/******************************
  Program "./lab/eadash.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./lab/eadash"
#define BITS_IN_WORLD 9656
#define ALIGN
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  mu_1_RequestType (const char *name, int os): mu__byte(9, 16, 4, name, os) {};
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  mu_1_ReplyType (const char *name, int os): mu__byte(17, 20, 3, name, os) {};
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  mu_1_RAC_State (const char *name, int os): mu__byte(21, 26, 3, name, os) {};
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  mu_1_CacheState (const char *name, int os): mu__byte(27, 29, 2, name, os) {};
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  mu_1__type_1 (const char *name, int os): mu__byte(30, 32, 2, name, os) {};
...
class mu_1__type_12: public mu__byte
{
 public:
  ...
  mu_1__type_12 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
  mu__subrange_31 (void): mu__byte(0, 4, 3) {};
  mu__subrange_31 (int val): mu__byte(0, 4, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 168 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 168 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 168 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 168 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 168 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 840 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 840 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 840 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 840 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 840 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_17: public mu__byte
{
 public:
  ...
  mu_1__type_17 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
if (n) array[i].set_self_ar(n,"Home_1", i * 208 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 208 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 208 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 208 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 208 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 1040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 1040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 1040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 1040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 1040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu__subrange_46: public mu__byte
{
 public:
  ...
  mu__subrange_46 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu__subrange_48: public mu__byte
{
 public:
  ...
  mu__subrange_48 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu__subrange_49: public mu__byte
{
 public:
  ...
  mu__subrange_49 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu__subrange_50: public mu__byte
{
 public:
  ...
  mu__subrange_50 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu__subrange_51: public mu__byte
{
 public:
  ...
  mu__subrange_51 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
  mu__subrange_51 (void): mu__byte(0, 4, 3) {};
  mu__subrange_51 (int val): mu__byte(0, 4, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",4200);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",9400);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",9600);
