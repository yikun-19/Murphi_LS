/******************************
  Program "./lab-bfs/flash_ctc10_orig_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./lab-bfs/flash_ctc10_orig_node2"
...
class mu_1_NODE: public mu__byte
{
 public:
  ...
  mu_1_NODE (const char *name, int os): mu__byte(1, 10, 4, name, os) {};
  mu_1_NODE (void): mu__byte(1, 10, 4) {};
  mu_1_NODE (int val): mu__byte(1, 10, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
void mu_1_DIR_STATE::set_self(const char *n, int os)
{
  ...
  if (name) mu_InvSet.set_self_2(name, ".InvSet", os + 128 ); else mu_InvSet.set_self_2(NULL, NULL, 0);
}
...
void mu_1_STATE::set_self(const char *n, int os)
{
  ...
  if (name) mu_HomeProc.set_self_2(name, ".HomeProc", os + 240 ); else mu_HomeProc.set_self_2(NULL, NULL, 0);
  if (name) mu_Dir.set_self_2(name, ".Dir", os + 264 ); else mu_Dir.set_self_2(NULL, NULL, 0);
  if (name) mu_UniMsg.set_self_2(name, ".UniMsg", os + 472 ); else mu_UniMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_HomeUniMsg.set_self_2(name, ".HomeUniMsg", os + 712 ); else mu_HomeUniMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_InvMsg.set_self_2(name, ".InvMsg", os + 736 ); else mu_InvMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_RpMsg.set_self_2(name, ".RpMsg", os + 816 ); else mu_RpMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_WbMsg.set_self_2(name, ".WbMsg", os + 896 ); else mu_WbMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_ShWbMsg.set_self_2(name, ".ShWbMsg", os + 912 ); else mu_ShWbMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_NakcMsg.set_self_2(name, ".NakcMsg", os + 928 ); else mu_NakcMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_PendReqSrc.set_self_2(name, ".PendReqSrc", os + 936 ); else mu_PendReqSrc.set_self_2(NULL, NULL, 0);
  if (name) mu_HomePendReqSrc.set_self_2(name, ".HomePendReqSrc", os + 944 ); else mu_HomePendReqSrc.set_self_2(NULL, NULL, 0);
  if (name) mu_Collecting.set_self_2(name, ".Collecting", os + 952 ); else mu_Collecting.set_self_2(NULL, NULL, 0);
  if (name) mu_FwdCmd.set_self_2(name, ".FwdCmd", os + 960 ); else mu_FwdCmd.set_self_2(NULL, NULL, 0);
}
...
bool Condition(unsigned r)
{
  ...
  if (r>=20 && r<=20) return R2.Condition(r-20);
  if (r>=21 && r<=21) return R3.Condition(r-21);
  if (r>=22 && r<=31) return R4.Condition(r-22);
  if (r>=32 && r<=41) return R5.Condition(r-32);
  if (r>=42 && r<=51) return R6.Condition(r-42);
  if (r>=52 && r<=61) return R7.Condition(r-52);
  if (r>=62 && r<=62) return R8.Condition(r-62);
  if (r>=63 && r<=72) return R9.Condition(r-63);
  if (r>=73 && r<=73) return R10.Condition(r-73);
  if (r>=74 && r<=83) return R11.Condition(r-74);
  if (r>=84 && r<=183) return R12.Condition(r-84);
  if (r>=184 && r<=193) return R13.Condition(r-184);
  if (r>=194 && r<=293) return R14.Condition(r-194);
  if (r>=294 && r<=303) return R15.Condition(r-294);
  if (r>=304 && r<=313) return R16.Condition(r-304);
  if (r>=314 && r<=323) return R17.Condition(r-314);
  if (r>=324 && r<=333) return R18.Condition(r-324);
  if (r>=334 && r<=343) return R19.Condition(r-334);
  if (r>=344 && r<=353) return R20.Condition(r-344);
  if (r>=354 && r<=453) return R21.Condition(r-354);
  if (r>=454 && r<=463) return R22.Condition(r-454);
  if (r>=464 && r<=563) return R23.Condition(r-464);
  if (r>=564 && r<=573) return R24.Condition(r-564);
  if (r>=574 && r<=583) return R25.Condition(r-574);
  if (r>=584 && r<=593) return R26.Condition(r-584);
  if (r>=594 && r<=594) return R27.Condition(r-594);
  if (r>=595 && r<=595) return R28.Condition(r-595);
  if (r>=596 && r<=605) return R29.Condition(r-596);
  if (r>=606 && r<=606) return R30.Condition(r-606);
  if (r>=607 && r<=616) return R31.Condition(r-607);
  if (r>=617 && r<=617) return R32.Condition(r-617);
  if (r>=618 && r<=627) return R33.Condition(r-618);
  if (r>=628 && r<=628) return R34.Condition(r-628);
  if (r>=629 && r<=629) return R35.Condition(r-629);
  if (r>=630 && r<=639) return R36.Condition(r-630);
  if (r>=640 && r<=640) return R37.Condition(r-640);
  if (r>=641 && r<=641) return R38.Condition(r-641);
  if (r>=642 && r<=651) return R39.Condition(r-642);
...
void Code(unsigned r)
{
  ...
  if (r>=20 && r<=20) { R2.Code(r-20); return; } 
  if (r>=21 && r<=21) { R3.Code(r-21); return; } 
  if (r>=22 && r<=31) { R4.Code(r-22); return; } 
  if (r>=32 && r<=41) { R5.Code(r-32); return; } 
  if (r>=42 && r<=51) { R6.Code(r-42); return; } 
  if (r>=52 && r<=61) { R7.Code(r-52); return; } 
  if (r>=62 && r<=62) { R8.Code(r-62); return; } 
  if (r>=63 && r<=72) { R9.Code(r-63); return; } 
  if (r>=73 && r<=73) { R10.Code(r-73); return; } 
  if (r>=74 && r<=83) { R11.Code(r-74); return; } 
  if (r>=84 && r<=183) { R12.Code(r-84); return; } 
  if (r>=184 && r<=193) { R13.Code(r-184); return; } 
  if (r>=194 && r<=293) { R14.Code(r-194); return; } 
  if (r>=294 && r<=303) { R15.Code(r-294); return; } 
  if (r>=304 && r<=313) { R16.Code(r-304); return; } 
  if (r>=314 && r<=323) { R17.Code(r-314); return; } 
  if (r>=324 && r<=333) { R18.Code(r-324); return; } 
  if (r>=334 && r<=343) { R19.Code(r-334); return; } 
  if (r>=344 && r<=353) { R20.Code(r-344); return; } 
  if (r>=354 && r<=453) { R21.Code(r-354); return; } 
  if (r>=454 && r<=463) { R22.Code(r-454); return; } 
  if (r>=464 && r<=563) { R23.Code(r-464); return; } 
  if (r>=564 && r<=573) { R24.Code(r-564); return; } 
  if (r>=574 && r<=583) { R25.Code(r-574); return; } 
  if (r>=584 && r<=593) { R26.Code(r-584); return; } 
  if (r>=594 && r<=594) { R27.Code(r-594); return; } 
  if (r>=595 && r<=595) { R28.Code(r-595); return; } 
  if (r>=596 && r<=605) { R29.Code(r-596); return; } 
  if (r>=606 && r<=606) { R30.Code(r-606); return; } 
  if (r>=607 && r<=616) { R31.Code(r-607); return; } 
  if (r>=617 && r<=617) { R32.Code(r-617); return; } 
  if (r>=618 && r<=627) { R33.Code(r-618); return; } 
  if (r>=628 && r<=628) { R34.Code(r-628); return; } 
  if (r>=629 && r<=629) { R35.Code(r-629); return; } 
  if (r>=630 && r<=639) { R36.Code(r-630); return; } 
  if (r>=640 && r<=640) { R37.Code(r-640); return; } 
  if (r>=641 && r<=641) { R38.Code(r-641); return; } 
  if (r>=642 && r<=651) { R39.Code(r-642); return; } 
}
int Priority(unsigned short r)
{
  if (r<=9) { return R0.Priority(); } 
  if (r>=10 && r<=19) { return R1.Priority(); } 
  if (r>=20 && r<=20) { return R2.Priority(); } 
  if (r>=21 && r<=21) { return R3.Priority(); } 
  if (r>=22 && r<=31) { return R4.Priority(); } 
  if (r>=32 && r<=41) { return R5.Priority(); } 
  if (r>=42 && r<=51) { return R6.Priority(); } 
  if (r>=52 && r<=61) { return R7.Priority(); } 
  if (r>=62 && r<=62) { return R8.Priority(); } 
  if (r>=63 && r<=72) { return R9.Priority(); } 
  if (r>=73 && r<=73) { return R10.Priority(); } 
  if (r>=74 && r<=83) { return R11.Priority(); } 
  if (r>=84 && r<=183) { return R12.Priority(); } 
  if (r>=184 && r<=193) { return R13.Priority(); } 
  if (r>=194 && r<=293) { return R14.Priority(); } 
  if (r>=294 && r<=303) { return R15.Priority(); } 
  if (r>=304 && r<=313) { return R16.Priority(); } 
  if (r>=314 && r<=323) { return R17.Priority(); } 
  if (r>=324 && r<=333) { return R18.Priority(); } 
  if (r>=334 && r<=343) { return R19.Priority(); } 
  if (r>=344 && r<=353) { return R20.Priority(); } 
  if (r>=354 && r<=453) { return R21.Priority(); } 
  if (r>=454 && r<=463) { return R22.Priority(); } 
  if (r>=464 && r<=563) { return R23.Priority(); } 
  if (r>=564 && r<=573) { return R24.Priority(); } 
  if (r>=574 && r<=583) { return R25.Priority(); } 
  if (r>=584 && r<=593) { return R26.Priority(); } 
  if (r>=594 && r<=594) { return R27.Priority(); } 
  if (r>=595 && r<=595) { return R28.Priority(); } 
  if (r>=596 && r<=605) { return R29.Priority(); } 
  if (r>=606 && r<=606) { return R30.Priority(); } 
  if (r>=607 && r<=616) { return R31.Priority(); } 
  if (r>=617 && r<=617) { return R32.Priority(); } 
  if (r>=618 && r<=627) { return R33.Priority(); } 
  if (r>=628 && r<=628) { return R34.Priority(); } 
  if (r>=629 && r<=629) { return R35.Priority(); } 
  if (r>=630 && r<=639) { return R36.Priority(); } 
  if (r>=640 && r<=640) { return R37.Priority(); } 
  if (r>=641 && r<=641) { return R38.Priority(); } 
  if (r>=642 && r<=651) { return R39.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=9) return R0.Name(r-0);
  if (r>=10 && r<=19) return R1.Name(r-10);
  if (r>=20 && r<=20) return R2.Name(r-20);
  if (r>=21 && r<=21) return R3.Name(r-21);
  if (r>=22 && r<=31) return R4.Name(r-22);
  if (r>=32 && r<=41) return R5.Name(r-32);
  if (r>=42 && r<=51) return R6.Name(r-42);
  if (r>=52 && r<=61) return R7.Name(r-52);
  if (r>=62 && r<=62) return R8.Name(r-62);
  if (r>=63 && r<=72) return R9.Name(r-63);
  if (r>=73 && r<=73) return R10.Name(r-73);
  if (r>=74 && r<=83) return R11.Name(r-74);
  if (r>=84 && r<=183) return R12.Name(r-84);
  if (r>=184 && r<=193) return R13.Name(r-184);
  if (r>=194 && r<=293) return R14.Name(r-194);
  if (r>=294 && r<=303) return R15.Name(r-294);
  if (r>=304 && r<=313) return R16.Name(r-304);
  if (r>=314 && r<=323) return R17.Name(r-314);
  if (r>=324 && r<=333) return R18.Name(r-324);
  if (r>=334 && r<=343) return R19.Name(r-334);
  if (r>=344 && r<=353) return R20.Name(r-344);
  if (r>=354 && r<=453) return R21.Name(r-354);
  if (r>=454 && r<=463) return R22.Name(r-454);
  if (r>=464 && r<=563) return R23.Name(r-464);
  if (r>=564 && r<=573) return R24.Name(r-564);
  if (r>=574 && r<=583) return R25.Name(r-574);
  if (r>=584 && r<=593) return R26.Name(r-584);
  if (r>=594 && r<=594) return R27.Name(r-594);
  if (r>=595 && r<=595) return R28.Name(r-595);
  if (r>=596 && r<=605) return R29.Name(r-596);
  if (r>=606 && r<=606) return R30.Name(r-606);
  if (r>=607 && r<=616) return R31.Name(r-607);
  if (r>=617 && r<=617) return R32.Name(r-617);
  if (r>=618 && r<=627) return R33.Name(r-618);
  if (r>=628 && r<=628) return R34.Name(r-628);
  if (r>=629 && r<=629) return R35.Name(r-629);
  if (r>=630 && r<=639) return R36.Name(r-630);
  if (r>=640 && r<=640) return R37.Name(r-640);
  if (r>=641 && r<=641) return R38.Name(r-641);
  if (r>=642 && r<=651) return R39.Name(r-642);
  return NULL;
}
};
const unsigned numrules = 652;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 652
...
bool mu__condition_259() // Condition for Rule "test_proprity, j:1, i:9"
{
  return mu__invariant_247( 1, 9 );
}

bool mu__condition_260() // Condition for Rule "test_proprity, j:1, i:10"
{
  return mu__invariant_247( 1, 10 );
}

bool mu__condition_262() // Condition for Rule "test_proprity, j:2, i:1"
{
  return mu__invariant_247( 2, 1 );
}

bool mu__condition_263() // Condition for Rule "test_proprity, j:2, i:2"
{
  return mu__invariant_247( 2, 2 );
}

bool mu__condition_264() // Condition for Rule "test_proprity, j:2, i:3"
{
  return mu__invariant_247( 2, 3 );
}

bool mu__condition_265() // Condition for Rule "test_proprity, j:2, i:4"
{
  return mu__invariant_247( 2, 4 );
}

bool mu__condition_266() // Condition for Rule "test_proprity, j:2, i:5"
{
  return mu__invariant_247( 2, 5 );
}

bool mu__condition_267() // Condition for Rule "test_proprity, j:2, i:6"
{
  return mu__invariant_247( 2, 6 );
}

bool mu__condition_268() // Condition for Rule "test_proprity, j:2, i:7"
{
  return mu__invariant_247( 2, 7 );
}

bool mu__condition_269() // Condition for Rule "test_proprity, j:2, i:8"
{
  return mu__invariant_247( 2, 8 );
}

bool mu__condition_270() // Condition for Rule "test_proprity, j:2, i:9"
{
  return mu__invariant_247( 2, 9 );
}

bool mu__condition_271() // Condition for Rule "test_proprity, j:2, i:10"
{
  return mu__invariant_247( 2, 10 );
}

bool mu__condition_273() // Condition for Rule "test_proprity, j:3, i:1"
{
  return mu__invariant_247( 3, 1 );
}

bool mu__condition_274() // Condition for Rule "test_proprity, j:3, i:2"
{
  return mu__invariant_247( 3, 2 );
}

bool mu__condition_275() // Condition for Rule "test_proprity, j:3, i:3"
{
  return mu__invariant_247( 3, 3 );
}

bool mu__condition_276() // Condition for Rule "test_proprity, j:3, i:4"
{
  return mu__invariant_247( 3, 4 );
}

bool mu__condition_277() // Condition for Rule "test_proprity, j:3, i:5"
{
  return mu__invariant_247( 3, 5 );
}

bool mu__condition_278() // Condition for Rule "test_proprity, j:3, i:6"
{
  return mu__invariant_247( 3, 6 );
}

bool mu__condition_279() // Condition for Rule "test_proprity, j:3, i:7"
{
  return mu__invariant_247( 3, 7 );
}

bool mu__condition_280() // Condition for Rule "test_proprity, j:3, i:8"
{
  return mu__invariant_247( 3, 8 );
}

bool mu__condition_281() // Condition for Rule "test_proprity, j:3, i:9"
{
  return mu__invariant_247( 3, 9 );
}

bool mu__condition_282() // Condition for Rule "test_proprity, j:3, i:10"
{
  return mu__invariant_247( 3, 10 );
}

bool mu__condition_284() // Condition for Rule "test_proprity, j:4, i:1"
{
  return mu__invariant_247( 4, 1 );
}

bool mu__condition_285() // Condition for Rule "test_proprity, j:4, i:2"
{
  return mu__invariant_247( 4, 2 );
}

bool mu__condition_286() // Condition for Rule "test_proprity, j:4, i:3"
{
  return mu__invariant_247( 4, 3 );
}

bool mu__condition_287() // Condition for Rule "test_proprity, j:4, i:4"
{
  return mu__invariant_247( 4, 4 );
}

bool mu__condition_288() // Condition for Rule "test_proprity, j:4, i:5"
{
  return mu__invariant_247( 4, 5 );
}

bool mu__condition_289() // Condition for Rule "test_proprity, j:4, i:6"
{
  return mu__invariant_247( 4, 6 );
}

bool mu__condition_290() // Condition for Rule "test_proprity, j:4, i:7"
{
  return mu__invariant_247( 4, 7 );
}

bool mu__condition_291() // Condition for Rule "test_proprity, j:4, i:8"
{
  return mu__invariant_247( 4, 8 );
}

bool mu__condition_292() // Condition for Rule "test_proprity, j:4, i:9"
{
  return mu__invariant_247( 4, 9 );
}

bool mu__condition_293() // Condition for Rule "test_proprity, j:4, i:10"
{
  return mu__invariant_247( 4, 10 );
}

bool mu__condition_295() // Condition for Rule "test_proprity, j:5, i:1"
{
  return mu__invariant_247( 5, 1 );
}

bool mu__condition_296() // Condition for Rule "test_proprity, j:5, i:2"
{
  return mu__invariant_247( 5, 2 );
}

bool mu__condition_297() // Condition for Rule "test_proprity, j:5, i:3"
{
  return mu__invariant_247( 5, 3 );
}

bool mu__condition_298() // Condition for Rule "test_proprity, j:5, i:4"
{
  return mu__invariant_247( 5, 4 );
}

bool mu__condition_299() // Condition for Rule "test_proprity, j:5, i:5"
{
  return mu__invariant_247( 5, 5 );
}

bool mu__condition_300() // Condition for Rule "test_proprity, j:5, i:6"
{
  return mu__invariant_247( 5, 6 );
}

bool mu__condition_301() // Condition for Rule "test_proprity, j:5, i:7"
{
  return mu__invariant_247( 5, 7 );
}

bool mu__condition_302() // Condition for Rule "test_proprity, j:5, i:8"
{
  return mu__invariant_247( 5, 8 );
}

bool mu__condition_303() // Condition for Rule "test_proprity, j:5, i:9"
{
  return mu__invariant_247( 5, 9 );
}

bool mu__condition_304() // Condition for Rule "test_proprity, j:5, i:10"
{
  return mu__invariant_247( 5, 10 );
}

bool mu__condition_306() // Condition for Rule "test_proprity, j:6, i:1"
{
  return mu__invariant_247( 6, 1 );
}

bool mu__condition_307() // Condition for Rule "test_proprity, j:6, i:2"
{
  return mu__invariant_247( 6, 2 );
}

bool mu__condition_308() // Condition for Rule "test_proprity, j:6, i:3"
{
  return mu__invariant_247( 6, 3 );
}

bool mu__condition_309() // Condition for Rule "test_proprity, j:6, i:4"
{
  return mu__invariant_247( 6, 4 );
}

bool mu__condition_310() // Condition for Rule "test_proprity, j:6, i:5"
{
  return mu__invariant_247( 6, 5 );
}

bool mu__condition_311() // Condition for Rule "test_proprity, j:6, i:6"
{
  return mu__invariant_247( 6, 6 );
}

bool mu__condition_312() // Condition for Rule "test_proprity, j:6, i:7"
{
  return mu__invariant_247( 6, 7 );
}

bool mu__condition_313() // Condition for Rule "test_proprity, j:6, i:8"
{
  return mu__invariant_247( 6, 8 );
}

bool mu__condition_314() // Condition for Rule "test_proprity, j:6, i:9"
{
  return mu__invariant_247( 6, 9 );
}

bool mu__condition_315() // Condition for Rule "test_proprity, j:6, i:10"
{
  return mu__invariant_247( 6, 10 );
}

bool mu__condition_317() // Condition for Rule "test_proprity, j:7, i:1"
{
  return mu__invariant_247( 7, 1 );
}

bool mu__condition_318() // Condition for Rule "test_proprity, j:7, i:2"
{
  return mu__invariant_247( 7, 2 );
}

bool mu__condition_319() // Condition for Rule "test_proprity, j:7, i:3"
{
  return mu__invariant_247( 7, 3 );
}

bool mu__condition_320() // Condition for Rule "test_proprity, j:7, i:4"
{
  return mu__invariant_247( 7, 4 );
}

bool mu__condition_321() // Condition for Rule "test_proprity, j:7, i:5"
{
  return mu__invariant_247( 7, 5 );
}

bool mu__condition_322() // Condition for Rule "test_proprity, j:7, i:6"
{
  return mu__invariant_247( 7, 6 );
}

bool mu__condition_323() // Condition for Rule "test_proprity, j:7, i:7"
{
  return mu__invariant_247( 7, 7 );
}

bool mu__condition_324() // Condition for Rule "test_proprity, j:7, i:8"
{
  return mu__invariant_247( 7, 8 );
}

bool mu__condition_325() // Condition for Rule "test_proprity, j:7, i:9"
{
  return mu__invariant_247( 7, 9 );
}

bool mu__condition_326() // Condition for Rule "test_proprity, j:7, i:10"
{
  return mu__invariant_247( 7, 10 );
}

bool mu__condition_328() // Condition for Rule "test_proprity, j:8, i:1"
{
  return mu__invariant_247( 8, 1 );
}

bool mu__condition_329() // Condition for Rule "test_proprity, j:8, i:2"
{
  return mu__invariant_247( 8, 2 );
}

bool mu__condition_330() // Condition for Rule "test_proprity, j:8, i:3"
{
  return mu__invariant_247( 8, 3 );
}

bool mu__condition_331() // Condition for Rule "test_proprity, j:8, i:4"
{
  return mu__invariant_247( 8, 4 );
}

bool mu__condition_332() // Condition for Rule "test_proprity, j:8, i:5"
{
  return mu__invariant_247( 8, 5 );
}

bool mu__condition_333() // Condition for Rule "test_proprity, j:8, i:6"
{
  return mu__invariant_247( 8, 6 );
}

bool mu__condition_334() // Condition for Rule "test_proprity, j:8, i:7"
{
  return mu__invariant_247( 8, 7 );
}

bool mu__condition_335() // Condition for Rule "test_proprity, j:8, i:8"
{
  return mu__invariant_247( 8, 8 );
}

bool mu__condition_336() // Condition for Rule "test_proprity, j:8, i:9"
{
  return mu__invariant_247( 8, 9 );
}

bool mu__condition_337() // Condition for Rule "test_proprity, j:8, i:10"
{
  return mu__invariant_247( 8, 10 );
}

bool mu__condition_339() // Condition for Rule "test_proprity, j:9, i:1"
{
  return mu__invariant_247( 9, 1 );
}

bool mu__condition_340() // Condition for Rule "test_proprity, j:9, i:2"
{
  return mu__invariant_247( 9, 2 );
}

bool mu__condition_341() // Condition for Rule "test_proprity, j:9, i:3"
{
  return mu__invariant_247( 9, 3 );
}

bool mu__condition_342() // Condition for Rule "test_proprity, j:9, i:4"
{
  return mu__invariant_247( 9, 4 );
}

bool mu__condition_343() // Condition for Rule "test_proprity, j:9, i:5"
{
  return mu__invariant_247( 9, 5 );
}

bool mu__condition_344() // Condition for Rule "test_proprity, j:9, i:6"
{
  return mu__invariant_247( 9, 6 );
}

bool mu__condition_345() // Condition for Rule "test_proprity, j:9, i:7"
{
  return mu__invariant_247( 9, 7 );
}

bool mu__condition_346() // Condition for Rule "test_proprity, j:9, i:8"
{
  return mu__invariant_247( 9, 8 );
}

bool mu__condition_347() // Condition for Rule "test_proprity, j:9, i:9"
{
  return mu__invariant_247( 9, 9 );
}

bool mu__condition_348() // Condition for Rule "test_proprity, j:9, i:10"
{
  return mu__invariant_247( 9, 10 );
}

bool mu__condition_350() // Condition for Rule "test_proprity, j:10, i:1"
{
  return mu__invariant_247( 10, 1 );
}

bool mu__condition_351() // Condition for Rule "test_proprity, j:10, i:2"
{
  return mu__invariant_247( 10, 2 );
}

bool mu__condition_352() // Condition for Rule "test_proprity, j:10, i:3"
{
  return mu__invariant_247( 10, 3 );
}

bool mu__condition_353() // Condition for Rule "test_proprity, j:10, i:4"
{
  return mu__invariant_247( 10, 4 );
}

bool mu__condition_354() // Condition for Rule "test_proprity, j:10, i:5"
{
  return mu__invariant_247( 10, 5 );
}

bool mu__condition_355() // Condition for Rule "test_proprity, j:10, i:6"
{
  return mu__invariant_247( 10, 6 );
}

bool mu__condition_356() // Condition for Rule "test_proprity, j:10, i:7"
{
  return mu__invariant_247( 10, 7 );
}

bool mu__condition_357() // Condition for Rule "test_proprity, j:10, i:8"
{
  return mu__invariant_247( 10, 8 );
}

bool mu__condition_358() // Condition for Rule "test_proprity, j:10, i:9"
{
  return mu__invariant_247( 10, 9 );
}

bool mu__condition_359() // Condition for Rule "test_proprity, j:10, i:10"
{
  return mu__invariant_247( 10, 10 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"test_proprity, j:10, i:10", &mu__condition_359, NULL, },
{"test_proprity, j:10, i:9", &mu__condition_358, NULL, },
{"test_proprity, j:10, i:8", &mu__condition_357, NULL, },
{"test_proprity, j:10, i:7", &mu__condition_356, NULL, },
{"test_proprity, j:10, i:6", &mu__condition_355, NULL, },
{"test_proprity, j:10, i:5", &mu__condition_354, NULL, },
{"test_proprity, j:10, i:4", &mu__condition_353, NULL, },
{"test_proprity, j:10, i:3", &mu__condition_352, NULL, },
{"test_proprity, j:10, i:2", &mu__condition_351, NULL, },
{"test_proprity, j:10, i:1", &mu__condition_350, NULL, },
{"test_proprity, j:9, i:10", &mu__condition_348, NULL, },
{"test_proprity, j:9, i:9", &mu__condition_347, NULL, },
{"test_proprity, j:9, i:8", &mu__condition_346, NULL, },
{"test_proprity, j:9, i:7", &mu__condition_345, NULL, },
{"test_proprity, j:9, i:6", &mu__condition_344, NULL, },
{"test_proprity, j:9, i:5", &mu__condition_343, NULL, },
{"test_proprity, j:9, i:4", &mu__condition_342, NULL, },
{"test_proprity, j:9, i:3", &mu__condition_341, NULL, },
{"test_proprity, j:9, i:2", &mu__condition_340, NULL, },
{"test_proprity, j:9, i:1", &mu__condition_339, NULL, },
{"test_proprity, j:8, i:10", &mu__condition_337, NULL, },
{"test_proprity, j:8, i:9", &mu__condition_336, NULL, },
{"test_proprity, j:8, i:8", &mu__condition_335, NULL, },
{"test_proprity, j:8, i:7", &mu__condition_334, NULL, },
{"test_proprity, j:8, i:6", &mu__condition_333, NULL, },
{"test_proprity, j:8, i:5", &mu__condition_332, NULL, },
{"test_proprity, j:8, i:4", &mu__condition_331, NULL, },
{"test_proprity, j:8, i:3", &mu__condition_330, NULL, },
{"test_proprity, j:8, i:2", &mu__condition_329, NULL, },
{"test_proprity, j:8, i:1", &mu__condition_328, NULL, },
{"test_proprity, j:7, i:10", &mu__condition_326, NULL, },
{"test_proprity, j:7, i:9", &mu__condition_325, NULL, },
{"test_proprity, j:7, i:8", &mu__condition_324, NULL, },
{"test_proprity, j:7, i:7", &mu__condition_323, NULL, },
{"test_proprity, j:7, i:6", &mu__condition_322, NULL, },
{"test_proprity, j:7, i:5", &mu__condition_321, NULL, },
{"test_proprity, j:7, i:4", &mu__condition_320, NULL, },
{"test_proprity, j:7, i:3", &mu__condition_319, NULL, },
{"test_proprity, j:7, i:2", &mu__condition_318, NULL, },
{"test_proprity, j:7, i:1", &mu__condition_317, NULL, },
{"test_proprity, j:6, i:10", &mu__condition_315, NULL, },
{"test_proprity, j:6, i:9", &mu__condition_314, NULL, },
{"test_proprity, j:6, i:8", &mu__condition_313, NULL, },
{"test_proprity, j:6, i:7", &mu__condition_312, NULL, },
{"test_proprity, j:6, i:6", &mu__condition_311, NULL, },
{"test_proprity, j:6, i:5", &mu__condition_310, NULL, },
{"test_proprity, j:6, i:4", &mu__condition_309, NULL, },
{"test_proprity, j:6, i:3", &mu__condition_308, NULL, },
{"test_proprity, j:6, i:2", &mu__condition_307, NULL, },
{"test_proprity, j:6, i:1", &mu__condition_306, NULL, },
{"test_proprity, j:5, i:10", &mu__condition_304, NULL, },
{"test_proprity, j:5, i:9", &mu__condition_303, NULL, },
{"test_proprity, j:5, i:8", &mu__condition_302, NULL, },
{"test_proprity, j:5, i:7", &mu__condition_301, NULL, },
{"test_proprity, j:5, i:6", &mu__condition_300, NULL, },
{"test_proprity, j:5, i:5", &mu__condition_299, NULL, },
{"test_proprity, j:5, i:4", &mu__condition_298, NULL, },
{"test_proprity, j:5, i:3", &mu__condition_297, NULL, },
{"test_proprity, j:5, i:2", &mu__condition_296, NULL, },
{"test_proprity, j:5, i:1", &mu__condition_295, NULL, },
{"test_proprity, j:4, i:10", &mu__condition_293, NULL, },
{"test_proprity, j:4, i:9", &mu__condition_292, NULL, },
{"test_proprity, j:4, i:8", &mu__condition_291, NULL, },
{"test_proprity, j:4, i:7", &mu__condition_290, NULL, },
{"test_proprity, j:4, i:6", &mu__condition_289, NULL, },
{"test_proprity, j:4, i:5", &mu__condition_288, NULL, },
{"test_proprity, j:4, i:4", &mu__condition_287, NULL, },
{"test_proprity, j:4, i:3", &mu__condition_286, NULL, },
{"test_proprity, j:4, i:2", &mu__condition_285, NULL, },
{"test_proprity, j:4, i:1", &mu__condition_284, NULL, },
{"test_proprity, j:3, i:10", &mu__condition_282, NULL, },
{"test_proprity, j:3, i:9", &mu__condition_281, NULL, },
{"test_proprity, j:3, i:8", &mu__condition_280, NULL, },
{"test_proprity, j:3, i:7", &mu__condition_279, NULL, },
{"test_proprity, j:3, i:6", &mu__condition_278, NULL, },
{"test_proprity, j:3, i:5", &mu__condition_277, NULL, },
{"test_proprity, j:3, i:4", &mu__condition_276, NULL, },
{"test_proprity, j:3, i:3", &mu__condition_275, NULL, },
{"test_proprity, j:3, i:2", &mu__condition_274, NULL, },
{"test_proprity, j:3, i:1", &mu__condition_273, NULL, },
{"test_proprity, j:2, i:10", &mu__condition_271, NULL, },
{"test_proprity, j:2, i:9", &mu__condition_270, NULL, },
{"test_proprity, j:2, i:8", &mu__condition_269, NULL, },
{"test_proprity, j:2, i:7", &mu__condition_268, NULL, },
{"test_proprity, j:2, i:6", &mu__condition_267, NULL, },
{"test_proprity, j:2, i:5", &mu__condition_266, NULL, },
{"test_proprity, j:2, i:4", &mu__condition_265, NULL, },
{"test_proprity, j:2, i:3", &mu__condition_264, NULL, },
{"test_proprity, j:2, i:2", &mu__condition_263, NULL, },
{"test_proprity, j:2, i:1", &mu__condition_262, NULL, },
{"test_proprity, j:1, i:10", &mu__condition_260, NULL, },
{"test_proprity, j:1, i:9", &mu__condition_259, NULL, },
