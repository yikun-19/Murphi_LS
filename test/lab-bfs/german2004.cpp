/******************************
  Program "./lab-bfs/german2004.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./lab-bfs/german2004"
#define BITS_IN_WORLD 4208
#define ALIGN
...
class mu_1_node_id: public mu__byte
{
 public:
  ...
  mu_1_node_id (const char *name, int os): mu__byte(0, 2, 2, name, os) {};
  mu_1_node_id (void): mu__byte(0, 2, 2) {};
  mu_1_node_id (int val): mu__byte(0, 2, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
void mu_1_home_request_type::set_self(const char *n, int os)
{
  ...
  if (name) mu_status.set_self_2(name, ".status", os + 72 ); else mu_status.set_self_2(NULL, NULL, 0);
}
...
void mu_1_node_type::set_self(const char *n, int os)
{
  ...
  if (name) mu_local_requests.set_self_2(name, ".local_requests", os + 384 ); else mu_local_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_home_requests.set_self_2(name, ".home_requests", os + 416 ); else mu_home_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_remote_requests.set_self_2(name, ".remote_requests", os + 736 ); else mu_remote_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_inchan.set_self_2(name, ".inchan", os + 960 ); else mu_inchan.set_self_2(NULL, NULL, 0);
  if (name) mu_outchan.set_self_2(name, ".outchan", os + 1176 ); else mu_outchan.set_self_2(NULL, NULL, 0);
}
...
void mu_1__type_11::set_self( const char *n, int os)
{
  ...
  name = (char *)n;
  for(int i = 0; i < 3; i++) {
    array[i].set_self_ar(n, s=tsprintf("%d",i + 0), i * 1392 + os);
    delete[] s;
  }
};
...
/*** Variable declaration ***/
mu_1_data_type mu_auxdata("auxdata",4176);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=108 && what_rule<216)
    { R1.NextRule(what_rule);
      if (what_rule<216) return; }
  if (what_rule>=216 && what_rule<324)
    { R2.NextRule(what_rule);
      if (what_rule<324) return; }
  if (what_rule>=324 && what_rule<432)
    { R3.NextRule(what_rule);
      if (what_rule<432) return; }
  if (what_rule>=432 && what_rule<528)
    { R4.NextRule(what_rule);
      if (what_rule<528) return; }
  if (what_rule>=528 && what_rule<564)
    { R5.NextRule(what_rule);
      if (what_rule<564) return; }
  if (what_rule>=564 && what_rule<600)
    { R6.NextRule(what_rule);
      if (what_rule<600) return; }
  if (what_rule>=600 && what_rule<612)
    { R7.NextRule(what_rule);
      if (what_rule<612) return; }
  if (what_rule>=612 && what_rule<648)
    { R8.NextRule(what_rule);
      if (what_rule<648) return; }
  if (what_rule>=648 && what_rule<756)
    { R9.NextRule(what_rule);
      if (what_rule<756) return; }
  if (what_rule>=756 && what_rule<783)
...
{
  category = CONDITION;
  if (r<=107) return R0.Condition(r-0);
  if (r>=108 && r<=215) return R1.Condition(r-108);
  if (r>=216 && r<=323) return R2.Condition(r-216);
  if (r>=324 && r<=431) return R3.Condition(r-324);
  if (r>=432 && r<=527) return R4.Condition(r-432);
  if (r>=528 && r<=563) return R5.Condition(r-528);
  if (r>=564 && r<=599) return R6.Condition(r-564);
  if (r>=600 && r<=611) return R7.Condition(r-600);
  if (r>=612 && r<=647) return R8.Condition(r-612);
  if (r>=648 && r<=755) return R9.Condition(r-648);
  if (r>=756 && r<=782) return R10.Condition(r-756);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
return 0;}
void Code(unsigned r)
{
  if (r<=107) { R0.Code(r-0); return; } 
  if (r>=108 && r<=215) { R1.Code(r-108); return; } 
  if (r>=216 && r<=323) { R2.Code(r-216); return; } 
  if (r>=324 && r<=431) { R3.Code(r-324); return; } 
  if (r>=432 && r<=527) { R4.Code(r-432); return; } 
  if (r>=528 && r<=563) { R5.Code(r-528); return; } 
  if (r>=564 && r<=599) { R6.Code(r-564); return; } 
  if (r>=600 && r<=611) { R7.Code(r-600); return; } 
  if (r>=612 && r<=647) { R8.Code(r-612); return; } 
  if (r>=648 && r<=755) { R9.Code(r-648); return; } 
  if (r>=756 && r<=782) { R10.Code(r-756); return; } 
}
int Priority(unsigned short r)
{
  if (r<=107) { return R0.Priority(); } 
  if (r>=108 && r<=215) { return R1.Priority(); } 
  if (r>=216 && r<=323) { return R2.Priority(); } 
  if (r>=324 && r<=431) { return R3.Priority(); } 
  if (r>=432 && r<=527) { return R4.Priority(); } 
  if (r>=528 && r<=563) { return R5.Priority(); } 
  if (r>=564 && r<=599) { return R6.Priority(); } 
  if (r>=600 && r<=611) { return R7.Priority(); } 
  if (r>=612 && r<=647) { return R8.Priority(); } 
  if (r>=648 && r<=755) { return R9.Priority(); } 
  if (r>=756 && r<=782) { return R10.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=107) return R0.Name(r-0);
  if (r>=108 && r<=215) return R1.Name(r-108);
  if (r>=216 && r<=323) return R2.Name(r-216);
  if (r>=324 && r<=431) return R3.Name(r-324);
  if (r>=432 && r<=527) return R4.Name(r-432);
  if (r>=528 && r<=563) return R5.Name(r-528);
  if (r>=564 && r<=599) return R6.Name(r-564);
  if (r>=600 && r<=611) return R7.Name(r-600);
  if (r>=612 && r<=647) return R8.Name(r-612);
  if (r>=648 && r<=755) return R9.Name(r-648);
  if (r>=756 && r<=782) return R10.Name(r-756);
  return NULL;
}
};
const unsigned numrules = 783;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 783
...
bool mu__condition_117() // Condition for Rule "data consistency property, d:0, addr:1, client:0"
{
  return mu__invariant_108( 0, 1, 0 );
}

bool mu__condition_118() // Condition for Rule "data consistency property, d:0, addr:1, client:1"
{
  return mu__invariant_108( 0, 1, 1 );
}

bool mu__condition_119() // Condition for Rule "data consistency property, d:0, addr:1, client:2"
{
  return mu__invariant_108( 0, 1, 2 );
}

bool mu__condition_121() // Condition for Rule "data consistency property, d:0, addr:2, client:0"
{
  return mu__invariant_108( 0, 2, 0 );
}

bool mu__condition_122() // Condition for Rule "data consistency property, d:0, addr:2, client:1"
{
  return mu__invariant_108( 0, 2, 1 );
}

bool mu__condition_123() // Condition for Rule "data consistency property, d:0, addr:2, client:2"
{
  return mu__invariant_108( 0, 2, 2 );
}

bool mu__condition_125() // Condition for Rule "data consistency property, d:0, addr:3, client:0"
{
  return mu__invariant_108( 0, 3, 0 );
}

bool mu__condition_126() // Condition for Rule "data consistency property, d:0, addr:3, client:1"
{
  return mu__invariant_108( 0, 3, 1 );
}

bool mu__condition_127() // Condition for Rule "data consistency property, d:0, addr:3, client:2"
{
  return mu__invariant_108( 0, 3, 2 );
}

bool mu__condition_130() // Condition for Rule "data consistency property, d:1, addr:0, client:0"
{
  return mu__invariant_108( 1, 0, 0 );
}

bool mu__condition_131() // Condition for Rule "data consistency property, d:1, addr:0, client:1"
{
  return mu__invariant_108( 1, 0, 1 );
}

bool mu__condition_132() // Condition for Rule "data consistency property, d:1, addr:0, client:2"
{
  return mu__invariant_108( 1, 0, 2 );
}

bool mu__condition_134() // Condition for Rule "data consistency property, d:1, addr:1, client:0"
{
  return mu__invariant_108( 1, 1, 0 );
}

bool mu__condition_135() // Condition for Rule "data consistency property, d:1, addr:1, client:1"
{
  return mu__invariant_108( 1, 1, 1 );
}

bool mu__condition_136() // Condition for Rule "data consistency property, d:1, addr:1, client:2"
{
  return mu__invariant_108( 1, 1, 2 );
}

bool mu__condition_138() // Condition for Rule "data consistency property, d:1, addr:2, client:0"
{
  return mu__invariant_108( 1, 2, 0 );
}

bool mu__condition_139() // Condition for Rule "data consistency property, d:1, addr:2, client:1"
{
  return mu__invariant_108( 1, 2, 1 );
}

bool mu__condition_140() // Condition for Rule "data consistency property, d:1, addr:2, client:2"
{
  return mu__invariant_108( 1, 2, 2 );
}

bool mu__condition_142() // Condition for Rule "data consistency property, d:1, addr:3, client:0"
{
  return mu__invariant_108( 1, 3, 0 );
}

bool mu__condition_143() // Condition for Rule "data consistency property, d:1, addr:3, client:1"
{
  return mu__invariant_108( 1, 3, 1 );
}

bool mu__condition_144() // Condition for Rule "data consistency property, d:1, addr:3, client:2"
{
  return mu__invariant_108( 1, 3, 2 );
}

bool mu__condition_147() // Condition for Rule "data consistency property, d:2, addr:0, client:0"
{
  return mu__invariant_108( 2, 0, 0 );
}

bool mu__condition_148() // Condition for Rule "data consistency property, d:2, addr:0, client:1"
{
  return mu__invariant_108( 2, 0, 1 );
}

bool mu__condition_149() // Condition for Rule "data consistency property, d:2, addr:0, client:2"
{
  return mu__invariant_108( 2, 0, 2 );
}

bool mu__condition_151() // Condition for Rule "data consistency property, d:2, addr:1, client:0"
{
  return mu__invariant_108( 2, 1, 0 );
}

bool mu__condition_152() // Condition for Rule "data consistency property, d:2, addr:1, client:1"
{
  return mu__invariant_108( 2, 1, 1 );
}

bool mu__condition_153() // Condition for Rule "data consistency property, d:2, addr:1, client:2"
{
  return mu__invariant_108( 2, 1, 2 );
}

bool mu__condition_155() // Condition for Rule "data consistency property, d:2, addr:2, client:0"
{
  return mu__invariant_108( 2, 2, 0 );
}

bool mu__condition_156() // Condition for Rule "data consistency property, d:2, addr:2, client:1"
{
  return mu__invariant_108( 2, 2, 1 );
}

bool mu__condition_157() // Condition for Rule "data consistency property, d:2, addr:2, client:2"
{
  return mu__invariant_108( 2, 2, 2 );
}

bool mu__condition_159() // Condition for Rule "data consistency property, d:2, addr:3, client:0"
{
  return mu__invariant_108( 2, 3, 0 );
}

bool mu__condition_160() // Condition for Rule "data consistency property, d:2, addr:3, client:1"
{
  return mu__invariant_108( 2, 3, 1 );
}

bool mu__condition_161() // Condition for Rule "data consistency property, d:2, addr:3, client:2"
{
  return mu__invariant_108( 2, 3, 2 );
}

bool mu__condition_164() // Condition for Rule "data consistency property, d:3, addr:0, client:0"
{
  return mu__invariant_108( 3, 0, 0 );
}

bool mu__condition_165() // Condition for Rule "data consistency property, d:3, addr:0, client:1"
{
  return mu__invariant_108( 3, 0, 1 );
}

bool mu__condition_166() // Condition for Rule "data consistency property, d:3, addr:0, client:2"
{
  return mu__invariant_108( 3, 0, 2 );
}

bool mu__condition_168() // Condition for Rule "data consistency property, d:3, addr:1, client:0"
{
  return mu__invariant_108( 3, 1, 0 );
}

bool mu__condition_169() // Condition for Rule "data consistency property, d:3, addr:1, client:1"
{
  return mu__invariant_108( 3, 1, 1 );
}

bool mu__condition_170() // Condition for Rule "data consistency property, d:3, addr:1, client:2"
{
  return mu__invariant_108( 3, 1, 2 );
}

bool mu__condition_172() // Condition for Rule "data consistency property, d:3, addr:2, client:0"
{
  return mu__invariant_108( 3, 2, 0 );
}

bool mu__condition_173() // Condition for Rule "data consistency property, d:3, addr:2, client:1"
{
  return mu__invariant_108( 3, 2, 1 );
}

bool mu__condition_174() // Condition for Rule "data consistency property, d:3, addr:2, client:2"
{
  return mu__invariant_108( 3, 2, 2 );
}

bool mu__condition_176() // Condition for Rule "data consistency property, d:3, addr:3, client:0"
{
  return mu__invariant_108( 3, 3, 0 );
}

bool mu__condition_177() // Condition for Rule "data consistency property, d:3, addr:3, client:1"
{
  return mu__invariant_108( 3, 3, 1 );
}

bool mu__condition_178() // Condition for Rule "data consistency property, d:3, addr:3, client:2"
{
...
int mu__invariant_179( const mu_1_addr_type &mu_addr, const mu_1_node_id &mu_n2, const mu_1_node_id &mu_n1) // Invariant "coherent"
{
bool mu__boolexpr180;
bool mu__boolexpr181;
  if (!((mu_n1) != (mu_n2))) mu__boolexpr181 = FALSE ;
  else {
  mu__boolexpr181 = ((mu_node[mu_n1].mu_cache[mu_addr].mu_state) == (mu_cache_shared)) ; 
}
  if (!(mu__boolexpr181)) mu__boolexpr180 = TRUE ;
  else {
  mu__boolexpr180 = ((mu_node[mu_n2].mu_cache[mu_addr].mu_state) == (mu_cache_shared)) ; 
}
return mu__boolexpr180;
};

bool mu__condition_185() // Condition for Rule "coherent, addr:0, n2:0, n1:0"
{
  return mu__invariant_179( 0, 0, 0 );
}

bool mu__condition_186() // Condition for Rule "coherent, addr:0, n2:0, n1:1"
{
  return mu__invariant_179( 0, 0, 1 );
}

bool mu__condition_187() // Condition for Rule "coherent, addr:0, n2:0, n1:2"
{
  return mu__invariant_179( 0, 0, 2 );
}

bool mu__condition_189() // Condition for Rule "coherent, addr:0, n2:1, n1:0"
{
  return mu__invariant_179( 0, 1, 0 );
}

bool mu__condition_190() // Condition for Rule "coherent, addr:0, n2:1, n1:1"
{
  return mu__invariant_179( 0, 1, 1 );
}

bool mu__condition_191() // Condition for Rule "coherent, addr:0, n2:1, n1:2"
{
  return mu__invariant_179( 0, 1, 2 );
}

bool mu__condition_193() // Condition for Rule "coherent, addr:0, n2:2, n1:0"
{
  return mu__invariant_179( 0, 2, 0 );
}

bool mu__condition_194() // Condition for Rule "coherent, addr:0, n2:2, n1:1"
{
  return mu__invariant_179( 0, 2, 1 );
}

bool mu__condition_195() // Condition for Rule "coherent, addr:0, n2:2, n1:2"
{
  return mu__invariant_179( 0, 2, 2 );
}

bool mu__condition_198() // Condition for Rule "coherent, addr:1, n2:0, n1:0"
{
  return mu__invariant_179( 1, 0, 0 );
}

bool mu__condition_199() // Condition for Rule "coherent, addr:1, n2:0, n1:1"
{
  return mu__invariant_179( 1, 0, 1 );
}

bool mu__condition_200() // Condition for Rule "coherent, addr:1, n2:0, n1:2"
{
  return mu__invariant_179( 1, 0, 2 );
}

bool mu__condition_202() // Condition for Rule "coherent, addr:1, n2:1, n1:0"
{
  return mu__invariant_179( 1, 1, 0 );
}

bool mu__condition_203() // Condition for Rule "coherent, addr:1, n2:1, n1:1"
{
  return mu__invariant_179( 1, 1, 1 );
}

bool mu__condition_204() // Condition for Rule "coherent, addr:1, n2:1, n1:2"
{
  return mu__invariant_179( 1, 1, 2 );
}

bool mu__condition_206() // Condition for Rule "coherent, addr:1, n2:2, n1:0"
{
  return mu__invariant_179( 1, 2, 0 );
}

bool mu__condition_207() // Condition for Rule "coherent, addr:1, n2:2, n1:1"
{
  return mu__invariant_179( 1, 2, 1 );
}

bool mu__condition_208() // Condition for Rule "coherent, addr:1, n2:2, n1:2"
{
  return mu__invariant_179( 1, 2, 2 );
}

bool mu__condition_211() // Condition for Rule "coherent, addr:2, n2:0, n1:0"
{
  return mu__invariant_179( 2, 0, 0 );
}

bool mu__condition_212() // Condition for Rule "coherent, addr:2, n2:0, n1:1"
{
  return mu__invariant_179( 2, 0, 1 );
}

bool mu__condition_213() // Condition for Rule "coherent, addr:2, n2:0, n1:2"
{
  return mu__invariant_179( 2, 0, 2 );
}

bool mu__condition_215() // Condition for Rule "coherent, addr:2, n2:1, n1:0"
{
  return mu__invariant_179( 2, 1, 0 );
}

bool mu__condition_216() // Condition for Rule "coherent, addr:2, n2:1, n1:1"
{
  return mu__invariant_179( 2, 1, 1 );
}

bool mu__condition_217() // Condition for Rule "coherent, addr:2, n2:1, n1:2"
{
  return mu__invariant_179( 2, 1, 2 );
}

bool mu__condition_219() // Condition for Rule "coherent, addr:2, n2:2, n1:0"
{
  return mu__invariant_179( 2, 2, 0 );
}

bool mu__condition_220() // Condition for Rule "coherent, addr:2, n2:2, n1:1"
{
  return mu__invariant_179( 2, 2, 1 );
}

bool mu__condition_221() // Condition for Rule "coherent, addr:2, n2:2, n1:2"
{
  return mu__invariant_179( 2, 2, 2 );
}

bool mu__condition_224() // Condition for Rule "coherent, addr:3, n2:0, n1:0"
{
  return mu__invariant_179( 3, 0, 0 );
}

bool mu__condition_225() // Condition for Rule "coherent, addr:3, n2:0, n1:1"
{
  return mu__invariant_179( 3, 0, 1 );
}

bool mu__condition_226() // Condition for Rule "coherent, addr:3, n2:0, n1:2"
{
  return mu__invariant_179( 3, 0, 2 );
}

bool mu__condition_228() // Condition for Rule "coherent, addr:3, n2:1, n1:0"
{
  return mu__invariant_179( 3, 1, 0 );
}

bool mu__condition_229() // Condition for Rule "coherent, addr:3, n2:1, n1:1"
{
  return mu__invariant_179( 3, 1, 1 );
}

bool mu__condition_230() // Condition for Rule "coherent, addr:3, n2:1, n1:2"
{
  return mu__invariant_179( 3, 1, 2 );
}

bool mu__condition_232() // Condition for Rule "coherent, addr:3, n2:2, n1:0"
{
  return mu__invariant_179( 3, 2, 0 );
}

bool mu__condition_233() // Condition for Rule "coherent, addr:3, n2:2, n1:1"
{
  return mu__invariant_179( 3, 2, 1 );
}

bool mu__condition_234() // Condition for Rule "coherent, addr:3, n2:2, n1:2"
{
  return mu__invariant_179( 3, 2, 2 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"coherent, addr:3, n2:2, n1:2", &mu__condition_234, NULL, },
{"coherent, addr:3, n2:2, n1:1", &mu__condition_233, NULL, },
{"coherent, addr:3, n2:2, n1:0", &mu__condition_232, NULL, },
{"coherent, addr:3, n2:1, n1:2", &mu__condition_230, NULL, },
{"coherent, addr:3, n2:1, n1:1", &mu__condition_229, NULL, },
{"coherent, addr:3, n2:1, n1:0", &mu__condition_228, NULL, },
{"coherent, addr:3, n2:0, n1:2", &mu__condition_226, NULL, },
{"coherent, addr:3, n2:0, n1:1", &mu__condition_225, NULL, },
{"coherent, addr:3, n2:0, n1:0", &mu__condition_224, NULL, },
{"coherent, addr:2, n2:2, n1:2", &mu__condition_221, NULL, },
{"coherent, addr:2, n2:2, n1:1", &mu__condition_220, NULL, },
{"coherent, addr:2, n2:2, n1:0", &mu__condition_219, NULL, },
{"coherent, addr:2, n2:1, n1:2", &mu__condition_217, NULL, },
{"coherent, addr:2, n2:1, n1:1", &mu__condition_216, NULL, },
{"coherent, addr:2, n2:1, n1:0", &mu__condition_215, NULL, },
{"coherent, addr:2, n2:0, n1:2", &mu__condition_213, NULL, },
{"coherent, addr:2, n2:0, n1:1", &mu__condition_212, NULL, },
{"coherent, addr:2, n2:0, n1:0", &mu__condition_211, NULL, },
{"coherent, addr:1, n2:2, n1:2", &mu__condition_208, NULL, },
{"coherent, addr:1, n2:2, n1:1", &mu__condition_207, NULL, },
{"coherent, addr:1, n2:2, n1:0", &mu__condition_206, NULL, },
{"coherent, addr:1, n2:1, n1:2", &mu__condition_204, NULL, },
{"coherent, addr:1, n2:1, n1:1", &mu__condition_203, NULL, },
{"coherent, addr:1, n2:1, n1:0", &mu__condition_202, NULL, },
{"coherent, addr:1, n2:0, n1:2", &mu__condition_200, NULL, },
{"coherent, addr:1, n2:0, n1:1", &mu__condition_199, NULL, },
{"coherent, addr:1, n2:0, n1:0", &mu__condition_198, NULL, },
{"coherent, addr:0, n2:2, n1:2", &mu__condition_195, NULL, },
{"coherent, addr:0, n2:2, n1:1", &mu__condition_194, NULL, },
{"coherent, addr:0, n2:2, n1:0", &mu__condition_193, NULL, },
{"coherent, addr:0, n2:1, n1:2", &mu__condition_191, NULL, },
{"coherent, addr:0, n2:1, n1:1", &mu__condition_190, NULL, },
{"coherent, addr:0, n2:1, n1:0", &mu__condition_189, NULL, },
{"coherent, addr:0, n2:0, n1:2", &mu__condition_187, NULL, },
{"coherent, addr:0, n2:0, n1:1", &mu__condition_186, NULL, },
{"coherent, addr:0, n2:0, n1:0", &mu__condition_185, NULL, },
{"data consistency property, d:3, addr:3, client:2", &mu__condition_178, NULL, },
{"data consistency property, d:3, addr:3, client:1", &mu__condition_177, NULL, },
{"data consistency property, d:3, addr:3, client:0", &mu__condition_176, NULL, },
{"data consistency property, d:3, addr:2, client:2", &mu__condition_174, NULL, },
{"data consistency property, d:3, addr:2, client:1", &mu__condition_173, NULL, },
{"data consistency property, d:3, addr:2, client:0", &mu__condition_172, NULL, },
{"data consistency property, d:3, addr:1, client:2", &mu__condition_170, NULL, },
{"data consistency property, d:3, addr:1, client:1", &mu__condition_169, NULL, },
{"data consistency property, d:3, addr:1, client:0", &mu__condition_168, NULL, },
{"data consistency property, d:3, addr:0, client:2", &mu__condition_166, NULL, },
{"data consistency property, d:3, addr:0, client:1", &mu__condition_165, NULL, },
{"data consistency property, d:3, addr:0, client:0", &mu__condition_164, NULL, },
{"data consistency property, d:2, addr:3, client:2", &mu__condition_161, NULL, },
{"data consistency property, d:2, addr:3, client:1", &mu__condition_160, NULL, },
{"data consistency property, d:2, addr:3, client:0", &mu__condition_159, NULL, },
{"data consistency property, d:2, addr:2, client:2", &mu__condition_157, NULL, },
{"data consistency property, d:2, addr:2, client:1", &mu__condition_156, NULL, },
{"data consistency property, d:2, addr:2, client:0", &mu__condition_155, NULL, },
{"data consistency property, d:2, addr:1, client:2", &mu__condition_153, NULL, },
{"data consistency property, d:2, addr:1, client:1", &mu__condition_152, NULL, },
{"data consistency property, d:2, addr:1, client:0", &mu__condition_151, NULL, },
{"data consistency property, d:2, addr:0, client:2", &mu__condition_149, NULL, },
{"data consistency property, d:2, addr:0, client:1", &mu__condition_148, NULL, },
{"data consistency property, d:2, addr:0, client:0", &mu__condition_147, NULL, },
{"data consistency property, d:1, addr:3, client:2", &mu__condition_144, NULL, },
{"data consistency property, d:1, addr:3, client:1", &mu__condition_143, NULL, },
{"data consistency property, d:1, addr:3, client:0", &mu__condition_142, NULL, },
{"data consistency property, d:1, addr:2, client:2", &mu__condition_140, NULL, },
{"data consistency property, d:1, addr:2, client:1", &mu__condition_139, NULL, },
{"data consistency property, d:1, addr:2, client:0", &mu__condition_138, NULL, },
{"data consistency property, d:1, addr:1, client:2", &mu__condition_136, NULL, },
{"data consistency property, d:1, addr:1, client:1", &mu__condition_135, NULL, },
{"data consistency property, d:1, addr:1, client:0", &mu__condition_134, NULL, },
{"data consistency property, d:1, addr:0, client:2", &mu__condition_132, NULL, },
{"data consistency property, d:1, addr:0, client:1", &mu__condition_131, NULL, },
{"data consistency property, d:1, addr:0, client:0", &mu__condition_130, NULL, },
{"data consistency property, d:0, addr:3, client:2", &mu__condition_127, NULL, },
{"data consistency property, d:0, addr:3, client:1", &mu__condition_126, NULL, },
{"data consistency property, d:0, addr:3, client:0", &mu__condition_125, NULL, },
{"data consistency property, d:0, addr:2, client:2", &mu__condition_123, NULL, },
{"data consistency property, d:0, addr:2, client:1", &mu__condition_122, NULL, },
{"data consistency property, d:0, addr:2, client:0", &mu__condition_121, NULL, },
{"data consistency property, d:0, addr:1, client:2", &mu__condition_119, NULL, },
{"data consistency property, d:0, addr:1, client:1", &mu__condition_118, NULL, },
{"data consistency property, d:0, addr:1, client:0", &mu__condition_117, NULL, },
...
const unsigned short numinvariants = 84;
