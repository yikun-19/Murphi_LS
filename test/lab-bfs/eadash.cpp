/******************************
  Program "./lab-bfs/eadash.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./lab-bfs/eadash"
#define BITS_IN_WORLD 674872
#define ALIGN
...
class mu_1_Address: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_Address& val)
    {
      if (val.defined())
	return ( s << mu_1_Address::values[ int(val) - 22 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_Address (const char *name, int os): mu__byte(22, 22, 1, name, os) {};
  mu_1_Address (void): mu__byte(22, 22, 1) {};
  mu_1_Address (int val): mu__byte(22, 22, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_Value: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_Value& val)
    {
      if (val.defined())
	return ( s << mu_1_Value::values[ int(val) - 23 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_Value (const char *name, int os): mu__byte(23, 24, 2, name, os) {};
  mu_1_Value (void): mu__byte(23, 24, 2) {};
  mu_1_Value (int val): mu__byte(23, 24, 2, "Parameter or function result.", 0)
    { operator=(val); };
  const char * Name() { return values[ value() -23]; };
  virtual void print()
    {
      if (defined()) cout << name << ':' << values[ value() - 23] << '\n';
      else cout << name << ":Undefined\n";
    };
  void print_statistic() {};
...
class mu_1_DirIndex: public mu__byte
{
 public:
  ...
  mu_1_DirIndex (const char *name, int os): mu__byte(0, 19, 5, name, os) {};
  mu_1_DirIndex (void): mu__byte(0, 19, 5) {};
  mu_1_DirIndex (int val): mu__byte(0, 19, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
class mu_1_NodeCount: public mu__byte
{
 public:
  ...
  mu_1_NodeCount (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu_1_NodeCount (void): mu__byte(0, 20, 5) {};
  mu_1_NodeCount (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RequestType::values[ int(val) - 25] );
    else return ( s << "Undefined" );
  };

  mu_1_RequestType (const char *name, int os): mu__byte(25, 32, 4, name, os) {};
  mu_1_RequestType (void): mu__byte(25, 32, 4) {};
  mu_1_RequestType (int val): mu__byte(25, 32, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_ReplyType::values[ int(val) - 33] );
    else return ( s << "Undefined" );
  };

  mu_1_ReplyType (const char *name, int os): mu__byte(33, 36, 3, name, os) {};
  mu_1_ReplyType (void): mu__byte(33, 36, 3) {};
  mu_1_ReplyType (int val): mu__byte(33, 36, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RAC_State::values[ int(val) - 37] );
    else return ( s << "Undefined" );
  };

  mu_1_RAC_State (const char *name, int os): mu__byte(37, 42, 3, name, os) {};
  mu_1_RAC_State (void): mu__byte(37, 42, 3) {};
  mu_1_RAC_State (int val): mu__byte(37, 42, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_CacheState::values[ int(val) - 43] );
    else return ( s << "Undefined" );
  };

  mu_1_CacheState (const char *name, int os): mu__byte(43, 45, 2, name, os) {};
  mu_1_CacheState (void): mu__byte(43, 45, 2) {};
  mu_1_CacheState (int val): mu__byte(43, 45, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
 ...
 public:
  ...
  mu_1_Value& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: Address is internally represented from 22 to 22.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 22 ];
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 46] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (const char *name, int os): mu__byte(46, 48, 2, name, os) {};
  mu_1__type_1 (void): mu__byte(46, 48, 2) {};
  mu_1__type_1 (int val): mu__byte(46, 48, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  mu_1__type_2 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu_1__type_2 (void): mu__byte(0, 20, 5) {};
  mu_1__type_2 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Address_1", i * 176 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_12: public mu__byte
{
 public:
  ...
  mu_1__type_12 (const char *name, int os): mu__byte(0, 21, 5, name, os) {};
  mu_1__type_12 (void): mu__byte(0, 21, 5) {};
  mu_1__type_12 (int val): mu__byte(0, 21, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_31 (void): mu__byte(0, 20, 5) {};
  mu__subrange_31 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_9", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_10", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_11", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_12", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_13", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_14", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_15", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_16", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_17", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_18", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_19", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_20", i * 680 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_9", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_10", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_11", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_12", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_13", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_14", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_15", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_16", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_17", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_18", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_19", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_20", i * 14280 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_17: public mu__byte
{
 public:
  ...
  mu_1__type_17 (const char *name, int os): mu__byte(0, 21, 5, name, os) {};
  mu_1__type_17 (void): mu__byte(0, 21, 5) {};
  mu_1__type_17 (int val): mu__byte(0, 21, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_37 (void): mu__byte(0, 20, 5) {};
  mu__subrange_37 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_9", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_10", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_11", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_12", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_13", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_14", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_15", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_16", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_17", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_18", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_19", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_20", i * 848 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_9", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_10", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_11", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_12", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_13", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_14", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_15", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_16", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_17", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_18", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_19", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_20", i * 17808 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Remote_11", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_12", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_13", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_14", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_15", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_16", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_17", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_18", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_19", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_20", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu__subrange_44: public mu__byte
{
 public:
  ...
  mu__subrange_44 (const char *name, int os): mu__byte(0, 19, 5, name, os) {};
  mu__subrange_44 (void): mu__byte(0, 19, 5) {};
  mu__subrange_44 (int val): mu__byte(0, 19, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_45: public mu__byte
{
 public:
  ...
  mu__subrange_45 (const char *name, int os): mu__byte(0, 19, 5, name, os) {};
  mu__subrange_45 (void): mu__byte(0, 19, 5) {};
  mu__subrange_45 (int val): mu__byte(0, 19, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_47: public mu__byte
{
 public:
  ...
  mu__subrange_47 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_47 (void): mu__byte(0, 20, 5) {};
  mu__subrange_47 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_49: public mu__byte
{
 public:
  ...
  mu__subrange_49 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_49 (void): mu__byte(0, 20, 5) {};
  mu__subrange_49 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_50: public mu__byte
{
 public:
  ...
  mu__subrange_50 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_50 (void): mu__byte(0, 20, 5) {};
  mu__subrange_50 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_51: public mu__byte
{
 public:
  ...
  mu__subrange_51 (const char *name, int os): mu__byte(0, 20, 5, name, os) {};
  mu__subrange_51 (void): mu__byte(0, 20, 5) {};
  mu__subrange_51 (int val): mu__byte(0, 20, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
const int mu_DirMax = 20;
const int mu_ChanMax = 21;
...
const int mu_Address_1 = 22;
const int mu_Value_1 = 23;
const int mu_Value_2 = 24;
const int mu_RD_H = 25;
const int mu_RD_RAC = 26;
const int mu_RDX_H = 27;
const int mu_RDX_RAC = 28;
const int mu_INV = 29;
const int mu_WB = 30;
const int mu_SHWB = 31;
const int mu_DXFER = 32;
const int mu_ACK = 33;
const int mu_NAK = 34;
const int mu_IACK = 35;
const int mu_SACK = 36;
const int mu_INVAL = 37;
const int mu_WRD = 38;
const int mu_WRDO = 39;
const int mu_WRDX = 40;
const int mu_WINV = 41;
const int mu_RRD = 42;
const int mu_Non_Locally_Cached = 43;
const int mu_Locally_Shared = 44;
const int mu_Locally_Exmod = 45;
const int mu_Uncached = 46;
const int mu_Shared_Remote = 47;
const int mu_Dirty_Remote = 48;
/*** Variable declaration ***/
mu_1__type_16 mu_ReqNet("ReqNet",0);

/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",299880);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",673848);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",674688);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=42 && what_rule<483)
    { R1.NextRule(what_rule);
      if (what_rule<483) return; }
  if (what_rule>=483 && what_rule<924)
    { R2.NextRule(what_rule);
      if (what_rule<924) return; }
  if (what_rule>=924 && what_rule<1365)
    { R3.NextRule(what_rule);
      if (what_rule<1365) return; }
  if (what_rule>=1365 && what_rule<1806)
    { R4.NextRule(what_rule);
      if (what_rule<1806) return; }
  if (what_rule>=1806 && what_rule<2247)
    { R5.NextRule(what_rule);
      if (what_rule<2247) return; }
  if (what_rule>=2247 && what_rule<2688)
    { R6.NextRule(what_rule);
      if (what_rule<2688) return; }
  if (what_rule>=2688 && what_rule<3129)
    { R7.NextRule(what_rule);
      if (what_rule<3129) return; }
  if (what_rule>=3129 && what_rule<3570)
    { R8.NextRule(what_rule);
      if (what_rule<3570) return; }
  if (what_rule>=3570 && what_rule<4011)
    { R9.NextRule(what_rule);
      if (what_rule<4011) return; }
  if (what_rule>=4011 && what_rule<4452)
    { R10.NextRule(what_rule);
      if (what_rule<4452) return; }
  if (what_rule>=4452 && what_rule<4893)
    { R11.NextRule(what_rule);
      if (what_rule<4893) return; }
  if (what_rule>=4893 && what_rule<5334)
    { R12.NextRule(what_rule);
      if (what_rule<5334) return; }
  if (what_rule>=5334 && what_rule<5355)
    { R13.NextRule(what_rule);
      if (what_rule<5355) return; }
  if (what_rule>=5355 && what_rule<5376)
    { R14.NextRule(what_rule);
      if (what_rule<5376) return; }
  if (what_rule>=5376 && what_rule<5397)
    { R15.NextRule(what_rule);
      if (what_rule<5397) return; }
  if (what_rule>=5397 && what_rule<5418)
    { R16.NextRule(what_rule);
      if (what_rule<5418) return; }
  if (what_rule>=5418 && what_rule<5439)
    { R17.NextRule(what_rule);
      if (what_rule<5439) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  if (r<=41) return R0.Condition(r-0);
  if (r>=42 && r<=482) return R1.Condition(r-42);
  if (r>=483 && r<=923) return R2.Condition(r-483);
  if (r>=924 && r<=1364) return R3.Condition(r-924);
  if (r>=1365 && r<=1805) return R4.Condition(r-1365);
  if (r>=1806 && r<=2246) return R5.Condition(r-1806);
  if (r>=2247 && r<=2687) return R6.Condition(r-2247);
  if (r>=2688 && r<=3128) return R7.Condition(r-2688);
  if (r>=3129 && r<=3569) return R8.Condition(r-3129);
  if (r>=3570 && r<=4010) return R9.Condition(r-3570);
  if (r>=4011 && r<=4451) return R10.Condition(r-4011);
  if (r>=4452 && r<=4892) return R11.Condition(r-4452);
  if (r>=4893 && r<=5333) return R12.Condition(r-4893);
  if (r>=5334 && r<=5354) return R13.Condition(r-5334);
  if (r>=5355 && r<=5375) return R14.Condition(r-5355);
  if (r>=5376 && r<=5396) return R15.Condition(r-5376);
  if (r>=5397 && r<=5417) return R16.Condition(r-5397);
  if (r>=5418 && r<=5438) return R17.Condition(r-5418);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
return 0;}
void Code(unsigned r)
{
  if (r<=41) { R0.Code(r-0); return; } 
  if (r>=42 && r<=482) { R1.Code(r-42); return; } 
  if (r>=483 && r<=923) { R2.Code(r-483); return; } 
  if (r>=924 && r<=1364) { R3.Code(r-924); return; } 
  if (r>=1365 && r<=1805) { R4.Code(r-1365); return; } 
  if (r>=1806 && r<=2246) { R5.Code(r-1806); return; } 
  if (r>=2247 && r<=2687) { R6.Code(r-2247); return; } 
  if (r>=2688 && r<=3128) { R7.Code(r-2688); return; } 
  if (r>=3129 && r<=3569) { R8.Code(r-3129); return; } 
  if (r>=3570 && r<=4010) { R9.Code(r-3570); return; } 
  if (r>=4011 && r<=4451) { R10.Code(r-4011); return; } 
  if (r>=4452 && r<=4892) { R11.Code(r-4452); return; } 
  if (r>=4893 && r<=5333) { R12.Code(r-4893); return; } 
  if (r>=5334 && r<=5354) { R13.Code(r-5334); return; } 
  if (r>=5355 && r<=5375) { R14.Code(r-5355); return; } 
  if (r>=5376 && r<=5396) { R15.Code(r-5376); return; } 
  if (r>=5397 && r<=5417) { R16.Code(r-5397); return; } 
  if (r>=5418 && r<=5438) { R17.Code(r-5418); return; } 
}
int Priority(unsigned short r)
{
  if (r<=41) { return R0.Priority(); } 
  if (r>=42 && r<=482) { return R1.Priority(); } 
  if (r>=483 && r<=923) { return R2.Priority(); } 
  if (r>=924 && r<=1364) { return R3.Priority(); } 
  if (r>=1365 && r<=1805) { return R4.Priority(); } 
  if (r>=1806 && r<=2246) { return R5.Priority(); } 
  if (r>=2247 && r<=2687) { return R6.Priority(); } 
  if (r>=2688 && r<=3128) { return R7.Priority(); } 
  if (r>=3129 && r<=3569) { return R8.Priority(); } 
  if (r>=3570 && r<=4010) { return R9.Priority(); } 
  if (r>=4011 && r<=4451) { return R10.Priority(); } 
  if (r>=4452 && r<=4892) { return R11.Priority(); } 
  if (r>=4893 && r<=5333) { return R12.Priority(); } 
  if (r>=5334 && r<=5354) { return R13.Priority(); } 
  if (r>=5355 && r<=5375) { return R14.Priority(); } 
  if (r>=5376 && r<=5396) { return R15.Priority(); } 
  if (r>=5397 && r<=5417) { return R16.Priority(); } 
  if (r>=5418 && r<=5438) { return R17.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=41) return R0.Name(r-0);
  if (r>=42 && r<=482) return R1.Name(r-42);
  if (r>=483 && r<=923) return R2.Name(r-483);
  if (r>=924 && r<=1364) return R3.Name(r-924);
  if (r>=1365 && r<=1805) return R4.Name(r-1365);
  if (r>=1806 && r<=2246) return R5.Name(r-1806);
  if (r>=2247 && r<=2687) return R6.Name(r-2247);
  if (r>=2688 && r<=3128) return R7.Name(r-2688);
  if (r>=3129 && r<=3569) return R8.Name(r-3129);
  if (r>=3570 && r<=4010) return R9.Name(r-3570);
  if (r>=4011 && r<=4451) return R10.Name(r-4011);
  if (r>=4452 && r<=4892) return R11.Name(r-4452);
  if (r>=4893 && r<=5333) return R12.Name(r-4893);
  if (r>=5334 && r<=5354) return R13.Name(r-5334);
  if (r>=5355 && r<=5375) return R14.Name(r-5355);
  if (r>=5376 && r<=5396) return R15.Name(r-5376);
  if (r>=5397 && r<=5417) return R16.Name(r-5397);
  if (r>=5418 && r<=5438) return R17.Name(r-5418);
  return NULL;
}
};
const unsigned numrules = 5439;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 5439
...
mu__quant62 = TRUE;
{
for(int mu_n1 = 1; mu_n1 <= 21; mu_n1++)
  if (( ( mu_n1 >= 2 ) && ( mu_n1 <= 21 ) )|| ( ( mu_n1 >= 1 ) && ( mu_n1 <= 1 ) )) {
bool mu__quant63; 
mu__quant63 = TRUE;
{
for(int mu_n2 = 1; mu_n2 <= 21; mu_n2++)
  if (( ( mu_n2 >= 2 ) && ( mu_n2 <= 21 ) )|| ( ( mu_n2 >= 1 ) && ( mu_n2 <= 1 ) )) {
bool mu__quant64; 
mu__quant64 = TRUE;
{
for(int mu_h = 1; mu_h <= 1; mu_h++) {
...
mu__quant86 = FALSE;
{
for(int mu_m = 1; mu_m <= 21; mu_m++)
  if (( ( mu_m >= 2 ) && ( mu_m <= 21 ) )|| ( ( mu_m >= 1 ) && ( mu_m <= 1 ) )) {
bool mu__quant87; 
mu__quant87 = FALSE;
{
for(int mu_i = 0; mu_i <= 20; mu_i++) {
...
bool mu__boolexpr140;
  ...
  mu__boolexpr139 = ((mu_Procs[mu_n2].mu_Cache[mu_h][mu_a].mu_State) == (mu_Locally_Shared)) ; 
}
if ( !(!(mu__boolexpr139)) )
...
{"Globally invalid RAC state at Home Cluster", &mu__condition_154, NULL, },
{"Gobally invalid RAC state at Local Cluster", &mu__condition_147, NULL, },
{"Only a single master copy exist", &mu__condition_141, NULL, },
{"Irrelevant data is set to zero", &mu__condition_133, NULL, },
{"Consistency within Directory", &mu__condition_119, NULL, },
{"Condition for existance of master copy of data", &mu__condition_104, NULL, },
{"Consistency of data", &mu__condition_97, NULL, },
{"Adequate invalidations with Read Exclusive request", &mu__condition_71, NULL, },
};
  ...
  for (j=0; j<=undefined_class_mu_1_Value; j++) // class number
    {
      for (k=0; k<2; k++) // step through class_mu_1_pid[k]
	    if (class_mu_1_Value[k]==j)
	      revperm_mu_1_Value[0][start++] = k+23;
    }
  for (j=0; j<2; j++)
    for (k=0; k<2; k++)
      if (revperm_mu_1_Value[0][k]==j+23)
        perm_mu_1_Value[0][j]=k+23;
  start = 0;
  for (j=0; j<=undefined_class_mu_1_Remote; j++) // class number
    {
      for (k=0; k<20; k++) // step through class_mu_1_pid[k]
...
void PermSet::GenPerm0(mu_1_Value* Perm,int size, unsigned long& count)
{
  ...
  if (size!=2)
    ...
    {
      for (i=23; i<=24; i++)
        revperm_mu_1_Value[count][i-23]=Perm[i-23].value();// i - base
      count++;
    }
}
...
bool PermSet::NextPermutation()
{
  ...
  for (start = 0; start < 2; )
    {
      end = start-1+size_mu_1_Value[revperm_mu_1_Value[0][start]-23];
...
if (!nexted) return FALSE;
  for (j=0; j<2; j++)
    for (k=0; k<2; k++)
      if (revperm_mu_1_Value[0][k]==j+23)   // k - base 
	perm_mu_1_Value[0][j]=k+23; // j - base 
  for (j=0; j<20; j++)
    for (k=0; k<20; k++)
...
void mu_1_Value::Permute(PermSet& Perm, int i)
{
  if (Perm.Presentation != PermSet::Explicit)
    Error.Error("Internal Error: Wrong Sequence of Normalization");
  if (defined())
    value(Perm.perm_mu_1_Value[Perm.in_mu_1_Value[i]][value()-23]); // value - base
};
void mu_1_Value::SimpleCanonicalize(PermSet& Perm)
{
  ...
  if (defined())
    if (Perm.class_mu_1_Value[value()-23]==Perm.undefined_class_mu_1_Value) // value - base
      {
        // it has not been mapped to any particular value
        for (i=0; i<2; i++)
          if (Perm.class_mu_1_Value[i] == Perm.undefined_class_mu_1_Value && i!=value()-23)
            Perm.class_mu_1_Value[i]++;
        value(23 + Perm.undefined_class_mu_1_Value++);
      }
    else 
      {
        value(Perm.class_mu_1_Value[value()-23]+23);
      }
}
          ...
          if (exists && split)
            {
              for (i=0; i<count_mu_1_Remote; i++) // scan through array index priority
                for (j=0; j<count_mu_1_Value; j++) //scan through element priority
                  {
                    exists = FALSE;
                    for (k=0; k<20; k++) // initialize goodset
                      goodset_mu_1_Remote[k] = FALSE;
                    for (k=0; k<2; k++) // initialize goodset
                      goodset_mu_1_Value[k] = FALSE;
                    for (k=0; k<20; k++) // scan array index
                      // set goodsets
                      if (pos_mu_1_Remote[i][k] 
                          && !(*this)[k+2].mu_Messages[i0].mu_Value.isundefined()
                          && pos_mu_1_Value[j][(*this)[k+2].mu_Messages[i0].mu_Value-23])
                        {
                          exists = TRUE;
                          goodset_mu_1_Remote[k] = TRUE;
                          goodset_mu_1_Value[(*this)[k+2].mu_Messages[i0].mu_Value-23] = TRUE;
                        }
                    if (exists)
                      {
                ...
                for (j=0; j<count_mu_1_Value; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<20; k++) // scan array index
                      ...
                      if (pos_mu_1_Remote[i][k] 
                          ...
                          && pos_mu_1_Value[j][(*this)[k+2].mu_Cache[mu_Home_1][mu_Address_1].mu_Value-23])
                        {
                          exists = TRUE;
                          goodset_mu_1_Remote[k] = TRUE;
                          goodset_mu_1_Value[(*this)[k+2].mu_Cache[mu_Home_1][mu_Address_1].mu_Value-23] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
                ...
                for (j=0; j<count_mu_1_Value; j++) //scan through element priority
                  {
                    ...
                    for (k=0; k<20; k++) // scan array index
                      ...
                      if (pos_mu_1_Remote[i][k] 
                          ...
                          && pos_mu_1_Value[j][(*this)[k+2].mu_RAC[mu_Home_1][mu_Address_1].mu_Value-23])
                        {
                          exists = TRUE;
                          goodset_mu_1_Remote[k] = TRUE;
                          goodset_mu_1_Value[(*this)[k+2].mu_RAC[mu_Home_1][mu_Address_1].mu_Value-23] = TRUE;
                        }
                    if (exists)
                      {
                        // set split for the array index type
