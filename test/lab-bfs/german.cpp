/******************************
  Program "./lab-bfs/german.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./lab-bfs/german"
#define BITS_IN_WORLD 840
#define ALIGN
...
/*** Variable declaration ***/
mu_1__type_1 mu_Chan1("Chan1",160);

/*** Variable declaration ***/
mu_1__type_2 mu_Chan2("Chan2",320);

/*** Variable declaration ***/
mu_1__type_3 mu_Chan3("Chan3",480);

/*** Variable declaration ***/
mu_1__type_4 mu_InvSet("InvSet",640);

/*** Variable declaration ***/
mu_1__type_5 mu_ShrSet("ShrSet",720);

/*** Variable declaration ***/
mu_0_boolean mu_ExGntd("ExGntd",800);

/*** Variable declaration ***/
mu_1_MSG_CMD mu_CurCmd("CurCmd",808);

/*** Variable declaration ***/
mu_1_NODE mu_CurPtr("CurPtr",816);

/*** Variable declaration ***/
mu_1_DATA mu_MemData("MemData",824);

/*** Variable declaration ***/
mu_1_DATA mu_AuxData("AuxData",832);
...
bool Condition(unsigned r)
{
  ...
  if (r>=40 && r<=49) return R4.Condition(r-40);
  if (r>=50 && r<=59) return R5.Condition(r-50);
  if (r>=60 && r<=69) return R6.Condition(r-60);
  if (r>=70 && r<=79) return R7.Condition(r-70);
  if (r>=80 && r<=89) return R8.Condition(r-80);
  if (r>=90 && r<=99) return R9.Condition(r-90);
  if (r>=100 && r<=109) return R10.Condition(r-100);
  if (r>=110 && r<=129) return R11.Condition(r-110);
...
void Code(unsigned r)
{
  ...
  if (r>=40 && r<=49) { R4.Code(r-40); return; } 
  if (r>=50 && r<=59) { R5.Code(r-50); return; } 
  if (r>=60 && r<=69) { R6.Code(r-60); return; } 
  if (r>=70 && r<=79) { R7.Code(r-70); return; } 
  if (r>=80 && r<=89) { R8.Code(r-80); return; } 
  if (r>=90 && r<=99) { R9.Code(r-90); return; } 
  if (r>=100 && r<=109) { R10.Code(r-100); return; } 
  if (r>=110 && r<=129) { R11.Code(r-110); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=40 && r<=49) { return R4.Priority(); } 
  if (r>=50 && r<=59) { return R5.Priority(); } 
  if (r>=60 && r<=69) { return R6.Priority(); } 
  if (r>=70 && r<=79) { return R7.Priority(); } 
  if (r>=80 && r<=89) { return R8.Priority(); } 
  if (r>=90 && r<=99) { return R9.Priority(); } 
  if (r>=100 && r<=109) { return R10.Priority(); } 
  if (r>=110 && r<=129) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=40 && r<=49) return R4.Name(r-40);
  if (r>=50 && r<=59) return R5.Name(r-50);
  if (r>=60 && r<=69) return R6.Name(r-60);
  if (r>=70 && r<=79) return R7.Name(r-70);
  if (r>=80 && r<=89) return R8.Name(r-80);
  if (r>=90 && r<=99) return R9.Name(r-90);
  if (r>=100 && r<=109) return R10.Name(r-100);
  if (r>=110 && r<=129) return R11.Name(r-110);
  return NULL;
}
};
const unsigned numrules = 130;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 130
...
bool mu__condition_63() // Condition for Rule "CntrlProp, j:2, i:1"
{
  return mu__invariant_44( 2, 1 );
}

bool mu__condition_64() // Condition for Rule "CntrlProp, j:2, i:2"
{
  return mu__invariant_44( 2, 2 );
}

bool mu__condition_65() // Condition for Rule "CntrlProp, j:2, i:3"
{
  return mu__invariant_44( 2, 3 );
}

bool mu__condition_66() // Condition for Rule "CntrlProp, j:2, i:4"
{
  return mu__invariant_44( 2, 4 );
}

bool mu__condition_67() // Condition for Rule "CntrlProp, j:2, i:5"
{
  return mu__invariant_44( 2, 5 );
}

bool mu__condition_68() // Condition for Rule "CntrlProp, j:2, i:6"
{
  return mu__invariant_44( 2, 6 );
}

bool mu__condition_69() // Condition for Rule "CntrlProp, j:2, i:7"
{
  return mu__invariant_44( 2, 7 );
}

bool mu__condition_70() // Condition for Rule "CntrlProp, j:2, i:8"
{
  return mu__invariant_44( 2, 8 );
}

bool mu__condition_71() // Condition for Rule "CntrlProp, j:2, i:9"
{
  return mu__invariant_44( 2, 9 );
}

bool mu__condition_72() // Condition for Rule "CntrlProp, j:2, i:10"
{
  return mu__invariant_44( 2, 10 );
}

bool mu__condition_74() // Condition for Rule "CntrlProp, j:3, i:1"
{
  return mu__invariant_44( 3, 1 );
}

bool mu__condition_75() // Condition for Rule "CntrlProp, j:3, i:2"
{
  return mu__invariant_44( 3, 2 );
}

bool mu__condition_76() // Condition for Rule "CntrlProp, j:3, i:3"
{
  return mu__invariant_44( 3, 3 );
}

bool mu__condition_77() // Condition for Rule "CntrlProp, j:3, i:4"
{
  return mu__invariant_44( 3, 4 );
}

bool mu__condition_78() // Condition for Rule "CntrlProp, j:3, i:5"
{
  return mu__invariant_44( 3, 5 );
}

bool mu__condition_79() // Condition for Rule "CntrlProp, j:3, i:6"
{
  return mu__invariant_44( 3, 6 );
}

bool mu__condition_80() // Condition for Rule "CntrlProp, j:3, i:7"
{
  return mu__invariant_44( 3, 7 );
}

bool mu__condition_81() // Condition for Rule "CntrlProp, j:3, i:8"
{
  return mu__invariant_44( 3, 8 );
}

bool mu__condition_82() // Condition for Rule "CntrlProp, j:3, i:9"
{
  return mu__invariant_44( 3, 9 );
}

bool mu__condition_83() // Condition for Rule "CntrlProp, j:3, i:10"
{
  return mu__invariant_44( 3, 10 );
}

bool mu__condition_85() // Condition for Rule "CntrlProp, j:4, i:1"
{
  return mu__invariant_44( 4, 1 );
}

bool mu__condition_86() // Condition for Rule "CntrlProp, j:4, i:2"
{
  return mu__invariant_44( 4, 2 );
}

bool mu__condition_87() // Condition for Rule "CntrlProp, j:4, i:3"
{
  return mu__invariant_44( 4, 3 );
}

bool mu__condition_88() // Condition for Rule "CntrlProp, j:4, i:4"
{
  return mu__invariant_44( 4, 4 );
}

bool mu__condition_89() // Condition for Rule "CntrlProp, j:4, i:5"
{
  return mu__invariant_44( 4, 5 );
}

bool mu__condition_90() // Condition for Rule "CntrlProp, j:4, i:6"
{
  return mu__invariant_44( 4, 6 );
}

bool mu__condition_91() // Condition for Rule "CntrlProp, j:4, i:7"
{
  return mu__invariant_44( 4, 7 );
}

bool mu__condition_92() // Condition for Rule "CntrlProp, j:4, i:8"
{
  return mu__invariant_44( 4, 8 );
}

bool mu__condition_93() // Condition for Rule "CntrlProp, j:4, i:9"
{
  return mu__invariant_44( 4, 9 );
}

bool mu__condition_94() // Condition for Rule "CntrlProp, j:4, i:10"
{
  return mu__invariant_44( 4, 10 );
}

bool mu__condition_96() // Condition for Rule "CntrlProp, j:5, i:1"
{
  return mu__invariant_44( 5, 1 );
}

bool mu__condition_97() // Condition for Rule "CntrlProp, j:5, i:2"
{
  return mu__invariant_44( 5, 2 );
}

bool mu__condition_98() // Condition for Rule "CntrlProp, j:5, i:3"
{
  return mu__invariant_44( 5, 3 );
}

bool mu__condition_99() // Condition for Rule "CntrlProp, j:5, i:4"
{
  return mu__invariant_44( 5, 4 );
}

bool mu__condition_100() // Condition for Rule "CntrlProp, j:5, i:5"
{
  return mu__invariant_44( 5, 5 );
}

bool mu__condition_101() // Condition for Rule "CntrlProp, j:5, i:6"
{
  return mu__invariant_44( 5, 6 );
}

bool mu__condition_102() // Condition for Rule "CntrlProp, j:5, i:7"
{
  return mu__invariant_44( 5, 7 );
}

bool mu__condition_103() // Condition for Rule "CntrlProp, j:5, i:8"
{
  return mu__invariant_44( 5, 8 );
}

bool mu__condition_104() // Condition for Rule "CntrlProp, j:5, i:9"
{
  return mu__invariant_44( 5, 9 );
}

bool mu__condition_105() // Condition for Rule "CntrlProp, j:5, i:10"
{
  return mu__invariant_44( 5, 10 );
}

bool mu__condition_107() // Condition for Rule "CntrlProp, j:6, i:1"
{
  return mu__invariant_44( 6, 1 );
}

bool mu__condition_108() // Condition for Rule "CntrlProp, j:6, i:2"
{
  return mu__invariant_44( 6, 2 );
}

bool mu__condition_109() // Condition for Rule "CntrlProp, j:6, i:3"
{
  return mu__invariant_44( 6, 3 );
}

bool mu__condition_110() // Condition for Rule "CntrlProp, j:6, i:4"
{
  return mu__invariant_44( 6, 4 );
}

bool mu__condition_111() // Condition for Rule "CntrlProp, j:6, i:5"
{
  return mu__invariant_44( 6, 5 );
}

bool mu__condition_112() // Condition for Rule "CntrlProp, j:6, i:6"
{
  return mu__invariant_44( 6, 6 );
}

bool mu__condition_113() // Condition for Rule "CntrlProp, j:6, i:7"
{
  return mu__invariant_44( 6, 7 );
}

bool mu__condition_114() // Condition for Rule "CntrlProp, j:6, i:8"
{
  return mu__invariant_44( 6, 8 );
}

bool mu__condition_115() // Condition for Rule "CntrlProp, j:6, i:9"
{
  return mu__invariant_44( 6, 9 );
}

bool mu__condition_116() // Condition for Rule "CntrlProp, j:6, i:10"
{
  return mu__invariant_44( 6, 10 );
}

bool mu__condition_118() // Condition for Rule "CntrlProp, j:7, i:1"
{
  return mu__invariant_44( 7, 1 );
}

bool mu__condition_119() // Condition for Rule "CntrlProp, j:7, i:2"
{
  return mu__invariant_44( 7, 2 );
}

bool mu__condition_120() // Condition for Rule "CntrlProp, j:7, i:3"
{
  return mu__invariant_44( 7, 3 );
}

bool mu__condition_121() // Condition for Rule "CntrlProp, j:7, i:4"
{
  return mu__invariant_44( 7, 4 );
}

bool mu__condition_122() // Condition for Rule "CntrlProp, j:7, i:5"
{
  return mu__invariant_44( 7, 5 );
}

bool mu__condition_123() // Condition for Rule "CntrlProp, j:7, i:6"
{
  return mu__invariant_44( 7, 6 );
}

bool mu__condition_124() // Condition for Rule "CntrlProp, j:7, i:7"
{
  return mu__invariant_44( 7, 7 );
}

bool mu__condition_125() // Condition for Rule "CntrlProp, j:7, i:8"
{
  return mu__invariant_44( 7, 8 );
}

bool mu__condition_126() // Condition for Rule "CntrlProp, j:7, i:9"
{
  return mu__invariant_44( 7, 9 );
}

bool mu__condition_127() // Condition for Rule "CntrlProp, j:7, i:10"
{
  return mu__invariant_44( 7, 10 );
}

bool mu__condition_129() // Condition for Rule "CntrlProp, j:8, i:1"
{
  return mu__invariant_44( 8, 1 );
}

bool mu__condition_130() // Condition for Rule "CntrlProp, j:8, i:2"
{
  return mu__invariant_44( 8, 2 );
}

bool mu__condition_131() // Condition for Rule "CntrlProp, j:8, i:3"
{
  return mu__invariant_44( 8, 3 );
}

bool mu__condition_132() // Condition for Rule "CntrlProp, j:8, i:4"
{
  return mu__invariant_44( 8, 4 );
}

bool mu__condition_133() // Condition for Rule "CntrlProp, j:8, i:5"
{
  return mu__invariant_44( 8, 5 );
}

bool mu__condition_134() // Condition for Rule "CntrlProp, j:8, i:6"
{
  return mu__invariant_44( 8, 6 );
}

bool mu__condition_135() // Condition for Rule "CntrlProp, j:8, i:7"
{
  return mu__invariant_44( 8, 7 );
}

bool mu__condition_136() // Condition for Rule "CntrlProp, j:8, i:8"
{
  return mu__invariant_44( 8, 8 );
}

bool mu__condition_137() // Condition for Rule "CntrlProp, j:8, i:9"
{
  return mu__invariant_44( 8, 9 );
}

bool mu__condition_138() // Condition for Rule "CntrlProp, j:8, i:10"
{
  return mu__invariant_44( 8, 10 );
}

bool mu__condition_140() // Condition for Rule "CntrlProp, j:9, i:1"
{
  return mu__invariant_44( 9, 1 );
}

bool mu__condition_141() // Condition for Rule "CntrlProp, j:9, i:2"
{
  return mu__invariant_44( 9, 2 );
}

bool mu__condition_142() // Condition for Rule "CntrlProp, j:9, i:3"
{
  return mu__invariant_44( 9, 3 );
}

bool mu__condition_143() // Condition for Rule "CntrlProp, j:9, i:4"
{
  return mu__invariant_44( 9, 4 );
}

bool mu__condition_144() // Condition for Rule "CntrlProp, j:9, i:5"
{
  return mu__invariant_44( 9, 5 );
}

bool mu__condition_145() // Condition for Rule "CntrlProp, j:9, i:6"
{
  return mu__invariant_44( 9, 6 );
}

bool mu__condition_146() // Condition for Rule "CntrlProp, j:9, i:7"
{
  return mu__invariant_44( 9, 7 );
}

bool mu__condition_147() // Condition for Rule "CntrlProp, j:9, i:8"
{
  return mu__invariant_44( 9, 8 );
}

bool mu__condition_148() // Condition for Rule "CntrlProp, j:9, i:9"
{
  return mu__invariant_44( 9, 9 );
}

bool mu__condition_149() // Condition for Rule "CntrlProp, j:9, i:10"
{
  return mu__invariant_44( 9, 10 );
}

bool mu__condition_151() // Condition for Rule "CntrlProp, j:10, i:1"
{
  return mu__invariant_44( 10, 1 );
}

bool mu__condition_152() // Condition for Rule "CntrlProp, j:10, i:2"
{
  return mu__invariant_44( 10, 2 );
}

bool mu__condition_153() // Condition for Rule "CntrlProp, j:10, i:3"
{
  return mu__invariant_44( 10, 3 );
}

bool mu__condition_154() // Condition for Rule "CntrlProp, j:10, i:4"
{
  return mu__invariant_44( 10, 4 );
}

bool mu__condition_155() // Condition for Rule "CntrlProp, j:10, i:5"
{
  return mu__invariant_44( 10, 5 );
}

bool mu__condition_156() // Condition for Rule "CntrlProp, j:10, i:6"
{
  return mu__invariant_44( 10, 6 );
}

bool mu__condition_157() // Condition for Rule "CntrlProp, j:10, i:7"
{
  return mu__invariant_44( 10, 7 );
}

bool mu__condition_158() // Condition for Rule "CntrlProp, j:10, i:8"
{
  return mu__invariant_44( 10, 8 );
}

bool mu__condition_159() // Condition for Rule "CntrlProp, j:10, i:9"
{
  return mu__invariant_44( 10, 9 );
}

bool mu__condition_160() // Condition for Rule "CntrlProp, j:10, i:10"
{
...
{"CntrlProp, j:10, i:10", &mu__condition_160, NULL, },
{"CntrlProp, j:10, i:9", &mu__condition_159, NULL, },
{"CntrlProp, j:10, i:8", &mu__condition_158, NULL, },
{"CntrlProp, j:10, i:7", &mu__condition_157, NULL, },
{"CntrlProp, j:10, i:6", &mu__condition_156, NULL, },
{"CntrlProp, j:10, i:5", &mu__condition_155, NULL, },
{"CntrlProp, j:10, i:4", &mu__condition_154, NULL, },
{"CntrlProp, j:10, i:3", &mu__condition_153, NULL, },
{"CntrlProp, j:10, i:2", &mu__condition_152, NULL, },
{"CntrlProp, j:10, i:1", &mu__condition_151, NULL, },
{"CntrlProp, j:9, i:10", &mu__condition_149, NULL, },
{"CntrlProp, j:9, i:9", &mu__condition_148, NULL, },
{"CntrlProp, j:9, i:8", &mu__condition_147, NULL, },
{"CntrlProp, j:9, i:7", &mu__condition_146, NULL, },
{"CntrlProp, j:9, i:6", &mu__condition_145, NULL, },
{"CntrlProp, j:9, i:5", &mu__condition_144, NULL, },
{"CntrlProp, j:9, i:4", &mu__condition_143, NULL, },
{"CntrlProp, j:9, i:3", &mu__condition_142, NULL, },
{"CntrlProp, j:9, i:2", &mu__condition_141, NULL, },
{"CntrlProp, j:9, i:1", &mu__condition_140, NULL, },
{"CntrlProp, j:8, i:10", &mu__condition_138, NULL, },
{"CntrlProp, j:8, i:9", &mu__condition_137, NULL, },
{"CntrlProp, j:8, i:8", &mu__condition_136, NULL, },
{"CntrlProp, j:8, i:7", &mu__condition_135, NULL, },
{"CntrlProp, j:8, i:6", &mu__condition_134, NULL, },
{"CntrlProp, j:8, i:5", &mu__condition_133, NULL, },
{"CntrlProp, j:8, i:4", &mu__condition_132, NULL, },
{"CntrlProp, j:8, i:3", &mu__condition_131, NULL, },
{"CntrlProp, j:8, i:2", &mu__condition_130, NULL, },
{"CntrlProp, j:8, i:1", &mu__condition_129, NULL, },
{"CntrlProp, j:7, i:10", &mu__condition_127, NULL, },
{"CntrlProp, j:7, i:9", &mu__condition_126, NULL, },
{"CntrlProp, j:7, i:8", &mu__condition_125, NULL, },
{"CntrlProp, j:7, i:7", &mu__condition_124, NULL, },
{"CntrlProp, j:7, i:6", &mu__condition_123, NULL, },
{"CntrlProp, j:7, i:5", &mu__condition_122, NULL, },
{"CntrlProp, j:7, i:4", &mu__condition_121, NULL, },
{"CntrlProp, j:7, i:3", &mu__condition_120, NULL, },
{"CntrlProp, j:7, i:2", &mu__condition_119, NULL, },
{"CntrlProp, j:7, i:1", &mu__condition_118, NULL, },
{"CntrlProp, j:6, i:10", &mu__condition_116, NULL, },
{"CntrlProp, j:6, i:9", &mu__condition_115, NULL, },
{"CntrlProp, j:6, i:8", &mu__condition_114, NULL, },
{"CntrlProp, j:6, i:7", &mu__condition_113, NULL, },
{"CntrlProp, j:6, i:6", &mu__condition_112, NULL, },
{"CntrlProp, j:6, i:5", &mu__condition_111, NULL, },
{"CntrlProp, j:6, i:4", &mu__condition_110, NULL, },
{"CntrlProp, j:6, i:3", &mu__condition_109, NULL, },
{"CntrlProp, j:6, i:2", &mu__condition_108, NULL, },
{"CntrlProp, j:6, i:1", &mu__condition_107, NULL, },
{"CntrlProp, j:5, i:10", &mu__condition_105, NULL, },
{"CntrlProp, j:5, i:9", &mu__condition_104, NULL, },
{"CntrlProp, j:5, i:8", &mu__condition_103, NULL, },
{"CntrlProp, j:5, i:7", &mu__condition_102, NULL, },
{"CntrlProp, j:5, i:6", &mu__condition_101, NULL, },
{"CntrlProp, j:5, i:5", &mu__condition_100, NULL, },
{"CntrlProp, j:5, i:4", &mu__condition_99, NULL, },
{"CntrlProp, j:5, i:3", &mu__condition_98, NULL, },
{"CntrlProp, j:5, i:2", &mu__condition_97, NULL, },
{"CntrlProp, j:5, i:1", &mu__condition_96, NULL, },
{"CntrlProp, j:4, i:10", &mu__condition_94, NULL, },
{"CntrlProp, j:4, i:9", &mu__condition_93, NULL, },
{"CntrlProp, j:4, i:8", &mu__condition_92, NULL, },
{"CntrlProp, j:4, i:7", &mu__condition_91, NULL, },
{"CntrlProp, j:4, i:6", &mu__condition_90, NULL, },
{"CntrlProp, j:4, i:5", &mu__condition_89, NULL, },
{"CntrlProp, j:4, i:4", &mu__condition_88, NULL, },
{"CntrlProp, j:4, i:3", &mu__condition_87, NULL, },
{"CntrlProp, j:4, i:2", &mu__condition_86, NULL, },
{"CntrlProp, j:4, i:1", &mu__condition_85, NULL, },
{"CntrlProp, j:3, i:10", &mu__condition_83, NULL, },
{"CntrlProp, j:3, i:9", &mu__condition_82, NULL, },
{"CntrlProp, j:3, i:8", &mu__condition_81, NULL, },
{"CntrlProp, j:3, i:7", &mu__condition_80, NULL, },
{"CntrlProp, j:3, i:6", &mu__condition_79, NULL, },
{"CntrlProp, j:3, i:5", &mu__condition_78, NULL, },
{"CntrlProp, j:3, i:4", &mu__condition_77, NULL, },
{"CntrlProp, j:3, i:3", &mu__condition_76, NULL, },
{"CntrlProp, j:3, i:2", &mu__condition_75, NULL, },
{"CntrlProp, j:3, i:1", &mu__condition_74, NULL, },
{"CntrlProp, j:2, i:10", &mu__condition_72, NULL, },
{"CntrlProp, j:2, i:9", &mu__condition_71, NULL, },
{"CntrlProp, j:2, i:8", &mu__condition_70, NULL, },
{"CntrlProp, j:2, i:7", &mu__condition_69, NULL, },
{"CntrlProp, j:2, i:6", &mu__condition_68, NULL, },
{"CntrlProp, j:2, i:5", &mu__condition_67, NULL, },
{"CntrlProp, j:2, i:4", &mu__condition_66, NULL, },
{"CntrlProp, j:2, i:3", &mu__condition_65, NULL, },
{"CntrlProp, j:2, i:2", &mu__condition_64, NULL, },
{"CntrlProp, j:2, i:1", &mu__condition_63, NULL, },
