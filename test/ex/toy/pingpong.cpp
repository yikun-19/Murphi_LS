/******************************
  Program "pingpong.m" compiled by "Caching Murphi Release 5.5.0"
...
class mu_1_player_t: public mu__byte
{
 public:
  ...
  mu_1_player_t (const char *name, int os): mu__byte(0, 1, 2, name, os) {};
...
void mu_1__type_0::set_self(const char *n, int os)
{
  ...
  if (name) mu_hasball.set_self_2(name, ".hasball", os + 0 ); else mu_hasball.set_self_2(NULL, NULL, 0);
  if (name) mu_gotball.set_self_2(name, ".gotball", os + 8 ); else mu_gotball.set_self_2(NULL, NULL, 0);
}
...
{"Only one ball in play.", &mu__condition_11, NULL, },
};
