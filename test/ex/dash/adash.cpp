/******************************
  Program "./ex/dash/adash.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./ex/dash/adash"
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  mu_1_RequestType (const char *name, int os): mu__byte(7, 19, 4, name, os) {};
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  mu_1_ReplyType (const char *name, int os): mu__byte(20, 23, 3, name, os) {};
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  mu_1_RAC_State (const char *name, int os): mu__byte(24, 32, 4, name, os) {};
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  mu_1_CacheState (const char *name, int os): mu__byte(33, 35, 2, name, os) {};
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  mu_1__type_1 (const char *name, int os): mu__byte(36, 38, 2, name, os) {};
...
class mu_1__type_12: public mu__byte
{
 public:
  ...
  mu_1__type_12 (const char *name, int os): mu__byte(0, 6, 3, name, os) {};
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
  mu__subrange_31 (void): mu__byte(0, 5, 3) {};
  mu__subrange_31 (int val): mu__byte(0, 5, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 200 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 200 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 200 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 600 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 600 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 600 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_17: public mu__byte
{
 public:
  ...
  mu_1__type_17 (const char *name, int os): mu__byte(0, 6, 3, name, os) {};
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
  mu__subrange_37 (void): mu__byte(0, 5, 3) {};
  mu__subrange_37 (int val): mu__byte(0, 5, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 248 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 248 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 248 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 744 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 744 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 744 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu__subrange_45: public mu__byte
{
 public:
  ...
  mu__subrange_45 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu__subrange_47: public mu__byte
{
 public:
  ...
  mu__subrange_47 (const char *name, int os): mu__byte(0, 1, 2, name, os) {};
  mu__subrange_47 (void): mu__byte(0, 1, 2) {};
  mu__subrange_47 (int val): mu__byte(0, 1, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_48: public mu__byte
{
 public:
  ...
  mu__subrange_48 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_49: public mu__byte
{
 public:
  ...
  mu__subrange_49 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_50: public mu__byte
{
 public:
  ...
  mu__subrange_50 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_51: public mu__byte
{
 public:
  ...
  mu__subrange_51 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_52: public mu__byte
{
 public:
  ...
  mu__subrange_52 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_53: public mu__byte
{
 public:
  ...
  mu__subrange_53 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
...
class mu__subrange_54: public mu__byte
{
 public:
  ...
  mu__subrange_54 (const char *name, int os): mu__byte(0, 5, 3, name, os) {};
  mu__subrange_54 (void): mu__byte(0, 5, 3) {};
  mu__subrange_54 (int val): mu__byte(0, 5, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
