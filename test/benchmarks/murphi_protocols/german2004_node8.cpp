/******************************
  Program "./benchmarks/murphi_protocols/german2004_node8.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/german2004_node8"
#define BITS_IN_WORLD 16016
#define ALIGN
...
class mu_1_node_id: public mu__byte
{
 public:
  ...
  mu_1_node_id (const char *name, int os): mu__byte(0, 8, 4, name, os) {};
  mu_1_node_id (void): mu__byte(0, 8, 4) {};
  mu_1_node_id (int val): mu__byte(0, 8, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
void mu_1_home_request_type::set_self(const char *n, int os)
{
  ...
  if (name) mu_status.set_self_2(name, ".status", os + 120 ); else mu_status.set_self_2(NULL, NULL, 0);
}
...
void mu_1_node_type::set_self(const char *n, int os)
{
  ...
  if (name) mu_local_requests.set_self_2(name, ".local_requests", os + 576 ); else mu_local_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_home_requests.set_self_2(name, ".home_requests", os + 608 ); else mu_home_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_remote_requests.set_self_2(name, ".remote_requests", os + 1120 ); else mu_remote_requests.set_self_2(NULL, NULL, 0);
  if (name) mu_inchan.set_self_2(name, ".inchan", os + 1344 ); else mu_inchan.set_self_2(NULL, NULL, 0);
  if (name) mu_outchan.set_self_2(name, ".outchan", os + 1560 ); else mu_outchan.set_self_2(NULL, NULL, 0);
}
...
void mu_1__type_11::set_self( const char *n, int os)
{
  ...
  name = (char *)n;
  for(int i = 0; i < 9; i++) {
    array[i].set_self_ar(n, s=tsprintf("%d",i + 0), i * 1776 + os);
    delete[] s;
  }
};
...
/*** Variable declaration ***/
mu_1_data_type mu_auxdata("auxdata",15984);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=972 && what_rule<1944)
    { R1.NextRule(what_rule);
      if (what_rule<1944) return; }
  if (what_rule>=1944 && what_rule<2916)
    { R2.NextRule(what_rule);
      if (what_rule<2916) return; }
  if (what_rule>=2916 && what_rule<3888)
    { R3.NextRule(what_rule);
      if (what_rule<3888) return; }
  if (what_rule>=3888 && what_rule<4176)
    { R4.NextRule(what_rule);
      if (what_rule<4176) return; }
  if (what_rule>=4176 && what_rule<4284)
    { R5.NextRule(what_rule);
      if (what_rule<4284) return; }
  if (what_rule>=4284 && what_rule<4392)
    { R6.NextRule(what_rule);
      if (what_rule<4392) return; }
  if (what_rule>=4392 && what_rule<4428)
    { R7.NextRule(what_rule);
      if (what_rule<4428) return; }
  if (what_rule>=4428 && what_rule<4536)
    { R8.NextRule(what_rule);
      if (what_rule<4536) return; }
  if (what_rule>=4536 && what_rule<4860)
    { R9.NextRule(what_rule);
      if (what_rule<4860) return; }
  if (what_rule>=4860 && what_rule<5103)
    { R10.NextRule(what_rule);
      if (what_rule<5103) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  if (r<=971) return R0.Condition(r-0);
  if (r>=972 && r<=1943) return R1.Condition(r-972);
  if (r>=1944 && r<=2915) return R2.Condition(r-1944);
  if (r>=2916 && r<=3887) return R3.Condition(r-2916);
  if (r>=3888 && r<=4175) return R4.Condition(r-3888);
  if (r>=4176 && r<=4283) return R5.Condition(r-4176);
  if (r>=4284 && r<=4391) return R6.Condition(r-4284);
  if (r>=4392 && r<=4427) return R7.Condition(r-4392);
  if (r>=4428 && r<=4535) return R8.Condition(r-4428);
  if (r>=4536 && r<=4859) return R9.Condition(r-4536);
  if (r>=4860 && r<=5102) return R10.Condition(r-4860);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
return 0;}
void Code(unsigned r)
{
  if (r<=971) { R0.Code(r-0); return; } 
  if (r>=972 && r<=1943) { R1.Code(r-972); return; } 
  if (r>=1944 && r<=2915) { R2.Code(r-1944); return; } 
  if (r>=2916 && r<=3887) { R3.Code(r-2916); return; } 
  if (r>=3888 && r<=4175) { R4.Code(r-3888); return; } 
  if (r>=4176 && r<=4283) { R5.Code(r-4176); return; } 
  if (r>=4284 && r<=4391) { R6.Code(r-4284); return; } 
  if (r>=4392 && r<=4427) { R7.Code(r-4392); return; } 
  if (r>=4428 && r<=4535) { R8.Code(r-4428); return; } 
  if (r>=4536 && r<=4859) { R9.Code(r-4536); return; } 
  if (r>=4860 && r<=5102) { R10.Code(r-4860); return; } 
}
int Priority(unsigned short r)
{
  if (r<=971) { return R0.Priority(); } 
  if (r>=972 && r<=1943) { return R1.Priority(); } 
  if (r>=1944 && r<=2915) { return R2.Priority(); } 
  if (r>=2916 && r<=3887) { return R3.Priority(); } 
  if (r>=3888 && r<=4175) { return R4.Priority(); } 
  if (r>=4176 && r<=4283) { return R5.Priority(); } 
  if (r>=4284 && r<=4391) { return R6.Priority(); } 
  if (r>=4392 && r<=4427) { return R7.Priority(); } 
  if (r>=4428 && r<=4535) { return R8.Priority(); } 
  if (r>=4536 && r<=4859) { return R9.Priority(); } 
  if (r>=4860 && r<=5102) { return R10.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=971) return R0.Name(r-0);
  if (r>=972 && r<=1943) return R1.Name(r-972);
  if (r>=1944 && r<=2915) return R2.Name(r-1944);
  if (r>=2916 && r<=3887) return R3.Name(r-2916);
  if (r>=3888 && r<=4175) return R4.Name(r-3888);
  if (r>=4176 && r<=4283) return R5.Name(r-4176);
  if (r>=4284 && r<=4391) return R6.Name(r-4284);
  if (r>=4392 && r<=4427) return R7.Name(r-4392);
  if (r>=4428 && r<=4535) return R8.Name(r-4428);
  if (r>=4536 && r<=4859) return R9.Name(r-4536);
  if (r>=4860 && r<=5102) return R10.Name(r-4860);
  return NULL;
}
};
const unsigned numrules = 5103;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 5103
...
bool mu__condition_119() // Condition for Rule "coherent, addr:0, n2:0, n1:5"
{
  return mu__invariant_108( 0, 0, 5 );
}

bool mu__condition_120() // Condition for Rule "coherent, addr:0, n2:0, n1:6"
{
  return mu__invariant_108( 0, 0, 6 );
}

bool mu__condition_121() // Condition for Rule "coherent, addr:0, n2:0, n1:7"
{
  return mu__invariant_108( 0, 0, 7 );
}

bool mu__condition_122() // Condition for Rule "coherent, addr:0, n2:0, n1:8"
{
  return mu__invariant_108( 0, 0, 8 );
}

bool mu__condition_124() // Condition for Rule "coherent, addr:0, n2:1, n1:0"
{
  return mu__invariant_108( 0, 1, 0 );
}

bool mu__condition_125() // Condition for Rule "coherent, addr:0, n2:1, n1:1"
{
  return mu__invariant_108( 0, 1, 1 );
}

bool mu__condition_126() // Condition for Rule "coherent, addr:0, n2:1, n1:2"
{
  return mu__invariant_108( 0, 1, 2 );
}

bool mu__condition_127() // Condition for Rule "coherent, addr:0, n2:1, n1:3"
{
  return mu__invariant_108( 0, 1, 3 );
}

bool mu__condition_128() // Condition for Rule "coherent, addr:0, n2:1, n1:4"
{
  return mu__invariant_108( 0, 1, 4 );
}

bool mu__condition_129() // Condition for Rule "coherent, addr:0, n2:1, n1:5"
{
  return mu__invariant_108( 0, 1, 5 );
}

bool mu__condition_130() // Condition for Rule "coherent, addr:0, n2:1, n1:6"
{
  return mu__invariant_108( 0, 1, 6 );
}

bool mu__condition_131() // Condition for Rule "coherent, addr:0, n2:1, n1:7"
{
  return mu__invariant_108( 0, 1, 7 );
}

bool mu__condition_132() // Condition for Rule "coherent, addr:0, n2:1, n1:8"
{
  return mu__invariant_108( 0, 1, 8 );
}

bool mu__condition_134() // Condition for Rule "coherent, addr:0, n2:2, n1:0"
{
  return mu__invariant_108( 0, 2, 0 );
}

bool mu__condition_135() // Condition for Rule "coherent, addr:0, n2:2, n1:1"
{
  return mu__invariant_108( 0, 2, 1 );
}

bool mu__condition_136() // Condition for Rule "coherent, addr:0, n2:2, n1:2"
{
  return mu__invariant_108( 0, 2, 2 );
}

bool mu__condition_137() // Condition for Rule "coherent, addr:0, n2:2, n1:3"
{
  return mu__invariant_108( 0, 2, 3 );
}

bool mu__condition_138() // Condition for Rule "coherent, addr:0, n2:2, n1:4"
{
  return mu__invariant_108( 0, 2, 4 );
}

bool mu__condition_139() // Condition for Rule "coherent, addr:0, n2:2, n1:5"
{
  return mu__invariant_108( 0, 2, 5 );
}

bool mu__condition_140() // Condition for Rule "coherent, addr:0, n2:2, n1:6"
{
  return mu__invariant_108( 0, 2, 6 );
}

bool mu__condition_141() // Condition for Rule "coherent, addr:0, n2:2, n1:7"
{
  return mu__invariant_108( 0, 2, 7 );
}

bool mu__condition_142() // Condition for Rule "coherent, addr:0, n2:2, n1:8"
{
  return mu__invariant_108( 0, 2, 8 );
}

bool mu__condition_144() // Condition for Rule "coherent, addr:0, n2:3, n1:0"
{
  return mu__invariant_108( 0, 3, 0 );
}

bool mu__condition_145() // Condition for Rule "coherent, addr:0, n2:3, n1:1"
{
  return mu__invariant_108( 0, 3, 1 );
}

bool mu__condition_146() // Condition for Rule "coherent, addr:0, n2:3, n1:2"
{
  return mu__invariant_108( 0, 3, 2 );
}

bool mu__condition_147() // Condition for Rule "coherent, addr:0, n2:3, n1:3"
{
  return mu__invariant_108( 0, 3, 3 );
}

bool mu__condition_148() // Condition for Rule "coherent, addr:0, n2:3, n1:4"
{
  return mu__invariant_108( 0, 3, 4 );
}

bool mu__condition_149() // Condition for Rule "coherent, addr:0, n2:3, n1:5"
{
  return mu__invariant_108( 0, 3, 5 );
}

bool mu__condition_150() // Condition for Rule "coherent, addr:0, n2:3, n1:6"
{
  return mu__invariant_108( 0, 3, 6 );
}

bool mu__condition_151() // Condition for Rule "coherent, addr:0, n2:3, n1:7"
{
  return mu__invariant_108( 0, 3, 7 );
}

bool mu__condition_152() // Condition for Rule "coherent, addr:0, n2:3, n1:8"
{
  return mu__invariant_108( 0, 3, 8 );
}

bool mu__condition_154() // Condition for Rule "coherent, addr:0, n2:4, n1:0"
{
  return mu__invariant_108( 0, 4, 0 );
}

bool mu__condition_155() // Condition for Rule "coherent, addr:0, n2:4, n1:1"
{
  return mu__invariant_108( 0, 4, 1 );
}

bool mu__condition_156() // Condition for Rule "coherent, addr:0, n2:4, n1:2"
{
  return mu__invariant_108( 0, 4, 2 );
}

bool mu__condition_157() // Condition for Rule "coherent, addr:0, n2:4, n1:3"
{
  return mu__invariant_108( 0, 4, 3 );
}

bool mu__condition_158() // Condition for Rule "coherent, addr:0, n2:4, n1:4"
{
  return mu__invariant_108( 0, 4, 4 );
}

bool mu__condition_159() // Condition for Rule "coherent, addr:0, n2:4, n1:5"
{
  return mu__invariant_108( 0, 4, 5 );
}

bool mu__condition_160() // Condition for Rule "coherent, addr:0, n2:4, n1:6"
{
  return mu__invariant_108( 0, 4, 6 );
}

bool mu__condition_161() // Condition for Rule "coherent, addr:0, n2:4, n1:7"
{
  return mu__invariant_108( 0, 4, 7 );
}

bool mu__condition_162() // Condition for Rule "coherent, addr:0, n2:4, n1:8"
{
  return mu__invariant_108( 0, 4, 8 );
}

bool mu__condition_164() // Condition for Rule "coherent, addr:0, n2:5, n1:0"
{
  return mu__invariant_108( 0, 5, 0 );
}

bool mu__condition_165() // Condition for Rule "coherent, addr:0, n2:5, n1:1"
{
  return mu__invariant_108( 0, 5, 1 );
}

bool mu__condition_166() // Condition for Rule "coherent, addr:0, n2:5, n1:2"
{
  return mu__invariant_108( 0, 5, 2 );
}

bool mu__condition_167() // Condition for Rule "coherent, addr:0, n2:5, n1:3"
{
  return mu__invariant_108( 0, 5, 3 );
}

bool mu__condition_168() // Condition for Rule "coherent, addr:0, n2:5, n1:4"
{
  return mu__invariant_108( 0, 5, 4 );
}

bool mu__condition_169() // Condition for Rule "coherent, addr:0, n2:5, n1:5"
{
  return mu__invariant_108( 0, 5, 5 );
}

bool mu__condition_170() // Condition for Rule "coherent, addr:0, n2:5, n1:6"
{
  return mu__invariant_108( 0, 5, 6 );
}

bool mu__condition_171() // Condition for Rule "coherent, addr:0, n2:5, n1:7"
{
  return mu__invariant_108( 0, 5, 7 );
}

bool mu__condition_172() // Condition for Rule "coherent, addr:0, n2:5, n1:8"
{
  return mu__invariant_108( 0, 5, 8 );
}

bool mu__condition_174() // Condition for Rule "coherent, addr:0, n2:6, n1:0"
{
  return mu__invariant_108( 0, 6, 0 );
}

bool mu__condition_175() // Condition for Rule "coherent, addr:0, n2:6, n1:1"
{
  return mu__invariant_108( 0, 6, 1 );
}

bool mu__condition_176() // Condition for Rule "coherent, addr:0, n2:6, n1:2"
{
  return mu__invariant_108( 0, 6, 2 );
}

bool mu__condition_177() // Condition for Rule "coherent, addr:0, n2:6, n1:3"
{
  return mu__invariant_108( 0, 6, 3 );
}

bool mu__condition_178() // Condition for Rule "coherent, addr:0, n2:6, n1:4"
{
  return mu__invariant_108( 0, 6, 4 );
}

bool mu__condition_179() // Condition for Rule "coherent, addr:0, n2:6, n1:5"
{
  return mu__invariant_108( 0, 6, 5 );
}

bool mu__condition_180() // Condition for Rule "coherent, addr:0, n2:6, n1:6"
{
  return mu__invariant_108( 0, 6, 6 );
}

bool mu__condition_181() // Condition for Rule "coherent, addr:0, n2:6, n1:7"
{
  return mu__invariant_108( 0, 6, 7 );
}

bool mu__condition_182() // Condition for Rule "coherent, addr:0, n2:6, n1:8"
{
  return mu__invariant_108( 0, 6, 8 );
}

bool mu__condition_184() // Condition for Rule "coherent, addr:0, n2:7, n1:0"
{
  return mu__invariant_108( 0, 7, 0 );
}

bool mu__condition_185() // Condition for Rule "coherent, addr:0, n2:7, n1:1"
{
  return mu__invariant_108( 0, 7, 1 );
}

bool mu__condition_186() // Condition for Rule "coherent, addr:0, n2:7, n1:2"
{
  return mu__invariant_108( 0, 7, 2 );
}

bool mu__condition_187() // Condition for Rule "coherent, addr:0, n2:7, n1:3"
{
  return mu__invariant_108( 0, 7, 3 );
}

bool mu__condition_188() // Condition for Rule "coherent, addr:0, n2:7, n1:4"
{
  return mu__invariant_108( 0, 7, 4 );
}

bool mu__condition_189() // Condition for Rule "coherent, addr:0, n2:7, n1:5"
{
  return mu__invariant_108( 0, 7, 5 );
}

bool mu__condition_190() // Condition for Rule "coherent, addr:0, n2:7, n1:6"
{
  return mu__invariant_108( 0, 7, 6 );
}

bool mu__condition_191() // Condition for Rule "coherent, addr:0, n2:7, n1:7"
{
  return mu__invariant_108( 0, 7, 7 );
}

bool mu__condition_192() // Condition for Rule "coherent, addr:0, n2:7, n1:8"
{
  return mu__invariant_108( 0, 7, 8 );
}

bool mu__condition_194() // Condition for Rule "coherent, addr:0, n2:8, n1:0"
{
  return mu__invariant_108( 0, 8, 0 );
}

bool mu__condition_195() // Condition for Rule "coherent, addr:0, n2:8, n1:1"
{
  return mu__invariant_108( 0, 8, 1 );
}

bool mu__condition_196() // Condition for Rule "coherent, addr:0, n2:8, n1:2"
{
  return mu__invariant_108( 0, 8, 2 );
}

bool mu__condition_197() // Condition for Rule "coherent, addr:0, n2:8, n1:3"
{
  return mu__invariant_108( 0, 8, 3 );
}

bool mu__condition_198() // Condition for Rule "coherent, addr:0, n2:8, n1:4"
{
  return mu__invariant_108( 0, 8, 4 );
}

bool mu__condition_199() // Condition for Rule "coherent, addr:0, n2:8, n1:5"
{
  return mu__invariant_108( 0, 8, 5 );
}

bool mu__condition_200() // Condition for Rule "coherent, addr:0, n2:8, n1:6"
{
  return mu__invariant_108( 0, 8, 6 );
}

bool mu__condition_201() // Condition for Rule "coherent, addr:0, n2:8, n1:7"
{
  return mu__invariant_108( 0, 8, 7 );
}

bool mu__condition_202() // Condition for Rule "coherent, addr:0, n2:8, n1:8"
{
  return mu__invariant_108( 0, 8, 8 );
}

bool mu__condition_205() // Condition for Rule "coherent, addr:1, n2:0, n1:0"
{
  return mu__invariant_108( 1, 0, 0 );
}

bool mu__condition_206() // Condition for Rule "coherent, addr:1, n2:0, n1:1"
{
  return mu__invariant_108( 1, 0, 1 );
}

bool mu__condition_207() // Condition for Rule "coherent, addr:1, n2:0, n1:2"
{
  return mu__invariant_108( 1, 0, 2 );
}

bool mu__condition_208() // Condition for Rule "coherent, addr:1, n2:0, n1:3"
{
  return mu__invariant_108( 1, 0, 3 );
}

bool mu__condition_209() // Condition for Rule "coherent, addr:1, n2:0, n1:4"
{
  return mu__invariant_108( 1, 0, 4 );
}

bool mu__condition_210() // Condition for Rule "coherent, addr:1, n2:0, n1:5"
{
  return mu__invariant_108( 1, 0, 5 );
}

bool mu__condition_211() // Condition for Rule "coherent, addr:1, n2:0, n1:6"
{
  return mu__invariant_108( 1, 0, 6 );
}

bool mu__condition_212() // Condition for Rule "coherent, addr:1, n2:0, n1:7"
{
  return mu__invariant_108( 1, 0, 7 );
}

bool mu__condition_213() // Condition for Rule "coherent, addr:1, n2:0, n1:8"
{
  return mu__invariant_108( 1, 0, 8 );
}

bool mu__condition_215() // Condition for Rule "coherent, addr:1, n2:1, n1:0"
{
  return mu__invariant_108( 1, 1, 0 );
}

bool mu__condition_216() // Condition for Rule "coherent, addr:1, n2:1, n1:1"
{
  return mu__invariant_108( 1, 1, 1 );
}

bool mu__condition_217() // Condition for Rule "coherent, addr:1, n2:1, n1:2"
{
  return mu__invariant_108( 1, 1, 2 );
}

bool mu__condition_218() // Condition for Rule "coherent, addr:1, n2:1, n1:3"
{
  return mu__invariant_108( 1, 1, 3 );
}

bool mu__condition_219() // Condition for Rule "coherent, addr:1, n2:1, n1:4"
{
  return mu__invariant_108( 1, 1, 4 );
}

bool mu__condition_220() // Condition for Rule "coherent, addr:1, n2:1, n1:5"
{
  return mu__invariant_108( 1, 1, 5 );
}

bool mu__condition_221() // Condition for Rule "coherent, addr:1, n2:1, n1:6"
{
  return mu__invariant_108( 1, 1, 6 );
}

bool mu__condition_222() // Condition for Rule "coherent, addr:1, n2:1, n1:7"
{
  return mu__invariant_108( 1, 1, 7 );
}

bool mu__condition_223() // Condition for Rule "coherent, addr:1, n2:1, n1:8"
{
  return mu__invariant_108( 1, 1, 8 );
}

bool mu__condition_225() // Condition for Rule "coherent, addr:1, n2:2, n1:0"
{
  return mu__invariant_108( 1, 2, 0 );
}

bool mu__condition_226() // Condition for Rule "coherent, addr:1, n2:2, n1:1"
{
  return mu__invariant_108( 1, 2, 1 );
}

bool mu__condition_227() // Condition for Rule "coherent, addr:1, n2:2, n1:2"
{
  return mu__invariant_108( 1, 2, 2 );
}

bool mu__condition_228() // Condition for Rule "coherent, addr:1, n2:2, n1:3"
{
  return mu__invariant_108( 1, 2, 3 );
}

bool mu__condition_229() // Condition for Rule "coherent, addr:1, n2:2, n1:4"
{
  return mu__invariant_108( 1, 2, 4 );
}

bool mu__condition_230() // Condition for Rule "coherent, addr:1, n2:2, n1:5"
{
  return mu__invariant_108( 1, 2, 5 );
}

bool mu__condition_231() // Condition for Rule "coherent, addr:1, n2:2, n1:6"
{
  return mu__invariant_108( 1, 2, 6 );
}

bool mu__condition_232() // Condition for Rule "coherent, addr:1, n2:2, n1:7"
{
  return mu__invariant_108( 1, 2, 7 );
}

bool mu__condition_233() // Condition for Rule "coherent, addr:1, n2:2, n1:8"
{
  return mu__invariant_108( 1, 2, 8 );
}

bool mu__condition_235() // Condition for Rule "coherent, addr:1, n2:3, n1:0"
{
  return mu__invariant_108( 1, 3, 0 );
}

bool mu__condition_236() // Condition for Rule "coherent, addr:1, n2:3, n1:1"
{
  return mu__invariant_108( 1, 3, 1 );
}

bool mu__condition_237() // Condition for Rule "coherent, addr:1, n2:3, n1:2"
{
  return mu__invariant_108( 1, 3, 2 );
}

bool mu__condition_238() // Condition for Rule "coherent, addr:1, n2:3, n1:3"
{
  return mu__invariant_108( 1, 3, 3 );
}

bool mu__condition_239() // Condition for Rule "coherent, addr:1, n2:3, n1:4"
{
  return mu__invariant_108( 1, 3, 4 );
}

bool mu__condition_240() // Condition for Rule "coherent, addr:1, n2:3, n1:5"
{
  return mu__invariant_108( 1, 3, 5 );
}

bool mu__condition_241() // Condition for Rule "coherent, addr:1, n2:3, n1:6"
{
  return mu__invariant_108( 1, 3, 6 );
}

bool mu__condition_242() // Condition for Rule "coherent, addr:1, n2:3, n1:7"
{
  return mu__invariant_108( 1, 3, 7 );
}

bool mu__condition_243() // Condition for Rule "coherent, addr:1, n2:3, n1:8"
{
  return mu__invariant_108( 1, 3, 8 );
}

bool mu__condition_245() // Condition for Rule "coherent, addr:1, n2:4, n1:0"
{
  return mu__invariant_108( 1, 4, 0 );
}

bool mu__condition_246() // Condition for Rule "coherent, addr:1, n2:4, n1:1"
{
  return mu__invariant_108( 1, 4, 1 );
}

bool mu__condition_247() // Condition for Rule "coherent, addr:1, n2:4, n1:2"
{
  return mu__invariant_108( 1, 4, 2 );
}

bool mu__condition_248() // Condition for Rule "coherent, addr:1, n2:4, n1:3"
{
  return mu__invariant_108( 1, 4, 3 );
}

bool mu__condition_249() // Condition for Rule "coherent, addr:1, n2:4, n1:4"
{
  return mu__invariant_108( 1, 4, 4 );
}

bool mu__condition_250() // Condition for Rule "coherent, addr:1, n2:4, n1:5"
{
  return mu__invariant_108( 1, 4, 5 );
}

bool mu__condition_251() // Condition for Rule "coherent, addr:1, n2:4, n1:6"
{
  return mu__invariant_108( 1, 4, 6 );
}

bool mu__condition_252() // Condition for Rule "coherent, addr:1, n2:4, n1:7"
{
  return mu__invariant_108( 1, 4, 7 );
}

bool mu__condition_253() // Condition for Rule "coherent, addr:1, n2:4, n1:8"
{
  return mu__invariant_108( 1, 4, 8 );
}

bool mu__condition_255() // Condition for Rule "coherent, addr:1, n2:5, n1:0"
{
  return mu__invariant_108( 1, 5, 0 );
}

bool mu__condition_256() // Condition for Rule "coherent, addr:1, n2:5, n1:1"
{
  return mu__invariant_108( 1, 5, 1 );
}

bool mu__condition_257() // Condition for Rule "coherent, addr:1, n2:5, n1:2"
{
  return mu__invariant_108( 1, 5, 2 );
}

bool mu__condition_258() // Condition for Rule "coherent, addr:1, n2:5, n1:3"
{
  return mu__invariant_108( 1, 5, 3 );
}

bool mu__condition_259() // Condition for Rule "coherent, addr:1, n2:5, n1:4"
{
  return mu__invariant_108( 1, 5, 4 );
}

bool mu__condition_260() // Condition for Rule "coherent, addr:1, n2:5, n1:5"
{
  return mu__invariant_108( 1, 5, 5 );
}

bool mu__condition_261() // Condition for Rule "coherent, addr:1, n2:5, n1:6"
{
  return mu__invariant_108( 1, 5, 6 );
}

bool mu__condition_262() // Condition for Rule "coherent, addr:1, n2:5, n1:7"
{
  return mu__invariant_108( 1, 5, 7 );
}

bool mu__condition_263() // Condition for Rule "coherent, addr:1, n2:5, n1:8"
{
  return mu__invariant_108( 1, 5, 8 );
}

bool mu__condition_265() // Condition for Rule "coherent, addr:1, n2:6, n1:0"
{
  return mu__invariant_108( 1, 6, 0 );
}

bool mu__condition_266() // Condition for Rule "coherent, addr:1, n2:6, n1:1"
{
  return mu__invariant_108( 1, 6, 1 );
}

bool mu__condition_267() // Condition for Rule "coherent, addr:1, n2:6, n1:2"
{
  return mu__invariant_108( 1, 6, 2 );
}

bool mu__condition_268() // Condition for Rule "coherent, addr:1, n2:6, n1:3"
{
  return mu__invariant_108( 1, 6, 3 );
}

bool mu__condition_269() // Condition for Rule "coherent, addr:1, n2:6, n1:4"
{
  return mu__invariant_108( 1, 6, 4 );
}

bool mu__condition_270() // Condition for Rule "coherent, addr:1, n2:6, n1:5"
{
  return mu__invariant_108( 1, 6, 5 );
}

bool mu__condition_271() // Condition for Rule "coherent, addr:1, n2:6, n1:6"
{
  return mu__invariant_108( 1, 6, 6 );
}

bool mu__condition_272() // Condition for Rule "coherent, addr:1, n2:6, n1:7"
{
  return mu__invariant_108( 1, 6, 7 );
}

bool mu__condition_273() // Condition for Rule "coherent, addr:1, n2:6, n1:8"
{
  return mu__invariant_108( 1, 6, 8 );
}

bool mu__condition_275() // Condition for Rule "coherent, addr:1, n2:7, n1:0"
{
  return mu__invariant_108( 1, 7, 0 );
}

bool mu__condition_276() // Condition for Rule "coherent, addr:1, n2:7, n1:1"
{
  return mu__invariant_108( 1, 7, 1 );
}

bool mu__condition_277() // Condition for Rule "coherent, addr:1, n2:7, n1:2"
{
  return mu__invariant_108( 1, 7, 2 );
}

bool mu__condition_278() // Condition for Rule "coherent, addr:1, n2:7, n1:3"
{
  return mu__invariant_108( 1, 7, 3 );
}

bool mu__condition_279() // Condition for Rule "coherent, addr:1, n2:7, n1:4"
{
  return mu__invariant_108( 1, 7, 4 );
}

bool mu__condition_280() // Condition for Rule "coherent, addr:1, n2:7, n1:5"
{
  return mu__invariant_108( 1, 7, 5 );
}

bool mu__condition_281() // Condition for Rule "coherent, addr:1, n2:7, n1:6"
{
  return mu__invariant_108( 1, 7, 6 );
}

bool mu__condition_282() // Condition for Rule "coherent, addr:1, n2:7, n1:7"
{
  return mu__invariant_108( 1, 7, 7 );
}

bool mu__condition_283() // Condition for Rule "coherent, addr:1, n2:7, n1:8"
{
  return mu__invariant_108( 1, 7, 8 );
}

bool mu__condition_285() // Condition for Rule "coherent, addr:1, n2:8, n1:0"
{
  return mu__invariant_108( 1, 8, 0 );
}

bool mu__condition_286() // Condition for Rule "coherent, addr:1, n2:8, n1:1"
{
  return mu__invariant_108( 1, 8, 1 );
}

bool mu__condition_287() // Condition for Rule "coherent, addr:1, n2:8, n1:2"
{
  return mu__invariant_108( 1, 8, 2 );
}

bool mu__condition_288() // Condition for Rule "coherent, addr:1, n2:8, n1:3"
{
  return mu__invariant_108( 1, 8, 3 );
}

bool mu__condition_289() // Condition for Rule "coherent, addr:1, n2:8, n1:4"
{
  return mu__invariant_108( 1, 8, 4 );
}

bool mu__condition_290() // Condition for Rule "coherent, addr:1, n2:8, n1:5"
{
  return mu__invariant_108( 1, 8, 5 );
}

bool mu__condition_291() // Condition for Rule "coherent, addr:1, n2:8, n1:6"
{
  return mu__invariant_108( 1, 8, 6 );
}

bool mu__condition_292() // Condition for Rule "coherent, addr:1, n2:8, n1:7"
{
  return mu__invariant_108( 1, 8, 7 );
}

bool mu__condition_293() // Condition for Rule "coherent, addr:1, n2:8, n1:8"
{
  return mu__invariant_108( 1, 8, 8 );
}

bool mu__condition_296() // Condition for Rule "coherent, addr:2, n2:0, n1:0"
{
  return mu__invariant_108( 2, 0, 0 );
}

bool mu__condition_297() // Condition for Rule "coherent, addr:2, n2:0, n1:1"
{
  return mu__invariant_108( 2, 0, 1 );
}

bool mu__condition_298() // Condition for Rule "coherent, addr:2, n2:0, n1:2"
{
  return mu__invariant_108( 2, 0, 2 );
}

bool mu__condition_299() // Condition for Rule "coherent, addr:2, n2:0, n1:3"
{
  return mu__invariant_108( 2, 0, 3 );
}

bool mu__condition_300() // Condition for Rule "coherent, addr:2, n2:0, n1:4"
{
  return mu__invariant_108( 2, 0, 4 );
}

bool mu__condition_301() // Condition for Rule "coherent, addr:2, n2:0, n1:5"
{
  return mu__invariant_108( 2, 0, 5 );
}

bool mu__condition_302() // Condition for Rule "coherent, addr:2, n2:0, n1:6"
{
  return mu__invariant_108( 2, 0, 6 );
}

bool mu__condition_303() // Condition for Rule "coherent, addr:2, n2:0, n1:7"
{
  return mu__invariant_108( 2, 0, 7 );
}

bool mu__condition_304() // Condition for Rule "coherent, addr:2, n2:0, n1:8"
{
  return mu__invariant_108( 2, 0, 8 );
}

bool mu__condition_306() // Condition for Rule "coherent, addr:2, n2:1, n1:0"
{
  return mu__invariant_108( 2, 1, 0 );
}

bool mu__condition_307() // Condition for Rule "coherent, addr:2, n2:1, n1:1"
{
  return mu__invariant_108( 2, 1, 1 );
}

bool mu__condition_308() // Condition for Rule "coherent, addr:2, n2:1, n1:2"
{
  return mu__invariant_108( 2, 1, 2 );
}

bool mu__condition_309() // Condition for Rule "coherent, addr:2, n2:1, n1:3"
{
  return mu__invariant_108( 2, 1, 3 );
}

bool mu__condition_310() // Condition for Rule "coherent, addr:2, n2:1, n1:4"
{
  return mu__invariant_108( 2, 1, 4 );
}

bool mu__condition_311() // Condition for Rule "coherent, addr:2, n2:1, n1:5"
{
  return mu__invariant_108( 2, 1, 5 );
}

bool mu__condition_312() // Condition for Rule "coherent, addr:2, n2:1, n1:6"
{
  return mu__invariant_108( 2, 1, 6 );
}

bool mu__condition_313() // Condition for Rule "coherent, addr:2, n2:1, n1:7"
{
  return mu__invariant_108( 2, 1, 7 );
}

bool mu__condition_314() // Condition for Rule "coherent, addr:2, n2:1, n1:8"
{
  return mu__invariant_108( 2, 1, 8 );
}

bool mu__condition_316() // Condition for Rule "coherent, addr:2, n2:2, n1:0"
{
  return mu__invariant_108( 2, 2, 0 );
}

bool mu__condition_317() // Condition for Rule "coherent, addr:2, n2:2, n1:1"
{
  return mu__invariant_108( 2, 2, 1 );
}

bool mu__condition_318() // Condition for Rule "coherent, addr:2, n2:2, n1:2"
{
  return mu__invariant_108( 2, 2, 2 );
}

bool mu__condition_319() // Condition for Rule "coherent, addr:2, n2:2, n1:3"
{
  return mu__invariant_108( 2, 2, 3 );
}

bool mu__condition_320() // Condition for Rule "coherent, addr:2, n2:2, n1:4"
{
  return mu__invariant_108( 2, 2, 4 );
}

bool mu__condition_321() // Condition for Rule "coherent, addr:2, n2:2, n1:5"
{
  return mu__invariant_108( 2, 2, 5 );
}

bool mu__condition_322() // Condition for Rule "coherent, addr:2, n2:2, n1:6"
{
  return mu__invariant_108( 2, 2, 6 );
}

bool mu__condition_323() // Condition for Rule "coherent, addr:2, n2:2, n1:7"
{
  return mu__invariant_108( 2, 2, 7 );
}

bool mu__condition_324() // Condition for Rule "coherent, addr:2, n2:2, n1:8"
{
  return mu__invariant_108( 2, 2, 8 );
}

bool mu__condition_326() // Condition for Rule "coherent, addr:2, n2:3, n1:0"
{
  return mu__invariant_108( 2, 3, 0 );
}

bool mu__condition_327() // Condition for Rule "coherent, addr:2, n2:3, n1:1"
{
  return mu__invariant_108( 2, 3, 1 );
}

bool mu__condition_328() // Condition for Rule "coherent, addr:2, n2:3, n1:2"
{
  return mu__invariant_108( 2, 3, 2 );
}

bool mu__condition_329() // Condition for Rule "coherent, addr:2, n2:3, n1:3"
{
  return mu__invariant_108( 2, 3, 3 );
}

bool mu__condition_330() // Condition for Rule "coherent, addr:2, n2:3, n1:4"
{
  return mu__invariant_108( 2, 3, 4 );
}

bool mu__condition_331() // Condition for Rule "coherent, addr:2, n2:3, n1:5"
{
  return mu__invariant_108( 2, 3, 5 );
}

bool mu__condition_332() // Condition for Rule "coherent, addr:2, n2:3, n1:6"
{
  return mu__invariant_108( 2, 3, 6 );
}

bool mu__condition_333() // Condition for Rule "coherent, addr:2, n2:3, n1:7"
{
  return mu__invariant_108( 2, 3, 7 );
}

bool mu__condition_334() // Condition for Rule "coherent, addr:2, n2:3, n1:8"
{
  return mu__invariant_108( 2, 3, 8 );
}

bool mu__condition_336() // Condition for Rule "coherent, addr:2, n2:4, n1:0"
{
  return mu__invariant_108( 2, 4, 0 );
}

bool mu__condition_337() // Condition for Rule "coherent, addr:2, n2:4, n1:1"
{
  return mu__invariant_108( 2, 4, 1 );
}

bool mu__condition_338() // Condition for Rule "coherent, addr:2, n2:4, n1:2"
{
  return mu__invariant_108( 2, 4, 2 );
}

bool mu__condition_339() // Condition for Rule "coherent, addr:2, n2:4, n1:3"
{
  return mu__invariant_108( 2, 4, 3 );
}

bool mu__condition_340() // Condition for Rule "coherent, addr:2, n2:4, n1:4"
{
  return mu__invariant_108( 2, 4, 4 );
}

bool mu__condition_341() // Condition for Rule "coherent, addr:2, n2:4, n1:5"
{
  return mu__invariant_108( 2, 4, 5 );
}

bool mu__condition_342() // Condition for Rule "coherent, addr:2, n2:4, n1:6"
{
  return mu__invariant_108( 2, 4, 6 );
}

bool mu__condition_343() // Condition for Rule "coherent, addr:2, n2:4, n1:7"
{
  return mu__invariant_108( 2, 4, 7 );
}

bool mu__condition_344() // Condition for Rule "coherent, addr:2, n2:4, n1:8"
{
  return mu__invariant_108( 2, 4, 8 );
}

bool mu__condition_346() // Condition for Rule "coherent, addr:2, n2:5, n1:0"
{
  return mu__invariant_108( 2, 5, 0 );
}

bool mu__condition_347() // Condition for Rule "coherent, addr:2, n2:5, n1:1"
{
  return mu__invariant_108( 2, 5, 1 );
}

bool mu__condition_348() // Condition for Rule "coherent, addr:2, n2:5, n1:2"
{
  return mu__invariant_108( 2, 5, 2 );
}

bool mu__condition_349() // Condition for Rule "coherent, addr:2, n2:5, n1:3"
{
  return mu__invariant_108( 2, 5, 3 );
}

bool mu__condition_350() // Condition for Rule "coherent, addr:2, n2:5, n1:4"
{
  return mu__invariant_108( 2, 5, 4 );
}

bool mu__condition_351() // Condition for Rule "coherent, addr:2, n2:5, n1:5"
{
  return mu__invariant_108( 2, 5, 5 );
}

bool mu__condition_352() // Condition for Rule "coherent, addr:2, n2:5, n1:6"
{
  return mu__invariant_108( 2, 5, 6 );
}

bool mu__condition_353() // Condition for Rule "coherent, addr:2, n2:5, n1:7"
{
  return mu__invariant_108( 2, 5, 7 );
}

bool mu__condition_354() // Condition for Rule "coherent, addr:2, n2:5, n1:8"
{
  return mu__invariant_108( 2, 5, 8 );
}

bool mu__condition_356() // Condition for Rule "coherent, addr:2, n2:6, n1:0"
{
  return mu__invariant_108( 2, 6, 0 );
}

bool mu__condition_357() // Condition for Rule "coherent, addr:2, n2:6, n1:1"
{
  return mu__invariant_108( 2, 6, 1 );
}

bool mu__condition_358() // Condition for Rule "coherent, addr:2, n2:6, n1:2"
{
  return mu__invariant_108( 2, 6, 2 );
}

bool mu__condition_359() // Condition for Rule "coherent, addr:2, n2:6, n1:3"
{
  return mu__invariant_108( 2, 6, 3 );
}

bool mu__condition_360() // Condition for Rule "coherent, addr:2, n2:6, n1:4"
{
  return mu__invariant_108( 2, 6, 4 );
}

bool mu__condition_361() // Condition for Rule "coherent, addr:2, n2:6, n1:5"
{
  return mu__invariant_108( 2, 6, 5 );
}

bool mu__condition_362() // Condition for Rule "coherent, addr:2, n2:6, n1:6"
{
  return mu__invariant_108( 2, 6, 6 );
}

bool mu__condition_363() // Condition for Rule "coherent, addr:2, n2:6, n1:7"
{
  return mu__invariant_108( 2, 6, 7 );
}

bool mu__condition_364() // Condition for Rule "coherent, addr:2, n2:6, n1:8"
{
  return mu__invariant_108( 2, 6, 8 );
}

bool mu__condition_366() // Condition for Rule "coherent, addr:2, n2:7, n1:0"
{
  return mu__invariant_108( 2, 7, 0 );
}

bool mu__condition_367() // Condition for Rule "coherent, addr:2, n2:7, n1:1"
{
  return mu__invariant_108( 2, 7, 1 );
}

bool mu__condition_368() // Condition for Rule "coherent, addr:2, n2:7, n1:2"
{
  return mu__invariant_108( 2, 7, 2 );
}

bool mu__condition_369() // Condition for Rule "coherent, addr:2, n2:7, n1:3"
{
  return mu__invariant_108( 2, 7, 3 );
}

bool mu__condition_370() // Condition for Rule "coherent, addr:2, n2:7, n1:4"
{
  return mu__invariant_108( 2, 7, 4 );
}

bool mu__condition_371() // Condition for Rule "coherent, addr:2, n2:7, n1:5"
{
  return mu__invariant_108( 2, 7, 5 );
}

bool mu__condition_372() // Condition for Rule "coherent, addr:2, n2:7, n1:6"
{
  return mu__invariant_108( 2, 7, 6 );
}

bool mu__condition_373() // Condition for Rule "coherent, addr:2, n2:7, n1:7"
{
  return mu__invariant_108( 2, 7, 7 );
}

bool mu__condition_374() // Condition for Rule "coherent, addr:2, n2:7, n1:8"
{
  return mu__invariant_108( 2, 7, 8 );
}

bool mu__condition_376() // Condition for Rule "coherent, addr:2, n2:8, n1:0"
{
  return mu__invariant_108( 2, 8, 0 );
}

bool mu__condition_377() // Condition for Rule "coherent, addr:2, n2:8, n1:1"
{
  return mu__invariant_108( 2, 8, 1 );
}

bool mu__condition_378() // Condition for Rule "coherent, addr:2, n2:8, n1:2"
{
  return mu__invariant_108( 2, 8, 2 );
}

bool mu__condition_379() // Condition for Rule "coherent, addr:2, n2:8, n1:3"
{
  return mu__invariant_108( 2, 8, 3 );
}

bool mu__condition_380() // Condition for Rule "coherent, addr:2, n2:8, n1:4"
{
  return mu__invariant_108( 2, 8, 4 );
}

bool mu__condition_381() // Condition for Rule "coherent, addr:2, n2:8, n1:5"
{
  return mu__invariant_108( 2, 8, 5 );
}

bool mu__condition_382() // Condition for Rule "coherent, addr:2, n2:8, n1:6"
{
  return mu__invariant_108( 2, 8, 6 );
}

bool mu__condition_383() // Condition for Rule "coherent, addr:2, n2:8, n1:7"
{
  return mu__invariant_108( 2, 8, 7 );
}

bool mu__condition_384() // Condition for Rule "coherent, addr:2, n2:8, n1:8"
{
  return mu__invariant_108( 2, 8, 8 );
}

bool mu__condition_387() // Condition for Rule "coherent, addr:3, n2:0, n1:0"
{
  return mu__invariant_108( 3, 0, 0 );
}

bool mu__condition_388() // Condition for Rule "coherent, addr:3, n2:0, n1:1"
{
  return mu__invariant_108( 3, 0, 1 );
}

bool mu__condition_389() // Condition for Rule "coherent, addr:3, n2:0, n1:2"
{
  return mu__invariant_108( 3, 0, 2 );
}

bool mu__condition_390() // Condition for Rule "coherent, addr:3, n2:0, n1:3"
{
  return mu__invariant_108( 3, 0, 3 );
}

bool mu__condition_391() // Condition for Rule "coherent, addr:3, n2:0, n1:4"
{
  return mu__invariant_108( 3, 0, 4 );
}

bool mu__condition_392() // Condition for Rule "coherent, addr:3, n2:0, n1:5"
{
  return mu__invariant_108( 3, 0, 5 );
}

bool mu__condition_393() // Condition for Rule "coherent, addr:3, n2:0, n1:6"
{
  return mu__invariant_108( 3, 0, 6 );
}

bool mu__condition_394() // Condition for Rule "coherent, addr:3, n2:0, n1:7"
{
  return mu__invariant_108( 3, 0, 7 );
}

bool mu__condition_395() // Condition for Rule "coherent, addr:3, n2:0, n1:8"
{
  return mu__invariant_108( 3, 0, 8 );
}

bool mu__condition_397() // Condition for Rule "coherent, addr:3, n2:1, n1:0"
{
  return mu__invariant_108( 3, 1, 0 );
}

bool mu__condition_398() // Condition for Rule "coherent, addr:3, n2:1, n1:1"
{
  return mu__invariant_108( 3, 1, 1 );
}

bool mu__condition_399() // Condition for Rule "coherent, addr:3, n2:1, n1:2"
{
  return mu__invariant_108( 3, 1, 2 );
}

bool mu__condition_400() // Condition for Rule "coherent, addr:3, n2:1, n1:3"
{
  return mu__invariant_108( 3, 1, 3 );
}

bool mu__condition_401() // Condition for Rule "coherent, addr:3, n2:1, n1:4"
{
  return mu__invariant_108( 3, 1, 4 );
}

bool mu__condition_402() // Condition for Rule "coherent, addr:3, n2:1, n1:5"
{
  return mu__invariant_108( 3, 1, 5 );
}

bool mu__condition_403() // Condition for Rule "coherent, addr:3, n2:1, n1:6"
{
  return mu__invariant_108( 3, 1, 6 );
}

bool mu__condition_404() // Condition for Rule "coherent, addr:3, n2:1, n1:7"
{
  return mu__invariant_108( 3, 1, 7 );
}

bool mu__condition_405() // Condition for Rule "coherent, addr:3, n2:1, n1:8"
{
  return mu__invariant_108( 3, 1, 8 );
}

bool mu__condition_407() // Condition for Rule "coherent, addr:3, n2:2, n1:0"
{
  return mu__invariant_108( 3, 2, 0 );
}

bool mu__condition_408() // Condition for Rule "coherent, addr:3, n2:2, n1:1"
{
  return mu__invariant_108( 3, 2, 1 );
}

bool mu__condition_409() // Condition for Rule "coherent, addr:3, n2:2, n1:2"
{
  return mu__invariant_108( 3, 2, 2 );
}

bool mu__condition_410() // Condition for Rule "coherent, addr:3, n2:2, n1:3"
{
  return mu__invariant_108( 3, 2, 3 );
}

bool mu__condition_411() // Condition for Rule "coherent, addr:3, n2:2, n1:4"
{
  return mu__invariant_108( 3, 2, 4 );
}

bool mu__condition_412() // Condition for Rule "coherent, addr:3, n2:2, n1:5"
{
  return mu__invariant_108( 3, 2, 5 );
}

bool mu__condition_413() // Condition for Rule "coherent, addr:3, n2:2, n1:6"
{
  return mu__invariant_108( 3, 2, 6 );
}

bool mu__condition_414() // Condition for Rule "coherent, addr:3, n2:2, n1:7"
{
  return mu__invariant_108( 3, 2, 7 );
}

bool mu__condition_415() // Condition for Rule "coherent, addr:3, n2:2, n1:8"
{
  return mu__invariant_108( 3, 2, 8 );
}

bool mu__condition_417() // Condition for Rule "coherent, addr:3, n2:3, n1:0"
{
  return mu__invariant_108( 3, 3, 0 );
}

bool mu__condition_418() // Condition for Rule "coherent, addr:3, n2:3, n1:1"
{
  return mu__invariant_108( 3, 3, 1 );
}

bool mu__condition_419() // Condition for Rule "coherent, addr:3, n2:3, n1:2"
{
  return mu__invariant_108( 3, 3, 2 );
}

bool mu__condition_420() // Condition for Rule "coherent, addr:3, n2:3, n1:3"
{
  return mu__invariant_108( 3, 3, 3 );
}

bool mu__condition_421() // Condition for Rule "coherent, addr:3, n2:3, n1:4"
{
  return mu__invariant_108( 3, 3, 4 );
}

bool mu__condition_422() // Condition for Rule "coherent, addr:3, n2:3, n1:5"
{
  return mu__invariant_108( 3, 3, 5 );
}

bool mu__condition_423() // Condition for Rule "coherent, addr:3, n2:3, n1:6"
{
  return mu__invariant_108( 3, 3, 6 );
}

bool mu__condition_424() // Condition for Rule "coherent, addr:3, n2:3, n1:7"
{
  return mu__invariant_108( 3, 3, 7 );
}

bool mu__condition_425() // Condition for Rule "coherent, addr:3, n2:3, n1:8"
{
  return mu__invariant_108( 3, 3, 8 );
}

bool mu__condition_427() // Condition for Rule "coherent, addr:3, n2:4, n1:0"
{
  return mu__invariant_108( 3, 4, 0 );
}

bool mu__condition_428() // Condition for Rule "coherent, addr:3, n2:4, n1:1"
{
  return mu__invariant_108( 3, 4, 1 );
}

bool mu__condition_429() // Condition for Rule "coherent, addr:3, n2:4, n1:2"
{
  return mu__invariant_108( 3, 4, 2 );
}

bool mu__condition_430() // Condition for Rule "coherent, addr:3, n2:4, n1:3"
{
  return mu__invariant_108( 3, 4, 3 );
}

bool mu__condition_431() // Condition for Rule "coherent, addr:3, n2:4, n1:4"
{
  return mu__invariant_108( 3, 4, 4 );
}

bool mu__condition_432() // Condition for Rule "coherent, addr:3, n2:4, n1:5"
{
  return mu__invariant_108( 3, 4, 5 );
}

bool mu__condition_433() // Condition for Rule "coherent, addr:3, n2:4, n1:6"
{
  return mu__invariant_108( 3, 4, 6 );
}

bool mu__condition_434() // Condition for Rule "coherent, addr:3, n2:4, n1:7"
{
  return mu__invariant_108( 3, 4, 7 );
}

bool mu__condition_435() // Condition for Rule "coherent, addr:3, n2:4, n1:8"
{
  return mu__invariant_108( 3, 4, 8 );
}

bool mu__condition_437() // Condition for Rule "coherent, addr:3, n2:5, n1:0"
{
  return mu__invariant_108( 3, 5, 0 );
}

bool mu__condition_438() // Condition for Rule "coherent, addr:3, n2:5, n1:1"
{
  return mu__invariant_108( 3, 5, 1 );
}

bool mu__condition_439() // Condition for Rule "coherent, addr:3, n2:5, n1:2"
{
  return mu__invariant_108( 3, 5, 2 );
}

bool mu__condition_440() // Condition for Rule "coherent, addr:3, n2:5, n1:3"
{
  return mu__invariant_108( 3, 5, 3 );
}

bool mu__condition_441() // Condition for Rule "coherent, addr:3, n2:5, n1:4"
{
  return mu__invariant_108( 3, 5, 4 );
}

bool mu__condition_442() // Condition for Rule "coherent, addr:3, n2:5, n1:5"
{
  return mu__invariant_108( 3, 5, 5 );
}

bool mu__condition_443() // Condition for Rule "coherent, addr:3, n2:5, n1:6"
{
  return mu__invariant_108( 3, 5, 6 );
}

bool mu__condition_444() // Condition for Rule "coherent, addr:3, n2:5, n1:7"
{
  return mu__invariant_108( 3, 5, 7 );
}

bool mu__condition_445() // Condition for Rule "coherent, addr:3, n2:5, n1:8"
{
  return mu__invariant_108( 3, 5, 8 );
}

bool mu__condition_447() // Condition for Rule "coherent, addr:3, n2:6, n1:0"
{
  return mu__invariant_108( 3, 6, 0 );
}

bool mu__condition_448() // Condition for Rule "coherent, addr:3, n2:6, n1:1"
{
  return mu__invariant_108( 3, 6, 1 );
}

bool mu__condition_449() // Condition for Rule "coherent, addr:3, n2:6, n1:2"
{
  return mu__invariant_108( 3, 6, 2 );
}

bool mu__condition_450() // Condition for Rule "coherent, addr:3, n2:6, n1:3"
{
  return mu__invariant_108( 3, 6, 3 );
}

bool mu__condition_451() // Condition for Rule "coherent, addr:3, n2:6, n1:4"
{
  return mu__invariant_108( 3, 6, 4 );
}

bool mu__condition_452() // Condition for Rule "coherent, addr:3, n2:6, n1:5"
{
  return mu__invariant_108( 3, 6, 5 );
}

bool mu__condition_453() // Condition for Rule "coherent, addr:3, n2:6, n1:6"
{
  return mu__invariant_108( 3, 6, 6 );
}

bool mu__condition_454() // Condition for Rule "coherent, addr:3, n2:6, n1:7"
{
  return mu__invariant_108( 3, 6, 7 );
}

bool mu__condition_455() // Condition for Rule "coherent, addr:3, n2:6, n1:8"
{
  return mu__invariant_108( 3, 6, 8 );
}

bool mu__condition_457() // Condition for Rule "coherent, addr:3, n2:7, n1:0"
{
  return mu__invariant_108( 3, 7, 0 );
}

bool mu__condition_458() // Condition for Rule "coherent, addr:3, n2:7, n1:1"
{
  return mu__invariant_108( 3, 7, 1 );
}

bool mu__condition_459() // Condition for Rule "coherent, addr:3, n2:7, n1:2"
{
  return mu__invariant_108( 3, 7, 2 );
}

bool mu__condition_460() // Condition for Rule "coherent, addr:3, n2:7, n1:3"
{
  return mu__invariant_108( 3, 7, 3 );
}

bool mu__condition_461() // Condition for Rule "coherent, addr:3, n2:7, n1:4"
{
  return mu__invariant_108( 3, 7, 4 );
}

bool mu__condition_462() // Condition for Rule "coherent, addr:3, n2:7, n1:5"
{
  return mu__invariant_108( 3, 7, 5 );
}

bool mu__condition_463() // Condition for Rule "coherent, addr:3, n2:7, n1:6"
{
  return mu__invariant_108( 3, 7, 6 );
}

bool mu__condition_464() // Condition for Rule "coherent, addr:3, n2:7, n1:7"
{
  return mu__invariant_108( 3, 7, 7 );
}

bool mu__condition_465() // Condition for Rule "coherent, addr:3, n2:7, n1:8"
{
  return mu__invariant_108( 3, 7, 8 );
}

bool mu__condition_467() // Condition for Rule "coherent, addr:3, n2:8, n1:0"
{
  return mu__invariant_108( 3, 8, 0 );
}

bool mu__condition_468() // Condition for Rule "coherent, addr:3, n2:8, n1:1"
{
  return mu__invariant_108( 3, 8, 1 );
}

bool mu__condition_469() // Condition for Rule "coherent, addr:3, n2:8, n1:2"
{
  return mu__invariant_108( 3, 8, 2 );
}

bool mu__condition_470() // Condition for Rule "coherent, addr:3, n2:8, n1:3"
{
  return mu__invariant_108( 3, 8, 3 );
}

bool mu__condition_471() // Condition for Rule "coherent, addr:3, n2:8, n1:4"
{
  return mu__invariant_108( 3, 8, 4 );
}

bool mu__condition_472() // Condition for Rule "coherent, addr:3, n2:8, n1:5"
{
  return mu__invariant_108( 3, 8, 5 );
}

bool mu__condition_473() // Condition for Rule "coherent, addr:3, n2:8, n1:6"
{
  return mu__invariant_108( 3, 8, 6 );
}

bool mu__condition_474() // Condition for Rule "coherent, addr:3, n2:8, n1:7"
{
  return mu__invariant_108( 3, 8, 7 );
}

bool mu__condition_475() // Condition for Rule "coherent, addr:3, n2:8, n1:8"
{
  return mu__invariant_108( 3, 8, 8 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"coherent, addr:3, n2:8, n1:8", &mu__condition_475, NULL, },
{"coherent, addr:3, n2:8, n1:7", &mu__condition_474, NULL, },
{"coherent, addr:3, n2:8, n1:6", &mu__condition_473, NULL, },
{"coherent, addr:3, n2:8, n1:5", &mu__condition_472, NULL, },
{"coherent, addr:3, n2:8, n1:4", &mu__condition_471, NULL, },
{"coherent, addr:3, n2:8, n1:3", &mu__condition_470, NULL, },
{"coherent, addr:3, n2:8, n1:2", &mu__condition_469, NULL, },
{"coherent, addr:3, n2:8, n1:1", &mu__condition_468, NULL, },
{"coherent, addr:3, n2:8, n1:0", &mu__condition_467, NULL, },
{"coherent, addr:3, n2:7, n1:8", &mu__condition_465, NULL, },
{"coherent, addr:3, n2:7, n1:7", &mu__condition_464, NULL, },
{"coherent, addr:3, n2:7, n1:6", &mu__condition_463, NULL, },
{"coherent, addr:3, n2:7, n1:5", &mu__condition_462, NULL, },
{"coherent, addr:3, n2:7, n1:4", &mu__condition_461, NULL, },
{"coherent, addr:3, n2:7, n1:3", &mu__condition_460, NULL, },
{"coherent, addr:3, n2:7, n1:2", &mu__condition_459, NULL, },
{"coherent, addr:3, n2:7, n1:1", &mu__condition_458, NULL, },
{"coherent, addr:3, n2:7, n1:0", &mu__condition_457, NULL, },
{"coherent, addr:3, n2:6, n1:8", &mu__condition_455, NULL, },
{"coherent, addr:3, n2:6, n1:7", &mu__condition_454, NULL, },
{"coherent, addr:3, n2:6, n1:6", &mu__condition_453, NULL, },
{"coherent, addr:3, n2:6, n1:5", &mu__condition_452, NULL, },
{"coherent, addr:3, n2:6, n1:4", &mu__condition_451, NULL, },
{"coherent, addr:3, n2:6, n1:3", &mu__condition_450, NULL, },
{"coherent, addr:3, n2:6, n1:2", &mu__condition_449, NULL, },
{"coherent, addr:3, n2:6, n1:1", &mu__condition_448, NULL, },
{"coherent, addr:3, n2:6, n1:0", &mu__condition_447, NULL, },
{"coherent, addr:3, n2:5, n1:8", &mu__condition_445, NULL, },
{"coherent, addr:3, n2:5, n1:7", &mu__condition_444, NULL, },
{"coherent, addr:3, n2:5, n1:6", &mu__condition_443, NULL, },
{"coherent, addr:3, n2:5, n1:5", &mu__condition_442, NULL, },
{"coherent, addr:3, n2:5, n1:4", &mu__condition_441, NULL, },
{"coherent, addr:3, n2:5, n1:3", &mu__condition_440, NULL, },
{"coherent, addr:3, n2:5, n1:2", &mu__condition_439, NULL, },
{"coherent, addr:3, n2:5, n1:1", &mu__condition_438, NULL, },
{"coherent, addr:3, n2:5, n1:0", &mu__condition_437, NULL, },
{"coherent, addr:3, n2:4, n1:8", &mu__condition_435, NULL, },
{"coherent, addr:3, n2:4, n1:7", &mu__condition_434, NULL, },
{"coherent, addr:3, n2:4, n1:6", &mu__condition_433, NULL, },
{"coherent, addr:3, n2:4, n1:5", &mu__condition_432, NULL, },
{"coherent, addr:3, n2:4, n1:4", &mu__condition_431, NULL, },
{"coherent, addr:3, n2:4, n1:3", &mu__condition_430, NULL, },
{"coherent, addr:3, n2:4, n1:2", &mu__condition_429, NULL, },
{"coherent, addr:3, n2:4, n1:1", &mu__condition_428, NULL, },
{"coherent, addr:3, n2:4, n1:0", &mu__condition_427, NULL, },
{"coherent, addr:3, n2:3, n1:8", &mu__condition_425, NULL, },
{"coherent, addr:3, n2:3, n1:7", &mu__condition_424, NULL, },
{"coherent, addr:3, n2:3, n1:6", &mu__condition_423, NULL, },
{"coherent, addr:3, n2:3, n1:5", &mu__condition_422, NULL, },
{"coherent, addr:3, n2:3, n1:4", &mu__condition_421, NULL, },
{"coherent, addr:3, n2:3, n1:3", &mu__condition_420, NULL, },
{"coherent, addr:3, n2:3, n1:2", &mu__condition_419, NULL, },
{"coherent, addr:3, n2:3, n1:1", &mu__condition_418, NULL, },
{"coherent, addr:3, n2:3, n1:0", &mu__condition_417, NULL, },
{"coherent, addr:3, n2:2, n1:8", &mu__condition_415, NULL, },
{"coherent, addr:3, n2:2, n1:7", &mu__condition_414, NULL, },
{"coherent, addr:3, n2:2, n1:6", &mu__condition_413, NULL, },
{"coherent, addr:3, n2:2, n1:5", &mu__condition_412, NULL, },
{"coherent, addr:3, n2:2, n1:4", &mu__condition_411, NULL, },
{"coherent, addr:3, n2:2, n1:3", &mu__condition_410, NULL, },
{"coherent, addr:3, n2:2, n1:2", &mu__condition_409, NULL, },
{"coherent, addr:3, n2:2, n1:1", &mu__condition_408, NULL, },
{"coherent, addr:3, n2:2, n1:0", &mu__condition_407, NULL, },
{"coherent, addr:3, n2:1, n1:8", &mu__condition_405, NULL, },
{"coherent, addr:3, n2:1, n1:7", &mu__condition_404, NULL, },
{"coherent, addr:3, n2:1, n1:6", &mu__condition_403, NULL, },
{"coherent, addr:3, n2:1, n1:5", &mu__condition_402, NULL, },
{"coherent, addr:3, n2:1, n1:4", &mu__condition_401, NULL, },
{"coherent, addr:3, n2:1, n1:3", &mu__condition_400, NULL, },
{"coherent, addr:3, n2:1, n1:2", &mu__condition_399, NULL, },
{"coherent, addr:3, n2:1, n1:1", &mu__condition_398, NULL, },
{"coherent, addr:3, n2:1, n1:0", &mu__condition_397, NULL, },
{"coherent, addr:3, n2:0, n1:8", &mu__condition_395, NULL, },
{"coherent, addr:3, n2:0, n1:7", &mu__condition_394, NULL, },
{"coherent, addr:3, n2:0, n1:6", &mu__condition_393, NULL, },
{"coherent, addr:3, n2:0, n1:5", &mu__condition_392, NULL, },
{"coherent, addr:3, n2:0, n1:4", &mu__condition_391, NULL, },
{"coherent, addr:3, n2:0, n1:3", &mu__condition_390, NULL, },
{"coherent, addr:3, n2:0, n1:2", &mu__condition_389, NULL, },
{"coherent, addr:3, n2:0, n1:1", &mu__condition_388, NULL, },
{"coherent, addr:3, n2:0, n1:0", &mu__condition_387, NULL, },
{"coherent, addr:2, n2:8, n1:8", &mu__condition_384, NULL, },
{"coherent, addr:2, n2:8, n1:7", &mu__condition_383, NULL, },
{"coherent, addr:2, n2:8, n1:6", &mu__condition_382, NULL, },
{"coherent, addr:2, n2:8, n1:5", &mu__condition_381, NULL, },
{"coherent, addr:2, n2:8, n1:4", &mu__condition_380, NULL, },
{"coherent, addr:2, n2:8, n1:3", &mu__condition_379, NULL, },
{"coherent, addr:2, n2:8, n1:2", &mu__condition_378, NULL, },
{"coherent, addr:2, n2:8, n1:1", &mu__condition_377, NULL, },
{"coherent, addr:2, n2:8, n1:0", &mu__condition_376, NULL, },
{"coherent, addr:2, n2:7, n1:8", &mu__condition_374, NULL, },
{"coherent, addr:2, n2:7, n1:7", &mu__condition_373, NULL, },
{"coherent, addr:2, n2:7, n1:6", &mu__condition_372, NULL, },
{"coherent, addr:2, n2:7, n1:5", &mu__condition_371, NULL, },
{"coherent, addr:2, n2:7, n1:4", &mu__condition_370, NULL, },
{"coherent, addr:2, n2:7, n1:3", &mu__condition_369, NULL, },
{"coherent, addr:2, n2:7, n1:2", &mu__condition_368, NULL, },
{"coherent, addr:2, n2:7, n1:1", &mu__condition_367, NULL, },
{"coherent, addr:2, n2:7, n1:0", &mu__condition_366, NULL, },
{"coherent, addr:2, n2:6, n1:8", &mu__condition_364, NULL, },
{"coherent, addr:2, n2:6, n1:7", &mu__condition_363, NULL, },
{"coherent, addr:2, n2:6, n1:6", &mu__condition_362, NULL, },
{"coherent, addr:2, n2:6, n1:5", &mu__condition_361, NULL, },
{"coherent, addr:2, n2:6, n1:4", &mu__condition_360, NULL, },
{"coherent, addr:2, n2:6, n1:3", &mu__condition_359, NULL, },
{"coherent, addr:2, n2:6, n1:2", &mu__condition_358, NULL, },
{"coherent, addr:2, n2:6, n1:1", &mu__condition_357, NULL, },
{"coherent, addr:2, n2:6, n1:0", &mu__condition_356, NULL, },
{"coherent, addr:2, n2:5, n1:8", &mu__condition_354, NULL, },
{"coherent, addr:2, n2:5, n1:7", &mu__condition_353, NULL, },
{"coherent, addr:2, n2:5, n1:6", &mu__condition_352, NULL, },
{"coherent, addr:2, n2:5, n1:5", &mu__condition_351, NULL, },
{"coherent, addr:2, n2:5, n1:4", &mu__condition_350, NULL, },
{"coherent, addr:2, n2:5, n1:3", &mu__condition_349, NULL, },
{"coherent, addr:2, n2:5, n1:2", &mu__condition_348, NULL, },
{"coherent, addr:2, n2:5, n1:1", &mu__condition_347, NULL, },
{"coherent, addr:2, n2:5, n1:0", &mu__condition_346, NULL, },
{"coherent, addr:2, n2:4, n1:8", &mu__condition_344, NULL, },
{"coherent, addr:2, n2:4, n1:7", &mu__condition_343, NULL, },
{"coherent, addr:2, n2:4, n1:6", &mu__condition_342, NULL, },
{"coherent, addr:2, n2:4, n1:5", &mu__condition_341, NULL, },
{"coherent, addr:2, n2:4, n1:4", &mu__condition_340, NULL, },
{"coherent, addr:2, n2:4, n1:3", &mu__condition_339, NULL, },
{"coherent, addr:2, n2:4, n1:2", &mu__condition_338, NULL, },
{"coherent, addr:2, n2:4, n1:1", &mu__condition_337, NULL, },
{"coherent, addr:2, n2:4, n1:0", &mu__condition_336, NULL, },
{"coherent, addr:2, n2:3, n1:8", &mu__condition_334, NULL, },
{"coherent, addr:2, n2:3, n1:7", &mu__condition_333, NULL, },
{"coherent, addr:2, n2:3, n1:6", &mu__condition_332, NULL, },
{"coherent, addr:2, n2:3, n1:5", &mu__condition_331, NULL, },
{"coherent, addr:2, n2:3, n1:4", &mu__condition_330, NULL, },
{"coherent, addr:2, n2:3, n1:3", &mu__condition_329, NULL, },
{"coherent, addr:2, n2:3, n1:2", &mu__condition_328, NULL, },
{"coherent, addr:2, n2:3, n1:1", &mu__condition_327, NULL, },
{"coherent, addr:2, n2:3, n1:0", &mu__condition_326, NULL, },
{"coherent, addr:2, n2:2, n1:8", &mu__condition_324, NULL, },
{"coherent, addr:2, n2:2, n1:7", &mu__condition_323, NULL, },
{"coherent, addr:2, n2:2, n1:6", &mu__condition_322, NULL, },
{"coherent, addr:2, n2:2, n1:5", &mu__condition_321, NULL, },
{"coherent, addr:2, n2:2, n1:4", &mu__condition_320, NULL, },
{"coherent, addr:2, n2:2, n1:3", &mu__condition_319, NULL, },
{"coherent, addr:2, n2:2, n1:2", &mu__condition_318, NULL, },
{"coherent, addr:2, n2:2, n1:1", &mu__condition_317, NULL, },
{"coherent, addr:2, n2:2, n1:0", &mu__condition_316, NULL, },
{"coherent, addr:2, n2:1, n1:8", &mu__condition_314, NULL, },
{"coherent, addr:2, n2:1, n1:7", &mu__condition_313, NULL, },
{"coherent, addr:2, n2:1, n1:6", &mu__condition_312, NULL, },
{"coherent, addr:2, n2:1, n1:5", &mu__condition_311, NULL, },
{"coherent, addr:2, n2:1, n1:4", &mu__condition_310, NULL, },
{"coherent, addr:2, n2:1, n1:3", &mu__condition_309, NULL, },
{"coherent, addr:2, n2:1, n1:2", &mu__condition_308, NULL, },
{"coherent, addr:2, n2:1, n1:1", &mu__condition_307, NULL, },
{"coherent, addr:2, n2:1, n1:0", &mu__condition_306, NULL, },
{"coherent, addr:2, n2:0, n1:8", &mu__condition_304, NULL, },
{"coherent, addr:2, n2:0, n1:7", &mu__condition_303, NULL, },
{"coherent, addr:2, n2:0, n1:6", &mu__condition_302, NULL, },
{"coherent, addr:2, n2:0, n1:5", &mu__condition_301, NULL, },
{"coherent, addr:2, n2:0, n1:4", &mu__condition_300, NULL, },
{"coherent, addr:2, n2:0, n1:3", &mu__condition_299, NULL, },
{"coherent, addr:2, n2:0, n1:2", &mu__condition_298, NULL, },
{"coherent, addr:2, n2:0, n1:1", &mu__condition_297, NULL, },
{"coherent, addr:2, n2:0, n1:0", &mu__condition_296, NULL, },
{"coherent, addr:1, n2:8, n1:8", &mu__condition_293, NULL, },
{"coherent, addr:1, n2:8, n1:7", &mu__condition_292, NULL, },
{"coherent, addr:1, n2:8, n1:6", &mu__condition_291, NULL, },
{"coherent, addr:1, n2:8, n1:5", &mu__condition_290, NULL, },
{"coherent, addr:1, n2:8, n1:4", &mu__condition_289, NULL, },
{"coherent, addr:1, n2:8, n1:3", &mu__condition_288, NULL, },
{"coherent, addr:1, n2:8, n1:2", &mu__condition_287, NULL, },
{"coherent, addr:1, n2:8, n1:1", &mu__condition_286, NULL, },
{"coherent, addr:1, n2:8, n1:0", &mu__condition_285, NULL, },
{"coherent, addr:1, n2:7, n1:8", &mu__condition_283, NULL, },
{"coherent, addr:1, n2:7, n1:7", &mu__condition_282, NULL, },
{"coherent, addr:1, n2:7, n1:6", &mu__condition_281, NULL, },
{"coherent, addr:1, n2:7, n1:5", &mu__condition_280, NULL, },
{"coherent, addr:1, n2:7, n1:4", &mu__condition_279, NULL, },
{"coherent, addr:1, n2:7, n1:3", &mu__condition_278, NULL, },
{"coherent, addr:1, n2:7, n1:2", &mu__condition_277, NULL, },
{"coherent, addr:1, n2:7, n1:1", &mu__condition_276, NULL, },
{"coherent, addr:1, n2:7, n1:0", &mu__condition_275, NULL, },
{"coherent, addr:1, n2:6, n1:8", &mu__condition_273, NULL, },
{"coherent, addr:1, n2:6, n1:7", &mu__condition_272, NULL, },
{"coherent, addr:1, n2:6, n1:6", &mu__condition_271, NULL, },
{"coherent, addr:1, n2:6, n1:5", &mu__condition_270, NULL, },
{"coherent, addr:1, n2:6, n1:4", &mu__condition_269, NULL, },
{"coherent, addr:1, n2:6, n1:3", &mu__condition_268, NULL, },
{"coherent, addr:1, n2:6, n1:2", &mu__condition_267, NULL, },
{"coherent, addr:1, n2:6, n1:1", &mu__condition_266, NULL, },
{"coherent, addr:1, n2:6, n1:0", &mu__condition_265, NULL, },
{"coherent, addr:1, n2:5, n1:8", &mu__condition_263, NULL, },
{"coherent, addr:1, n2:5, n1:7", &mu__condition_262, NULL, },
{"coherent, addr:1, n2:5, n1:6", &mu__condition_261, NULL, },
{"coherent, addr:1, n2:5, n1:5", &mu__condition_260, NULL, },
{"coherent, addr:1, n2:5, n1:4", &mu__condition_259, NULL, },
{"coherent, addr:1, n2:5, n1:3", &mu__condition_258, NULL, },
{"coherent, addr:1, n2:5, n1:2", &mu__condition_257, NULL, },
{"coherent, addr:1, n2:5, n1:1", &mu__condition_256, NULL, },
{"coherent, addr:1, n2:5, n1:0", &mu__condition_255, NULL, },
{"coherent, addr:1, n2:4, n1:8", &mu__condition_253, NULL, },
{"coherent, addr:1, n2:4, n1:7", &mu__condition_252, NULL, },
{"coherent, addr:1, n2:4, n1:6", &mu__condition_251, NULL, },
{"coherent, addr:1, n2:4, n1:5", &mu__condition_250, NULL, },
{"coherent, addr:1, n2:4, n1:4", &mu__condition_249, NULL, },
{"coherent, addr:1, n2:4, n1:3", &mu__condition_248, NULL, },
{"coherent, addr:1, n2:4, n1:2", &mu__condition_247, NULL, },
{"coherent, addr:1, n2:4, n1:1", &mu__condition_246, NULL, },
{"coherent, addr:1, n2:4, n1:0", &mu__condition_245, NULL, },
{"coherent, addr:1, n2:3, n1:8", &mu__condition_243, NULL, },
{"coherent, addr:1, n2:3, n1:7", &mu__condition_242, NULL, },
{"coherent, addr:1, n2:3, n1:6", &mu__condition_241, NULL, },
{"coherent, addr:1, n2:3, n1:5", &mu__condition_240, NULL, },
{"coherent, addr:1, n2:3, n1:4", &mu__condition_239, NULL, },
{"coherent, addr:1, n2:3, n1:3", &mu__condition_238, NULL, },
{"coherent, addr:1, n2:3, n1:2", &mu__condition_237, NULL, },
{"coherent, addr:1, n2:3, n1:1", &mu__condition_236, NULL, },
{"coherent, addr:1, n2:3, n1:0", &mu__condition_235, NULL, },
{"coherent, addr:1, n2:2, n1:8", &mu__condition_233, NULL, },
{"coherent, addr:1, n2:2, n1:7", &mu__condition_232, NULL, },
{"coherent, addr:1, n2:2, n1:6", &mu__condition_231, NULL, },
{"coherent, addr:1, n2:2, n1:5", &mu__condition_230, NULL, },
{"coherent, addr:1, n2:2, n1:4", &mu__condition_229, NULL, },
{"coherent, addr:1, n2:2, n1:3", &mu__condition_228, NULL, },
{"coherent, addr:1, n2:2, n1:2", &mu__condition_227, NULL, },
{"coherent, addr:1, n2:2, n1:1", &mu__condition_226, NULL, },
{"coherent, addr:1, n2:2, n1:0", &mu__condition_225, NULL, },
{"coherent, addr:1, n2:1, n1:8", &mu__condition_223, NULL, },
{"coherent, addr:1, n2:1, n1:7", &mu__condition_222, NULL, },
{"coherent, addr:1, n2:1, n1:6", &mu__condition_221, NULL, },
{"coherent, addr:1, n2:1, n1:5", &mu__condition_220, NULL, },
{"coherent, addr:1, n2:1, n1:4", &mu__condition_219, NULL, },
{"coherent, addr:1, n2:1, n1:3", &mu__condition_218, NULL, },
{"coherent, addr:1, n2:1, n1:2", &mu__condition_217, NULL, },
{"coherent, addr:1, n2:1, n1:1", &mu__condition_216, NULL, },
{"coherent, addr:1, n2:1, n1:0", &mu__condition_215, NULL, },
{"coherent, addr:1, n2:0, n1:8", &mu__condition_213, NULL, },
{"coherent, addr:1, n2:0, n1:7", &mu__condition_212, NULL, },
{"coherent, addr:1, n2:0, n1:6", &mu__condition_211, NULL, },
{"coherent, addr:1, n2:0, n1:5", &mu__condition_210, NULL, },
{"coherent, addr:1, n2:0, n1:4", &mu__condition_209, NULL, },
{"coherent, addr:1, n2:0, n1:3", &mu__condition_208, NULL, },
{"coherent, addr:1, n2:0, n1:2", &mu__condition_207, NULL, },
{"coherent, addr:1, n2:0, n1:1", &mu__condition_206, NULL, },
{"coherent, addr:1, n2:0, n1:0", &mu__condition_205, NULL, },
{"coherent, addr:0, n2:8, n1:8", &mu__condition_202, NULL, },
{"coherent, addr:0, n2:8, n1:7", &mu__condition_201, NULL, },
{"coherent, addr:0, n2:8, n1:6", &mu__condition_200, NULL, },
{"coherent, addr:0, n2:8, n1:5", &mu__condition_199, NULL, },
{"coherent, addr:0, n2:8, n1:4", &mu__condition_198, NULL, },
{"coherent, addr:0, n2:8, n1:3", &mu__condition_197, NULL, },
{"coherent, addr:0, n2:8, n1:2", &mu__condition_196, NULL, },
{"coherent, addr:0, n2:8, n1:1", &mu__condition_195, NULL, },
{"coherent, addr:0, n2:8, n1:0", &mu__condition_194, NULL, },
{"coherent, addr:0, n2:7, n1:8", &mu__condition_192, NULL, },
{"coherent, addr:0, n2:7, n1:7", &mu__condition_191, NULL, },
{"coherent, addr:0, n2:7, n1:6", &mu__condition_190, NULL, },
{"coherent, addr:0, n2:7, n1:5", &mu__condition_189, NULL, },
{"coherent, addr:0, n2:7, n1:4", &mu__condition_188, NULL, },
{"coherent, addr:0, n2:7, n1:3", &mu__condition_187, NULL, },
{"coherent, addr:0, n2:7, n1:2", &mu__condition_186, NULL, },
{"coherent, addr:0, n2:7, n1:1", &mu__condition_185, NULL, },
{"coherent, addr:0, n2:7, n1:0", &mu__condition_184, NULL, },
{"coherent, addr:0, n2:6, n1:8", &mu__condition_182, NULL, },
{"coherent, addr:0, n2:6, n1:7", &mu__condition_181, NULL, },
{"coherent, addr:0, n2:6, n1:6", &mu__condition_180, NULL, },
{"coherent, addr:0, n2:6, n1:5", &mu__condition_179, NULL, },
{"coherent, addr:0, n2:6, n1:4", &mu__condition_178, NULL, },
{"coherent, addr:0, n2:6, n1:3", &mu__condition_177, NULL, },
{"coherent, addr:0, n2:6, n1:2", &mu__condition_176, NULL, },
{"coherent, addr:0, n2:6, n1:1", &mu__condition_175, NULL, },
{"coherent, addr:0, n2:6, n1:0", &mu__condition_174, NULL, },
{"coherent, addr:0, n2:5, n1:8", &mu__condition_172, NULL, },
{"coherent, addr:0, n2:5, n1:7", &mu__condition_171, NULL, },
{"coherent, addr:0, n2:5, n1:6", &mu__condition_170, NULL, },
{"coherent, addr:0, n2:5, n1:5", &mu__condition_169, NULL, },
{"coherent, addr:0, n2:5, n1:4", &mu__condition_168, NULL, },
{"coherent, addr:0, n2:5, n1:3", &mu__condition_167, NULL, },
{"coherent, addr:0, n2:5, n1:2", &mu__condition_166, NULL, },
{"coherent, addr:0, n2:5, n1:1", &mu__condition_165, NULL, },
{"coherent, addr:0, n2:5, n1:0", &mu__condition_164, NULL, },
{"coherent, addr:0, n2:4, n1:8", &mu__condition_162, NULL, },
{"coherent, addr:0, n2:4, n1:7", &mu__condition_161, NULL, },
{"coherent, addr:0, n2:4, n1:6", &mu__condition_160, NULL, },
{"coherent, addr:0, n2:4, n1:5", &mu__condition_159, NULL, },
{"coherent, addr:0, n2:4, n1:4", &mu__condition_158, NULL, },
{"coherent, addr:0, n2:4, n1:3", &mu__condition_157, NULL, },
{"coherent, addr:0, n2:4, n1:2", &mu__condition_156, NULL, },
{"coherent, addr:0, n2:4, n1:1", &mu__condition_155, NULL, },
{"coherent, addr:0, n2:4, n1:0", &mu__condition_154, NULL, },
{"coherent, addr:0, n2:3, n1:8", &mu__condition_152, NULL, },
{"coherent, addr:0, n2:3, n1:7", &mu__condition_151, NULL, },
{"coherent, addr:0, n2:3, n1:6", &mu__condition_150, NULL, },
{"coherent, addr:0, n2:3, n1:5", &mu__condition_149, NULL, },
{"coherent, addr:0, n2:3, n1:4", &mu__condition_148, NULL, },
{"coherent, addr:0, n2:3, n1:3", &mu__condition_147, NULL, },
{"coherent, addr:0, n2:3, n1:2", &mu__condition_146, NULL, },
{"coherent, addr:0, n2:3, n1:1", &mu__condition_145, NULL, },
{"coherent, addr:0, n2:3, n1:0", &mu__condition_144, NULL, },
{"coherent, addr:0, n2:2, n1:8", &mu__condition_142, NULL, },
{"coherent, addr:0, n2:2, n1:7", &mu__condition_141, NULL, },
{"coherent, addr:0, n2:2, n1:6", &mu__condition_140, NULL, },
{"coherent, addr:0, n2:2, n1:5", &mu__condition_139, NULL, },
{"coherent, addr:0, n2:2, n1:4", &mu__condition_138, NULL, },
{"coherent, addr:0, n2:2, n1:3", &mu__condition_137, NULL, },
{"coherent, addr:0, n2:2, n1:2", &mu__condition_136, NULL, },
{"coherent, addr:0, n2:2, n1:1", &mu__condition_135, NULL, },
{"coherent, addr:0, n2:2, n1:0", &mu__condition_134, NULL, },
{"coherent, addr:0, n2:1, n1:8", &mu__condition_132, NULL, },
{"coherent, addr:0, n2:1, n1:7", &mu__condition_131, NULL, },
{"coherent, addr:0, n2:1, n1:6", &mu__condition_130, NULL, },
{"coherent, addr:0, n2:1, n1:5", &mu__condition_129, NULL, },
{"coherent, addr:0, n2:1, n1:4", &mu__condition_128, NULL, },
{"coherent, addr:0, n2:1, n1:3", &mu__condition_127, NULL, },
{"coherent, addr:0, n2:1, n1:2", &mu__condition_126, NULL, },
{"coherent, addr:0, n2:1, n1:1", &mu__condition_125, NULL, },
{"coherent, addr:0, n2:1, n1:0", &mu__condition_124, NULL, },
{"coherent, addr:0, n2:0, n1:8", &mu__condition_122, NULL, },
{"coherent, addr:0, n2:0, n1:7", &mu__condition_121, NULL, },
{"coherent, addr:0, n2:0, n1:6", &mu__condition_120, NULL, },
{"coherent, addr:0, n2:0, n1:5", &mu__condition_119, NULL, },
...
const unsigned short numinvariants = 324;
