/******************************
  Program "./benchmarks/murphi_protocols/flash_ctc10_orig_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/flash_ctc10_orig_node2"
...
/********************
  Invariant records
 ********************/
int mu__invariant_253( const mu_1_NODE &mu_j, const mu_1_NODE &mu_i) // Invariant "test_proprity"
{
bool mu__boolexpr254;
  if (!((mu_Sta.mu_Proc[mu_i].mu_CacheState) == (mu_CACHE_E))) mu__boolexpr254 = FALSE ;
  else {
  mu__boolexpr254 = ((mu_Sta.mu_Proc[mu_j].mu_CacheState) == (mu_CACHE_S)) ; 
}
return !(mu__boolexpr254);
};

bool mu__condition_257() // Condition for Rule "test_proprity, j:1, i:1"
{
  return mu__invariant_253( 1, 1 );
}

bool mu__condition_258() // Condition for Rule "test_proprity, j:1, i:2"
{
  return mu__invariant_253( 1, 2 );
}

bool mu__condition_260() // Condition for Rule "test_proprity, j:2, i:1"
{
  return mu__invariant_253( 2, 1 );
}

bool mu__condition_261() // Condition for Rule "test_proprity, j:2, i:2"
{
  return mu__invariant_253( 2, 2 );
}
...
{"test_proprity, j:1, i:2", &mu__condition_258, NULL, },
{"test_proprity, j:1, i:1", &mu__condition_257, NULL, },
};
