/******************************
  Program "cache_err.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "cache_err"
...
/*** Variable declaration ***/
mu_1__type_3 mu_home_invalidate_list("home_invalidate_list",64);
...
/*** Variable declaration ***/
mu_1__type_4 mu_cache("cache",104);
...
/********************
  Invariant records
 ********************/
int mu__invariant_35( const mu_1_client &mu_c2, const mu_1_client &mu_c1) // Invariant "coherent"
{
bool mu__boolexpr36;
bool mu__boolexpr37;
  if (!((mu_c1) != (mu_c2))) mu__boolexpr37 = FALSE ;
  else {
  mu__boolexpr37 = ((mu_cache[mu_c1]) == (mu_exclusive)) ; 
}
  if (!(mu__boolexpr37)) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_cache[mu_c1]) == (mu_exclusive)) ; 
}
return mu__boolexpr36;
};

bool mu__condition_40() // Condition for Rule "coherent, c2:1, c1:1"
{
  return mu__invariant_35( 1, 1 );
}

bool mu__condition_41() // Condition for Rule "coherent, c2:1, c1:2"
{
  return mu__invariant_35( 1, 2 );
}

bool mu__condition_43() // Condition for Rule "coherent, c2:2, c1:1"
{
  return mu__invariant_35( 2, 1 );
}

bool mu__condition_44() // Condition for Rule "coherent, c2:2, c1:2"
{
  return mu__invariant_35( 2, 2 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"coherent, c2:2, c1:2", &mu__condition_44, NULL, },
{"coherent, c2:2, c1:1", &mu__condition_43, NULL, },
{"coherent, c2:1, c1:2", &mu__condition_41, NULL, },
{"coherent, c2:1, c1:1", &mu__condition_40, NULL, },
};
