/******************************
  Program "german2004.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "german2004"
...
int mu__invariant_117( const mu_1_addr_type &mu_addr, const mu_1_node_id &mu_n2, const mu_1_node_id &mu_n1) // Invariant "coherent"
{
bool mu__boolexpr118;
bool mu__boolexpr119;
  if (!((mu_n1) != (mu_n2))) mu__boolexpr119 = FALSE ;
  else {
  mu__boolexpr119 = ((mu_node[mu_n1].mu_cache[mu_addr].mu_state) == (mu_cache_exclusive)) ; 
}
  if (!(mu__boolexpr119)) mu__boolexpr118 = TRUE ;
  else {
  mu__boolexpr118 = ((mu_node[mu_n2].mu_cache[mu_addr].mu_state) == (mu_cache_invalid)) ; 
}
return mu__boolexpr118;
};

bool mu__condition_123() // Condition for Rule "coherent, addr:0, n2:0, n1:0"
{
  return mu__invariant_117( 0, 0, 0 );
}

bool mu__condition_124() // Condition for Rule "coherent, addr:0, n2:0, n1:1"
{
  return mu__invariant_117( 0, 0, 1 );
}

bool mu__condition_125() // Condition for Rule "coherent, addr:0, n2:0, n1:2"
{
  return mu__invariant_117( 0, 0, 2 );
}

bool mu__condition_126() // Condition for Rule "coherent, addr:0, n2:0, n1:3"
{
  return mu__invariant_117( 0, 0, 3 );
}

bool mu__condition_128() // Condition for Rule "coherent, addr:0, n2:1, n1:0"
{
  return mu__invariant_117( 0, 1, 0 );
}

bool mu__condition_129() // Condition for Rule "coherent, addr:0, n2:1, n1:1"
{
  return mu__invariant_117( 0, 1, 1 );
}

bool mu__condition_130() // Condition for Rule "coherent, addr:0, n2:1, n1:2"
{
  return mu__invariant_117( 0, 1, 2 );
}

bool mu__condition_131() // Condition for Rule "coherent, addr:0, n2:1, n1:3"
{
  return mu__invariant_117( 0, 1, 3 );
}

bool mu__condition_133() // Condition for Rule "coherent, addr:0, n2:2, n1:0"
{
  return mu__invariant_117( 0, 2, 0 );
}

bool mu__condition_134() // Condition for Rule "coherent, addr:0, n2:2, n1:1"
{
  return mu__invariant_117( 0, 2, 1 );
}

bool mu__condition_135() // Condition for Rule "coherent, addr:0, n2:2, n1:2"
{
  return mu__invariant_117( 0, 2, 2 );
}

bool mu__condition_136() // Condition for Rule "coherent, addr:0, n2:2, n1:3"
{
  return mu__invariant_117( 0, 2, 3 );
}

bool mu__condition_138() // Condition for Rule "coherent, addr:0, n2:3, n1:0"
{
  return mu__invariant_117( 0, 3, 0 );
}

bool mu__condition_139() // Condition for Rule "coherent, addr:0, n2:3, n1:1"
{
  return mu__invariant_117( 0, 3, 1 );
}

bool mu__condition_140() // Condition for Rule "coherent, addr:0, n2:3, n1:2"
{
  return mu__invariant_117( 0, 3, 2 );
}

bool mu__condition_141() // Condition for Rule "coherent, addr:0, n2:3, n1:3"
{
  return mu__invariant_117( 0, 3, 3 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"coherent, addr:0, n2:3, n1:3", &mu__condition_141, NULL, },
{"coherent, addr:0, n2:3, n1:2", &mu__condition_140, NULL, },
{"coherent, addr:0, n2:3, n1:1", &mu__condition_139, NULL, },
{"coherent, addr:0, n2:3, n1:0", &mu__condition_138, NULL, },
{"coherent, addr:0, n2:2, n1:3", &mu__condition_136, NULL, },
{"coherent, addr:0, n2:2, n1:2", &mu__condition_135, NULL, },
{"coherent, addr:0, n2:2, n1:1", &mu__condition_134, NULL, },
{"coherent, addr:0, n2:2, n1:0", &mu__condition_133, NULL, },
{"coherent, addr:0, n2:1, n1:3", &mu__condition_131, NULL, },
{"coherent, addr:0, n2:1, n1:2", &mu__condition_130, NULL, },
{"coherent, addr:0, n2:1, n1:1", &mu__condition_129, NULL, },
{"coherent, addr:0, n2:1, n1:0", &mu__condition_128, NULL, },
{"coherent, addr:0, n2:0, n1:3", &mu__condition_126, NULL, },
{"coherent, addr:0, n2:0, n1:2", &mu__condition_125, NULL, },
{"coherent, addr:0, n2:0, n1:1", &mu__condition_124, NULL, },
{"coherent, addr:0, n2:0, n1:0", &mu__condition_123, NULL, },
