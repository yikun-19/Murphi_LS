/******************************
  Program "german.m" compiled by "Caching Murphi Release 5.5.0"
...
/*** Variable declaration ***/
mu_1__type_1 mu_Chan1("Chan1",80);

/*** Variable declaration ***/
mu_1__type_2 mu_Chan2("Chan2",160);

/*** Variable declaration ***/
mu_1__type_3 mu_Chan3("Chan3",240);

/*** Variable declaration ***/
mu_1__type_4 mu_InvSet("InvSet",320);

/*** Variable declaration ***/
mu_1__type_5 mu_ShrSet("ShrSet",360);

/*** Variable declaration ***/
mu_0_boolean mu_ExGntd("ExGntd",400);

/*** Variable declaration ***/
mu_1_MSG_CMD mu_CurCmd("CurCmd",408);

/*** Variable declaration ***/
mu_1_NODE mu_CurPtr("CurPtr",416);

/*** Variable declaration ***/
mu_1_DATA mu_MemData("MemData",424);

/*** Variable declaration ***/
mu_1_DATA mu_AuxData("AuxData",432);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=20 && what_rule<25)
    { R4.NextRule(what_rule);
      if (what_rule<25) return; }
  if (what_rule>=25 && what_rule<30)
    { R5.NextRule(what_rule);
      if (what_rule<30) return; }
  if (what_rule>=30 && what_rule<35)
    { R6.NextRule(what_rule);
      if (what_rule<35) return; }
  if (what_rule>=35 && what_rule<40)
    { R7.NextRule(what_rule);
      if (what_rule<40) return; }
  if (what_rule>=40 && what_rule<45)
    { R8.NextRule(what_rule);
      if (what_rule<45) return; }
  if (what_rule>=45 && what_rule<50)
    { R9.NextRule(what_rule);
      if (what_rule<50) return; }
  if (what_rule>=50 && what_rule<55)
    { R10.NextRule(what_rule);
      if (what_rule<55) return; }
  if (what_rule>=55 && what_rule<65)
...
bool Condition(unsigned r)
{
  ...
  if (r>=20 && r<=24) return R4.Condition(r-20);
  if (r>=25 && r<=29) return R5.Condition(r-25);
  if (r>=30 && r<=34) return R6.Condition(r-30);
  if (r>=35 && r<=39) return R7.Condition(r-35);
  if (r>=40 && r<=44) return R8.Condition(r-40);
  if (r>=45 && r<=49) return R9.Condition(r-45);
  if (r>=50 && r<=54) return R10.Condition(r-50);
  if (r>=55 && r<=64) return R11.Condition(r-55);
...
void Code(unsigned r)
{
  ...
  if (r>=20 && r<=24) { R4.Code(r-20); return; } 
  if (r>=25 && r<=29) { R5.Code(r-25); return; } 
  if (r>=30 && r<=34) { R6.Code(r-30); return; } 
  if (r>=35 && r<=39) { R7.Code(r-35); return; } 
  if (r>=40 && r<=44) { R8.Code(r-40); return; } 
  if (r>=45 && r<=49) { R9.Code(r-45); return; } 
  if (r>=50 && r<=54) { R10.Code(r-50); return; } 
  if (r>=55 && r<=64) { R11.Code(r-55); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=20 && r<=24) { return R4.Priority(); } 
  if (r>=25 && r<=29) { return R5.Priority(); } 
  if (r>=30 && r<=34) { return R6.Priority(); } 
  if (r>=35 && r<=39) { return R7.Priority(); } 
  if (r>=40 && r<=44) { return R8.Priority(); } 
  if (r>=45 && r<=49) { return R9.Priority(); } 
  if (r>=50 && r<=54) { return R10.Priority(); } 
  if (r>=55 && r<=64) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=20 && r<=24) return R4.Name(r-20);
  if (r>=25 && r<=29) return R5.Name(r-25);
  if (r>=30 && r<=34) return R6.Name(r-30);
  if (r>=35 && r<=39) return R7.Name(r-35);
  if (r>=40 && r<=44) return R8.Name(r-40);
  if (r>=45 && r<=49) return R9.Name(r-45);
  if (r>=50 && r<=54) return R10.Name(r-50);
  if (r>=55 && r<=64) return R11.Name(r-55);
  return NULL;
}
};
const unsigned numrules = 65;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 65
...
/********************
  Invariant records
 ********************/
int mu__invariant_44() // Invariant "DataProp"
{
bool mu__boolexpr45;
bool mu__boolexpr46;
  if (!((mu_ExGntd) == (mu_false))) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_MemData) == (mu_AuxData)) ; 
}
...
for(int mu_i = 1; mu_i <= 5; mu_i++) {
bool mu__boolexpr48;
  if (!((mu_Cache[mu_i].mu_State) != (mu_I))) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_Cache[mu_i].mu_Data) == (mu_AuxData)) ; 
}
if ( !(mu__boolexpr48) )
  { mu__quant47 = FALSE; break; }
};
};
  mu__boolexpr45 = (mu__quant47) ; 
}
return mu__boolexpr45;
};

bool mu__condition_49() // Condition for Rule "DataProp"
{
...
int mu__invariant_50( const mu_1_NODE &mu_j, const mu_1_NODE &mu_i) // Invariant "CntrlProp"
{
bool mu__boolexpr51;
  if (!((mu_i) != (mu_j))) mu__boolexpr51 = TRUE ;
  else {
bool mu__boolexpr52;
bool mu__boolexpr53;
  if (!((mu_Cache[mu_i].mu_State) == (mu_E))) mu__boolexpr53 = TRUE ;
  else {
  mu__boolexpr53 = ((mu_Cache[mu_j].mu_State) == (mu_I)) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = FALSE ;
  else {
bool mu__boolexpr54;
  if (!((mu_Cache[mu_i].mu_State) == (mu_S))) mu__boolexpr54 = TRUE ;
  else {
bool mu__boolexpr55;
  if ((mu_Cache[mu_j].mu_State) == (mu_I)) mu__boolexpr55 = TRUE ;
  else {
  mu__boolexpr55 = ((mu_Cache[mu_j].mu_State) == (mu_E)) ; 
}
...
bool mu__condition_58() // Condition for Rule "CntrlProp, j:1, i:1"
{
  return mu__invariant_50( 1, 1 );
}

bool mu__condition_59() // Condition for Rule "CntrlProp, j:1, i:2"
{
  return mu__invariant_50( 1, 2 );
}

bool mu__condition_60() // Condition for Rule "CntrlProp, j:1, i:3"
{
  return mu__invariant_50( 1, 3 );
}

bool mu__condition_61() // Condition for Rule "CntrlProp, j:1, i:4"
{
  return mu__invariant_50( 1, 4 );
}

bool mu__condition_62() // Condition for Rule "CntrlProp, j:1, i:5"
{
  return mu__invariant_50( 1, 5 );
}

bool mu__condition_64() // Condition for Rule "CntrlProp, j:2, i:1"
{
  return mu__invariant_50( 2, 1 );
}

bool mu__condition_65() // Condition for Rule "CntrlProp, j:2, i:2"
{
  return mu__invariant_50( 2, 2 );
}

bool mu__condition_66() // Condition for Rule "CntrlProp, j:2, i:3"
{
  return mu__invariant_50( 2, 3 );
}

bool mu__condition_67() // Condition for Rule "CntrlProp, j:2, i:4"
{
  return mu__invariant_50( 2, 4 );
}

bool mu__condition_68() // Condition for Rule "CntrlProp, j:2, i:5"
{
  return mu__invariant_50( 2, 5 );
}

bool mu__condition_70() // Condition for Rule "CntrlProp, j:3, i:1"
{
  return mu__invariant_50( 3, 1 );
}

bool mu__condition_71() // Condition for Rule "CntrlProp, j:3, i:2"
{
  return mu__invariant_50( 3, 2 );
}

bool mu__condition_72() // Condition for Rule "CntrlProp, j:3, i:3"
{
  return mu__invariant_50( 3, 3 );
}

bool mu__condition_73() // Condition for Rule "CntrlProp, j:3, i:4"
{
  return mu__invariant_50( 3, 4 );
}

bool mu__condition_74() // Condition for Rule "CntrlProp, j:3, i:5"
{
  return mu__invariant_50( 3, 5 );
}

bool mu__condition_76() // Condition for Rule "CntrlProp, j:4, i:1"
{
  return mu__invariant_50( 4, 1 );
}

bool mu__condition_77() // Condition for Rule "CntrlProp, j:4, i:2"
{
  return mu__invariant_50( 4, 2 );
}

bool mu__condition_78() // Condition for Rule "CntrlProp, j:4, i:3"
{
  return mu__invariant_50( 4, 3 );
}

bool mu__condition_79() // Condition for Rule "CntrlProp, j:4, i:4"
{
  return mu__invariant_50( 4, 4 );
}

bool mu__condition_80() // Condition for Rule "CntrlProp, j:4, i:5"
{
  return mu__invariant_50( 4, 5 );
}

bool mu__condition_82() // Condition for Rule "CntrlProp, j:5, i:1"
{
  return mu__invariant_50( 5, 1 );
}

bool mu__condition_83() // Condition for Rule "CntrlProp, j:5, i:2"
{
  return mu__invariant_50( 5, 2 );
}

bool mu__condition_84() // Condition for Rule "CntrlProp, j:5, i:3"
{
  return mu__invariant_50( 5, 3 );
}

bool mu__condition_85() // Condition for Rule "CntrlProp, j:5, i:4"
{
  return mu__invariant_50( 5, 4 );
}

bool mu__condition_86() // Condition for Rule "CntrlProp, j:5, i:5"
{
  return mu__invariant_50( 5, 5 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"CntrlProp, j:5, i:5", &mu__condition_86, NULL, },
{"CntrlProp, j:5, i:4", &mu__condition_85, NULL, },
{"CntrlProp, j:5, i:3", &mu__condition_84, NULL, },
{"CntrlProp, j:5, i:2", &mu__condition_83, NULL, },
{"CntrlProp, j:5, i:1", &mu__condition_82, NULL, },
{"CntrlProp, j:4, i:5", &mu__condition_80, NULL, },
...
{"CntrlProp, j:2, i:5", &mu__condition_68, NULL, },
{"CntrlProp, j:2, i:4", &mu__condition_67, NULL, },
{"CntrlProp, j:2, i:3", &mu__condition_66, NULL, },
{"CntrlProp, j:2, i:2", &mu__condition_65, NULL, },
{"CntrlProp, j:2, i:1", &mu__condition_64, NULL, },
{"CntrlProp, j:1, i:5", &mu__condition_62, NULL, },
{"CntrlProp, j:1, i:4", &mu__condition_61, NULL, },
{"CntrlProp, j:1, i:3", &mu__condition_60, NULL, },
{"CntrlProp, j:1, i:2", &mu__condition_59, NULL, },
{"CntrlProp, j:1, i:1", &mu__condition_58, NULL, },
{"DataProp", &mu__condition_49, NULL, },
};
