/******************************
  Program "./benchmarks/murphi_protocols/mutual_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/mutual_node2"
