/******************************
  Program "./benchmarks/murphi_protocols/german_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/german_node2"
...
void Goal_value() {  // makun: set goalstate
    ...
    mu_Cache[2].mu_State.value(mu_E);
...
void Goal_value1() {  // makun: set goalstate1
