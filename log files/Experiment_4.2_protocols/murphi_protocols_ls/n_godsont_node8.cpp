...
class mu_1_TYPE_NODE: public mu__byte
{
 public:
  ...
  mu_1_TYPE_NODE (const char *name, int os): mu__byte(1, 8, 4, name, os) {};
  mu_1_TYPE_NODE (void): mu__byte(1, 8, 4) {};
  mu_1_TYPE_NODE (int val): mu__byte(1, 8, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
/*** Variable declaration ***/
mu_1_TYPE_NODE mu_curNode("curNode",656);

/*** Variable declaration ***/
mu_1_TYPE_CACHE mu_curCache("curCache",664);

/*** Variable declaration ***/
mu_1_TYPE_ADDR mu_curMemory("curMemory",672);

/*** Variable declaration ***/
mu_1_TYPE_DATA mu_curData("curData",680);

/*** Variable declaration ***/
mu_1_TYPE_LOCK mu_curLock("curLock",688);

/*** Variable declaration ***/
mu_1_REPLACE_STAGE mu_replace("replace",696);

/*** Variable declaration ***/
mu_1_REPLACE_RULE mu_repRule("repRule",704);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=32 && what_rule<96)
    { R2.NextRule(what_rule);
      if (what_rule<96) return; }
  if (what_rule>=96 && what_rule<224)
    { R3.NextRule(what_rule);
      if (what_rule<224) return; }
  if (what_rule>=224 && what_rule<288)
    { R4.NextRule(what_rule);
      if (what_rule<288) return; }
  if (what_rule>=288 && what_rule<320)
    { R5.NextRule(what_rule);
      if (what_rule<320) return; }
  if (what_rule>=320 && what_rule<384)
    { R6.NextRule(what_rule);
      if (what_rule<384) return; }
  if (what_rule>=384 && what_rule<385)
    { R7.NextRule(what_rule);
      if (what_rule<385) return; }
  if (what_rule>=385 && what_rule<417)
    { R8.NextRule(what_rule);
      if (what_rule<417) return; }
  if (what_rule>=417 && what_rule<481)
    { R9.NextRule(what_rule);
      if (what_rule<481) return; }
  if (what_rule>=481 && what_rule<482)
    { R10.NextRule(what_rule);
      if (what_rule<482) return; }
  if (what_rule>=482 && what_rule<546)
    { R11.NextRule(what_rule);
      if (what_rule<546) return; }
  if (what_rule>=546 && what_rule<610)
    { R12.NextRule(what_rule);
      if (what_rule<610) return; }
  if (what_rule>=610 && what_rule<642)
    { R13.NextRule(what_rule);
      if (what_rule<642) return; }
  if (what_rule>=642 && what_rule<706)
    { R14.NextRule(what_rule);
      if (what_rule<706) return; }
  if (what_rule>=706 && what_rule<738)
    { R15.NextRule(what_rule);
      if (what_rule<738) return; }
  if (what_rule>=738 && what_rule<754)
    { R16.NextRule(what_rule);
      if (what_rule<754) return; }
  if (what_rule>=754 && what_rule<755)
    { R17.NextRule(what_rule);
      if (what_rule<755) return; }
  if (what_rule>=755 && what_rule<787)
    { R18.NextRule(what_rule);
      if (what_rule<787) return; }
  if (what_rule>=787 && what_rule<819)
    { R19.NextRule(what_rule);
      if (what_rule<819) return; }
  if (what_rule>=819 && what_rule<835)
    { R20.NextRule(what_rule);
      if (what_rule<835) return; }
  if (what_rule>=835 && what_rule<851)
    { R21.NextRule(what_rule);
      if (what_rule<851) return; }
  if (what_rule>=851 && what_rule<853)
    { R22.NextRule(what_rule);
      if (what_rule<853) return; }
  if (what_rule>=853 && what_rule<861)
    { R23.NextRule(what_rule);
      if (what_rule<861) return; }
  if (what_rule>=861 && what_rule<877)
    { R24.NextRule(what_rule);
      if (what_rule<877) return; }
  if (what_rule>=877 && what_rule<885)
    { R25.NextRule(what_rule);
      if (what_rule<885) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  ...
  if (r>=32 && r<=95) return R2.Condition(r-32);
  if (r>=96 && r<=223) return R3.Condition(r-96);
  if (r>=224 && r<=287) return R4.Condition(r-224);
  if (r>=288 && r<=319) return R5.Condition(r-288);
  if (r>=320 && r<=383) return R6.Condition(r-320);
  if (r>=384 && r<=384) return R7.Condition(r-384);
  if (r>=385 && r<=416) return R8.Condition(r-385);
  if (r>=417 && r<=480) return R9.Condition(r-417);
  if (r>=481 && r<=481) return R10.Condition(r-481);
  if (r>=482 && r<=545) return R11.Condition(r-482);
  if (r>=546 && r<=609) return R12.Condition(r-546);
  if (r>=610 && r<=641) return R13.Condition(r-610);
  if (r>=642 && r<=705) return R14.Condition(r-642);
  if (r>=706 && r<=737) return R15.Condition(r-706);
  if (r>=738 && r<=753) return R16.Condition(r-738);
  if (r>=754 && r<=754) return R17.Condition(r-754);
  if (r>=755 && r<=786) return R18.Condition(r-755);
  if (r>=787 && r<=818) return R19.Condition(r-787);
  if (r>=819 && r<=834) return R20.Condition(r-819);
  if (r>=835 && r<=850) return R21.Condition(r-835);
  if (r>=851 && r<=852) return R22.Condition(r-851);
  if (r>=853 && r<=860) return R23.Condition(r-853);
  if (r>=861 && r<=876) return R24.Condition(r-861);
  if (r>=877 && r<=884) return R25.Condition(r-877);
...
void Code(unsigned r)
{
  ...
  if (r>=32 && r<=95) { R2.Code(r-32); return; } 
  if (r>=96 && r<=223) { R3.Code(r-96); return; } 
  if (r>=224 && r<=287) { R4.Code(r-224); return; } 
  if (r>=288 && r<=319) { R5.Code(r-288); return; } 
  if (r>=320 && r<=383) { R6.Code(r-320); return; } 
  if (r>=384 && r<=384) { R7.Code(r-384); return; } 
  if (r>=385 && r<=416) { R8.Code(r-385); return; } 
  if (r>=417 && r<=480) { R9.Code(r-417); return; } 
  if (r>=481 && r<=481) { R10.Code(r-481); return; } 
  if (r>=482 && r<=545) { R11.Code(r-482); return; } 
  if (r>=546 && r<=609) { R12.Code(r-546); return; } 
  if (r>=610 && r<=641) { R13.Code(r-610); return; } 
  if (r>=642 && r<=705) { R14.Code(r-642); return; } 
  if (r>=706 && r<=737) { R15.Code(r-706); return; } 
  if (r>=738 && r<=753) { R16.Code(r-738); return; } 
  if (r>=754 && r<=754) { R17.Code(r-754); return; } 
  if (r>=755 && r<=786) { R18.Code(r-755); return; } 
  if (r>=787 && r<=818) { R19.Code(r-787); return; } 
  if (r>=819 && r<=834) { R20.Code(r-819); return; } 
  if (r>=835 && r<=850) { R21.Code(r-835); return; } 
  if (r>=851 && r<=852) { R22.Code(r-851); return; } 
  if (r>=853 && r<=860) { R23.Code(r-853); return; } 
  if (r>=861 && r<=876) { R24.Code(r-861); return; } 
  if (r>=877 && r<=884) { R25.Code(r-877); return; } 
}
int Priority(unsigned short r)
{
  if (r<=15) { return R0.Priority(); } 
  if (r>=16 && r<=31) { return R1.Priority(); } 
  if (r>=32 && r<=95) { return R2.Priority(); } 
  if (r>=96 && r<=223) { return R3.Priority(); } 
  if (r>=224 && r<=287) { return R4.Priority(); } 
  if (r>=288 && r<=319) { return R5.Priority(); } 
  if (r>=320 && r<=383) { return R6.Priority(); } 
  if (r>=384 && r<=384) { return R7.Priority(); } 
  if (r>=385 && r<=416) { return R8.Priority(); } 
  if (r>=417 && r<=480) { return R9.Priority(); } 
  if (r>=481 && r<=481) { return R10.Priority(); } 
  if (r>=482 && r<=545) { return R11.Priority(); } 
  if (r>=546 && r<=609) { return R12.Priority(); } 
  if (r>=610 && r<=641) { return R13.Priority(); } 
  if (r>=642 && r<=705) { return R14.Priority(); } 
  if (r>=706 && r<=737) { return R15.Priority(); } 
  if (r>=738 && r<=753) { return R16.Priority(); } 
  if (r>=754 && r<=754) { return R17.Priority(); } 
  if (r>=755 && r<=786) { return R18.Priority(); } 
  if (r>=787 && r<=818) { return R19.Priority(); } 
  if (r>=819 && r<=834) { return R20.Priority(); } 
  if (r>=835 && r<=850) { return R21.Priority(); } 
  if (r>=851 && r<=852) { return R22.Priority(); } 
  if (r>=853 && r<=860) { return R23.Priority(); } 
  if (r>=861 && r<=876) { return R24.Priority(); } 
  if (r>=877 && r<=884) { return R25.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=15) return R0.Name(r-0);
  if (r>=16 && r<=31) return R1.Name(r-16);
  if (r>=32 && r<=95) return R2.Name(r-32);
  if (r>=96 && r<=223) return R3.Name(r-96);
  if (r>=224 && r<=287) return R4.Name(r-224);
  if (r>=288 && r<=319) return R5.Name(r-288);
  if (r>=320 && r<=383) return R6.Name(r-320);
  if (r>=384 && r<=384) return R7.Name(r-384);
  if (r>=385 && r<=416) return R8.Name(r-385);
  if (r>=417 && r<=480) return R9.Name(r-417);
  if (r>=481 && r<=481) return R10.Name(r-481);
  if (r>=482 && r<=545) return R11.Name(r-482);
  if (r>=546 && r<=609) return R12.Name(r-546);
  if (r>=610 && r<=641) return R13.Name(r-610);
  if (r>=642 && r<=705) return R14.Name(r-642);
  if (r>=706 && r<=737) return R15.Name(r-706);
  if (r>=738 && r<=753) return R16.Name(r-738);
  if (r>=754 && r<=754) return R17.Name(r-754);
  if (r>=755 && r<=786) return R18.Name(r-755);
  if (r>=787 && r<=818) return R19.Name(r-787);
  if (r>=819 && r<=834) return R20.Name(r-819);
  if (r>=835 && r<=850) return R21.Name(r-835);
  if (r>=851 && r<=852) return R22.Name(r-851);
  if (r>=853 && r<=860) return R23.Name(r-853);
  if (r>=861 && r<=876) return R24.Name(r-861);
  if (r>=877 && r<=884) return R25.Name(r-877);
  return NULL;
}
};
const unsigned numrules = 885;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 885
...
bool mu__condition_264() // Condition for Rule "Coherence, a:1, j:2, i:1"
{
  return mu__invariant_246( 1, 2, 1 );
}

bool mu__condition_265() // Condition for Rule "Coherence, a:1, j:2, i:2"
{
  return mu__invariant_246( 1, 2, 2 );
}

bool mu__condition_266() // Condition for Rule "Coherence, a:1, j:2, i:3"
{
  return mu__invariant_246( 1, 2, 3 );
}

bool mu__condition_267() // Condition for Rule "Coherence, a:1, j:2, i:4"
{
  return mu__invariant_246( 1, 2, 4 );
}

bool mu__condition_268() // Condition for Rule "Coherence, a:1, j:2, i:5"
{
  return mu__invariant_246( 1, 2, 5 );
}

bool mu__condition_269() // Condition for Rule "Coherence, a:1, j:2, i:6"
{
  return mu__invariant_246( 1, 2, 6 );
}

bool mu__condition_270() // Condition for Rule "Coherence, a:1, j:2, i:7"
{
  return mu__invariant_246( 1, 2, 7 );
}

bool mu__condition_271() // Condition for Rule "Coherence, a:1, j:2, i:8"
{
  return mu__invariant_246( 1, 2, 8 );
}

bool mu__condition_274() // Condition for Rule "Coherence, a:2, j:1, i:1"
{
  return mu__invariant_246( 2, 1, 1 );
}

bool mu__condition_275() // Condition for Rule "Coherence, a:2, j:1, i:2"
{
  return mu__invariant_246( 2, 1, 2 );
}

bool mu__condition_276() // Condition for Rule "Coherence, a:2, j:1, i:3"
{
  return mu__invariant_246( 2, 1, 3 );
}

bool mu__condition_277() // Condition for Rule "Coherence, a:2, j:1, i:4"
{
  return mu__invariant_246( 2, 1, 4 );
}

bool mu__condition_278() // Condition for Rule "Coherence, a:2, j:1, i:5"
{
  return mu__invariant_246( 2, 1, 5 );
}

bool mu__condition_279() // Condition for Rule "Coherence, a:2, j:1, i:6"
{
  return mu__invariant_246( 2, 1, 6 );
}

bool mu__condition_280() // Condition for Rule "Coherence, a:2, j:1, i:7"
{
  return mu__invariant_246( 2, 1, 7 );
}

bool mu__condition_281() // Condition for Rule "Coherence, a:2, j:1, i:8"
{
  return mu__invariant_246( 2, 1, 8 );
}

bool mu__condition_283() // Condition for Rule "Coherence, a:2, j:2, i:1"
{
  return mu__invariant_246( 2, 2, 1 );
}

bool mu__condition_284() // Condition for Rule "Coherence, a:2, j:2, i:2"
{
  return mu__invariant_246( 2, 2, 2 );
}

bool mu__condition_285() // Condition for Rule "Coherence, a:2, j:2, i:3"
{
  return mu__invariant_246( 2, 2, 3 );
}

bool mu__condition_286() // Condition for Rule "Coherence, a:2, j:2, i:4"
{
  return mu__invariant_246( 2, 2, 4 );
}

bool mu__condition_287() // Condition for Rule "Coherence, a:2, j:2, i:5"
{
  return mu__invariant_246( 2, 2, 5 );
}

bool mu__condition_288() // Condition for Rule "Coherence, a:2, j:2, i:6"
{
  return mu__invariant_246( 2, 2, 6 );
}

bool mu__condition_289() // Condition for Rule "Coherence, a:2, j:2, i:7"
{
  return mu__invariant_246( 2, 2, 7 );
}

bool mu__condition_290() // Condition for Rule "Coherence, a:2, j:2, i:8"
{
...
{"Coherence, a:2, j:2, i:8", &mu__condition_290, NULL, },
{"Coherence, a:2, j:2, i:7", &mu__condition_289, NULL, },
{"Coherence, a:2, j:2, i:6", &mu__condition_288, NULL, },
{"Coherence, a:2, j:2, i:5", &mu__condition_287, NULL, },
{"Coherence, a:2, j:2, i:4", &mu__condition_286, NULL, },
{"Coherence, a:2, j:2, i:3", &mu__condition_285, NULL, },
{"Coherence, a:2, j:2, i:2", &mu__condition_284, NULL, },
{"Coherence, a:2, j:2, i:1", &mu__condition_283, NULL, },
{"Coherence, a:2, j:1, i:8", &mu__condition_281, NULL, },
{"Coherence, a:2, j:1, i:7", &mu__condition_280, NULL, },
{"Coherence, a:2, j:1, i:6", &mu__condition_279, NULL, },
{"Coherence, a:2, j:1, i:5", &mu__condition_278, NULL, },
{"Coherence, a:2, j:1, i:4", &mu__condition_277, NULL, },
{"Coherence, a:2, j:1, i:3", &mu__condition_276, NULL, },
{"Coherence, a:2, j:1, i:2", &mu__condition_275, NULL, },
{"Coherence, a:2, j:1, i:1", &mu__condition_274, NULL, },
{"Coherence, a:1, j:2, i:8", &mu__condition_271, NULL, },
{"Coherence, a:1, j:2, i:7", &mu__condition_270, NULL, },
{"Coherence, a:1, j:2, i:6", &mu__condition_269, NULL, },
{"Coherence, a:1, j:2, i:5", &mu__condition_268, NULL, },
{"Coherence, a:1, j:2, i:4", &mu__condition_267, NULL, },
{"Coherence, a:1, j:2, i:3", &mu__condition_266, NULL, },
{"Coherence, a:1, j:2, i:2", &mu__condition_265, NULL, },
{"Coherence, a:1, j:2, i:1", &mu__condition_264, NULL, },
...
const unsigned short numinvariants = 32;
