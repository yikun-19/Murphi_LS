/******************************
  Program "./benchmarks/murphi_protocols/mutual_node8.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/mutual_node8"
...
class mu_1_client: public mu__byte
{
 public:
  ...
  mu_1_client (const char *name, int os): mu__byte(1, 8, 4, name, os) {};
  mu_1_client (void): mu__byte(1, 8, 4) {};
  mu_1_client (int val): mu__byte(1, 8, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
bool mu__condition_17() // Condition for Rule "coherence, j:2, i:1"
{
  return mu__invariant_3( 2, 1 );
}

bool mu__condition_18() // Condition for Rule "coherence, j:2, i:2"
{
  return mu__invariant_3( 2, 2 );
}

bool mu__condition_19() // Condition for Rule "coherence, j:2, i:3"
{
  return mu__invariant_3( 2, 3 );
}

bool mu__condition_20() // Condition for Rule "coherence, j:2, i:4"
{
  return mu__invariant_3( 2, 4 );
}

bool mu__condition_21() // Condition for Rule "coherence, j:2, i:5"
{
  return mu__invariant_3( 2, 5 );
}

bool mu__condition_22() // Condition for Rule "coherence, j:2, i:6"
{
  return mu__invariant_3( 2, 6 );
}

bool mu__condition_23() // Condition for Rule "coherence, j:2, i:7"
{
  return mu__invariant_3( 2, 7 );
}

bool mu__condition_24() // Condition for Rule "coherence, j:2, i:8"
{
  return mu__invariant_3( 2, 8 );
}

bool mu__condition_26() // Condition for Rule "coherence, j:3, i:1"
{
  return mu__invariant_3( 3, 1 );
}

bool mu__condition_27() // Condition for Rule "coherence, j:3, i:2"
{
  return mu__invariant_3( 3, 2 );
}

bool mu__condition_28() // Condition for Rule "coherence, j:3, i:3"
{
  return mu__invariant_3( 3, 3 );
}

bool mu__condition_29() // Condition for Rule "coherence, j:3, i:4"
{
  return mu__invariant_3( 3, 4 );
}

bool mu__condition_30() // Condition for Rule "coherence, j:3, i:5"
{
  return mu__invariant_3( 3, 5 );
}

bool mu__condition_31() // Condition for Rule "coherence, j:3, i:6"
{
  return mu__invariant_3( 3, 6 );
}

bool mu__condition_32() // Condition for Rule "coherence, j:3, i:7"
{
  return mu__invariant_3( 3, 7 );
}

bool mu__condition_33() // Condition for Rule "coherence, j:3, i:8"
{
  return mu__invariant_3( 3, 8 );
}

bool mu__condition_35() // Condition for Rule "coherence, j:4, i:1"
{
  return mu__invariant_3( 4, 1 );
}

bool mu__condition_36() // Condition for Rule "coherence, j:4, i:2"
{
  return mu__invariant_3( 4, 2 );
}

bool mu__condition_37() // Condition for Rule "coherence, j:4, i:3"
{
  return mu__invariant_3( 4, 3 );
}

bool mu__condition_38() // Condition for Rule "coherence, j:4, i:4"
{
  return mu__invariant_3( 4, 4 );
}

bool mu__condition_39() // Condition for Rule "coherence, j:4, i:5"
{
  return mu__invariant_3( 4, 5 );
}

bool mu__condition_40() // Condition for Rule "coherence, j:4, i:6"
{
  return mu__invariant_3( 4, 6 );
}

bool mu__condition_41() // Condition for Rule "coherence, j:4, i:7"
{
  return mu__invariant_3( 4, 7 );
}

bool mu__condition_42() // Condition for Rule "coherence, j:4, i:8"
{
  return mu__invariant_3( 4, 8 );
}

bool mu__condition_44() // Condition for Rule "coherence, j:5, i:1"
{
  return mu__invariant_3( 5, 1 );
}

bool mu__condition_45() // Condition for Rule "coherence, j:5, i:2"
{
  return mu__invariant_3( 5, 2 );
}

bool mu__condition_46() // Condition for Rule "coherence, j:5, i:3"
{
  return mu__invariant_3( 5, 3 );
}

bool mu__condition_47() // Condition for Rule "coherence, j:5, i:4"
{
  return mu__invariant_3( 5, 4 );
}

bool mu__condition_48() // Condition for Rule "coherence, j:5, i:5"
{
  return mu__invariant_3( 5, 5 );
}

bool mu__condition_49() // Condition for Rule "coherence, j:5, i:6"
{
  return mu__invariant_3( 5, 6 );
}

bool mu__condition_50() // Condition for Rule "coherence, j:5, i:7"
{
  return mu__invariant_3( 5, 7 );
}

bool mu__condition_51() // Condition for Rule "coherence, j:5, i:8"
{
  return mu__invariant_3( 5, 8 );
}

bool mu__condition_53() // Condition for Rule "coherence, j:6, i:1"
{
  return mu__invariant_3( 6, 1 );
}

bool mu__condition_54() // Condition for Rule "coherence, j:6, i:2"
{
  return mu__invariant_3( 6, 2 );
}

bool mu__condition_55() // Condition for Rule "coherence, j:6, i:3"
{
  return mu__invariant_3( 6, 3 );
}

bool mu__condition_56() // Condition for Rule "coherence, j:6, i:4"
{
  return mu__invariant_3( 6, 4 );
}

bool mu__condition_57() // Condition for Rule "coherence, j:6, i:5"
{
  return mu__invariant_3( 6, 5 );
}

bool mu__condition_58() // Condition for Rule "coherence, j:6, i:6"
{
  return mu__invariant_3( 6, 6 );
}

bool mu__condition_59() // Condition for Rule "coherence, j:6, i:7"
{
  return mu__invariant_3( 6, 7 );
}

bool mu__condition_60() // Condition for Rule "coherence, j:6, i:8"
{
  return mu__invariant_3( 6, 8 );
}

bool mu__condition_62() // Condition for Rule "coherence, j:7, i:1"
{
  return mu__invariant_3( 7, 1 );
}

bool mu__condition_63() // Condition for Rule "coherence, j:7, i:2"
{
  return mu__invariant_3( 7, 2 );
}

bool mu__condition_64() // Condition for Rule "coherence, j:7, i:3"
{
  return mu__invariant_3( 7, 3 );
}

bool mu__condition_65() // Condition for Rule "coherence, j:7, i:4"
{
  return mu__invariant_3( 7, 4 );
}

bool mu__condition_66() // Condition for Rule "coherence, j:7, i:5"
{
  return mu__invariant_3( 7, 5 );
}

bool mu__condition_67() // Condition for Rule "coherence, j:7, i:6"
{
  return mu__invariant_3( 7, 6 );
}

bool mu__condition_68() // Condition for Rule "coherence, j:7, i:7"
{
  return mu__invariant_3( 7, 7 );
}

bool mu__condition_69() // Condition for Rule "coherence, j:7, i:8"
{
  return mu__invariant_3( 7, 8 );
}

bool mu__condition_71() // Condition for Rule "coherence, j:8, i:1"
{
  return mu__invariant_3( 8, 1 );
}

bool mu__condition_72() // Condition for Rule "coherence, j:8, i:2"
{
  return mu__invariant_3( 8, 2 );
}

bool mu__condition_73() // Condition for Rule "coherence, j:8, i:3"
{
  return mu__invariant_3( 8, 3 );
}

bool mu__condition_74() // Condition for Rule "coherence, j:8, i:4"
{
  return mu__invariant_3( 8, 4 );
}

bool mu__condition_75() // Condition for Rule "coherence, j:8, i:5"
{
  return mu__invariant_3( 8, 5 );
}

bool mu__condition_76() // Condition for Rule "coherence, j:8, i:6"
{
  return mu__invariant_3( 8, 6 );
}

bool mu__condition_77() // Condition for Rule "coherence, j:8, i:7"
{
  return mu__invariant_3( 8, 7 );
}

bool mu__condition_78() // Condition for Rule "coherence, j:8, i:8"
{
...
{"coherence, j:8, i:8", &mu__condition_78, NULL, },
{"coherence, j:8, i:7", &mu__condition_77, NULL, },
{"coherence, j:8, i:6", &mu__condition_76, NULL, },
{"coherence, j:8, i:5", &mu__condition_75, NULL, },
{"coherence, j:8, i:4", &mu__condition_74, NULL, },
{"coherence, j:8, i:3", &mu__condition_73, NULL, },
{"coherence, j:8, i:2", &mu__condition_72, NULL, },
{"coherence, j:8, i:1", &mu__condition_71, NULL, },
{"coherence, j:7, i:8", &mu__condition_69, NULL, },
{"coherence, j:7, i:7", &mu__condition_68, NULL, },
{"coherence, j:7, i:6", &mu__condition_67, NULL, },
{"coherence, j:7, i:5", &mu__condition_66, NULL, },
{"coherence, j:7, i:4", &mu__condition_65, NULL, },
{"coherence, j:7, i:3", &mu__condition_64, NULL, },
{"coherence, j:7, i:2", &mu__condition_63, NULL, },
{"coherence, j:7, i:1", &mu__condition_62, NULL, },
{"coherence, j:6, i:8", &mu__condition_60, NULL, },
{"coherence, j:6, i:7", &mu__condition_59, NULL, },
{"coherence, j:6, i:6", &mu__condition_58, NULL, },
{"coherence, j:6, i:5", &mu__condition_57, NULL, },
{"coherence, j:6, i:4", &mu__condition_56, NULL, },
{"coherence, j:6, i:3", &mu__condition_55, NULL, },
{"coherence, j:6, i:2", &mu__condition_54, NULL, },
{"coherence, j:6, i:1", &mu__condition_53, NULL, },
{"coherence, j:5, i:8", &mu__condition_51, NULL, },
{"coherence, j:5, i:7", &mu__condition_50, NULL, },
{"coherence, j:5, i:6", &mu__condition_49, NULL, },
{"coherence, j:5, i:5", &mu__condition_48, NULL, },
{"coherence, j:5, i:4", &mu__condition_47, NULL, },
{"coherence, j:5, i:3", &mu__condition_46, NULL, },
{"coherence, j:5, i:2", &mu__condition_45, NULL, },
{"coherence, j:5, i:1", &mu__condition_44, NULL, },
{"coherence, j:4, i:8", &mu__condition_42, NULL, },
{"coherence, j:4, i:7", &mu__condition_41, NULL, },
{"coherence, j:4, i:6", &mu__condition_40, NULL, },
{"coherence, j:4, i:5", &mu__condition_39, NULL, },
{"coherence, j:4, i:4", &mu__condition_38, NULL, },
{"coherence, j:4, i:3", &mu__condition_37, NULL, },
{"coherence, j:4, i:2", &mu__condition_36, NULL, },
{"coherence, j:4, i:1", &mu__condition_35, NULL, },
{"coherence, j:3, i:8", &mu__condition_33, NULL, },
{"coherence, j:3, i:7", &mu__condition_32, NULL, },
{"coherence, j:3, i:6", &mu__condition_31, NULL, },
{"coherence, j:3, i:5", &mu__condition_30, NULL, },
{"coherence, j:3, i:4", &mu__condition_29, NULL, },
{"coherence, j:3, i:3", &mu__condition_28, NULL, },
{"coherence, j:3, i:2", &mu__condition_27, NULL, },
{"coherence, j:3, i:1", &mu__condition_26, NULL, },
{"coherence, j:2, i:8", &mu__condition_24, NULL, },
{"coherence, j:2, i:7", &mu__condition_23, NULL, },
{"coherence, j:2, i:6", &mu__condition_22, NULL, },
{"coherence, j:2, i:5", &mu__condition_21, NULL, },
{"coherence, j:2, i:4", &mu__condition_20, NULL, },
{"coherence, j:2, i:3", &mu__condition_19, NULL, },
{"coherence, j:2, i:2", &mu__condition_18, NULL, },
{"coherence, j:2, i:1", &mu__condition_17, NULL, },
