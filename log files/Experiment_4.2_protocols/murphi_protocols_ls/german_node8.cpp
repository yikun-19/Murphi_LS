/******************************
  Program "./benchmarks/murphi_protocols/german_node8.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/german_node8"
