/******************************
  Program "./benchmarks/murphi_protocols/ldash_node4.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/ldash_node4"
#define BITS_IN_WORLD 4232
#define ALIGN
...
class mu_1_LAddress: public mu__byte
{
 public:
  ...
  mu_1_LAddress (const char *name, int os): mu__byte(6, 6, 1, name, os) {};
...
class mu_1_Dir_Index: public mu__byte
{
 public:
  ...
  mu_1_Dir_Index (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu_1_Request_Type: public mu__byte
{
 public:
  ...
  mu_1_Request_Type (const char *name, int os): mu__byte(7, 9, 2, name, os) {};
...
class mu_1_Reply_Type: public mu__byte
{
 public:
  ...
  mu_1_Reply_Type (const char *name, int os): mu__byte(10, 12, 2, name, os) {};
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  mu_1_RAC_State (const char *name, int os): mu__byte(13, 19, 3, name, os) {};
...
class mu_1_Cache_State: public mu__byte
{
 public:
  ...
  mu_1_Cache_State (const char *name, int os): mu__byte(20, 21, 2, name, os) {};
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (const char *name, int os): mu__byte(22, 24, 2, name, os) {};
...
if (n) array[i].set_self_ar(n,"LAddress_1", i * 56 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 400 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 400 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 400 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 400 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 400 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_25: public mu__byte
{
 public:
  ...
  mu_1__type_25 (const char *name, int os): mu__byte(25, 26, 2, name, os) {};
...
/*** Variable declaration ***/
mu_1__type_22 mu_ReplyNet("ReplyNet",2000);

/*** Variable declaration ***/
mu_1__type_23 mu_Procs("Procs",4000);

/*** Variable declaration ***/
mu_1__type_24 mu_Homes("Homes",4160);

const int mu_Invalid = 25;
const int mu_Valid = 26;
/*** Variable declaration ***/
mu_1__type_28 mu_LockOwner("LockOwner",4216);
