/******************************
  Program "./benchmarks/murphi_protocols/ldash_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/ldash_node2"
...
class mu_1_LAddress: public mu__byte
{
 public:
  ...
  friend ostream& operator<< (ostream& s, mu_1_LAddress& val)
    {
      if (val.defined())
	return ( s << mu_1_LAddress::values[ int(val) - 4 ] );
      else
	return ( s << "Undefined" );
    };

  mu_1_LAddress (const char *name, int os): mu__byte(4, 4, 1, name, os) {};
  mu_1_LAddress (void): mu__byte(4, 4, 1) {};
  mu_1_LAddress (int val): mu__byte(4, 4, 1, "Parameter or function result.", 0)
    { operator=(val); };
...
class mu_1_Dir_Index: public mu__byte
{
 public:
  ...
  mu_1_Dir_Index (const char *name, int os): mu__byte(0, 2, 2, name, os) {};
  mu_1_Dir_Index (void): mu__byte(0, 2, 2) {};
  mu_1_Dir_Index (int val): mu__byte(0, 2, 2, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
class mu_1_Request_Type: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_Request_Type::values[ int(val) - 5] );
    else return ( s << "Undefined" );
  };

  mu_1_Request_Type (const char *name, int os): mu__byte(5, 7, 2, name, os) {};
  mu_1_Request_Type (void): mu__byte(5, 7, 2) {};
  mu_1_Request_Type (int val): mu__byte(5, 7, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_Reply_Type: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_Reply_Type::values[ int(val) - 8] );
    else return ( s << "Undefined" );
  };

  mu_1_Reply_Type (const char *name, int os): mu__byte(8, 10, 2, name, os) {};
  mu_1_Reply_Type (void): mu__byte(8, 10, 2) {};
  mu_1_Reply_Type (int val): mu__byte(8, 10, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RAC_State::values[ int(val) - 11] );
    else return ( s << "Undefined" );
  };

  mu_1_RAC_State (const char *name, int os): mu__byte(11, 17, 3, name, os) {};
  mu_1_RAC_State (void): mu__byte(11, 17, 3) {};
  mu_1_RAC_State (int val): mu__byte(11, 17, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_Cache_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_Cache_State::values[ int(val) - 18] );
    else return ( s << "Undefined" );
  };

  mu_1_Cache_State (const char *name, int os): mu__byte(18, 19, 2, name, os) {};
  mu_1_Cache_State (void): mu__byte(18, 19, 2) {};
  mu_1_Cache_State (int val): mu__byte(18, 19, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (const char *name, int os): mu__byte(20, 22, 2, name, os) {};
  mu_1__type_0 (void): mu__byte(20, 22, 2) {};
  mu_1__type_0 (int val): mu__byte(20, 22, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
 ...
 public:
  ...
  mu_1__type_2& operator[] (int index) /* const */
  {
	...
	if (index==UNDEFVAL) 
	  ...
	  Error.Error("Funny index value %d for %s: LAddress is internally represented from 4 to 4.\nInternal Error in Type checking.",index, name);
	return array[0];
      }
#else
    return array[ index - 4 ];
...
if (n) array[i].set_self_ar(n,"LAddress_1", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 240 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 240 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 240 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_25: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_25::values[ int(val) - 23] );
    else return ( s << "Undefined" );
  };

  mu_1__type_25 (const char *name, int os): mu__byte(23, 24, 2, name, os) {};
  mu_1__type_25 (void): mu__byte(23, 24, 2) {};
  mu_1__type_25 (int val): mu__byte(23, 24, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const int mu_LAddress_1 = 4;
const int mu_RD_L = 5;
const int mu_GSET = 6;
const int mu_IOWR = 7;
const int mu_ACK_L = 8;
const int mu_LCK = 9;
const int mu_UNLCK = 10;
const int mu_INVAL = 11;
const int mu_DLCK = 12;
const int mu_DULCK = 13;
const int mu_DGNTS = 14;
const int mu_WLCK = 15;
const int mu_RLCK = 16;
const int mu_WDIRW = 17;
const int mu_Non_Locally_Cached = 18;
const int mu_Locally_Shared = 19;
const int mu_Unlocked = 20;
const int mu_Locked = 21;
const int mu_Queued = 22;
/*** Variable declaration ***/
mu_1__type_17 mu_ReqNet("ReqNet",0);

/*** Variable declaration ***/
mu_1__type_22 mu_ReplyNet("ReplyNet",720);

/*** Variable declaration ***/
mu_1__type_23 mu_Procs("Procs",1440);

/*** Variable declaration ***/
mu_1__type_24 mu_Homes("Homes",1536);

const int mu_Invalid = 23;
const int mu_Valid = 24;
/*** Variable declaration ***/
mu_1__type_28 mu_LockOwner("LockOwner",1576);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=27 && what_rule<36)
    { R3.NextRule(what_rule);
      if (what_rule<36) return; }
  if (what_rule>=36 && what_rule<63)
    { R4.NextRule(what_rule);
      if (what_rule<63) return; }
  if (what_rule>=63 && what_rule<72)
    { R5.NextRule(what_rule);
      if (what_rule<72) return; }
  if (what_rule>=72 && what_rule<81)
    { R6.NextRule(what_rule);
      if (what_rule<81) return; }
  if (what_rule>=81 && what_rule<90)
    { R7.NextRule(what_rule);
      if (what_rule<90) return; }
  if (what_rule>=90 && what_rule<93)
    { R8.NextRule(what_rule);
      if (what_rule<93) return; }
  if (what_rule>=93 && what_rule<102)
    { R9.NextRule(what_rule);
      if (what_rule<102) return; }
  if (what_rule>=102 && what_rule<105)
    { R10.NextRule(what_rule);
      if (what_rule<105) return; }
  if (what_rule>=105 && what_rule<108)
...
bool Condition(unsigned r)
{
  ...
  if (r>=27 && r<=35) return R3.Condition(r-27);
  if (r>=36 && r<=62) return R4.Condition(r-36);
  if (r>=63 && r<=71) return R5.Condition(r-63);
  if (r>=72 && r<=80) return R6.Condition(r-72);
  if (r>=81 && r<=89) return R7.Condition(r-81);
  if (r>=90 && r<=92) return R8.Condition(r-90);
  if (r>=93 && r<=101) return R9.Condition(r-93);
  if (r>=102 && r<=104) return R10.Condition(r-102);
  if (r>=105 && r<=107) return R11.Condition(r-105);
...
void Code(unsigned r)
{
  ...
  if (r>=27 && r<=35) { R3.Code(r-27); return; } 
  if (r>=36 && r<=62) { R4.Code(r-36); return; } 
  if (r>=63 && r<=71) { R5.Code(r-63); return; } 
  if (r>=72 && r<=80) { R6.Code(r-72); return; } 
  if (r>=81 && r<=89) { R7.Code(r-81); return; } 
  if (r>=90 && r<=92) { R8.Code(r-90); return; } 
  if (r>=93 && r<=101) { R9.Code(r-93); return; } 
  if (r>=102 && r<=104) { R10.Code(r-102); return; } 
  if (r>=105 && r<=107) { R11.Code(r-105); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=27 && r<=35) { return R3.Priority(); } 
  if (r>=36 && r<=62) { return R4.Priority(); } 
  if (r>=63 && r<=71) { return R5.Priority(); } 
  if (r>=72 && r<=80) { return R6.Priority(); } 
  if (r>=81 && r<=89) { return R7.Priority(); } 
  if (r>=90 && r<=92) { return R8.Priority(); } 
  if (r>=93 && r<=101) { return R9.Priority(); } 
  if (r>=102 && r<=104) { return R10.Priority(); } 
  if (r>=105 && r<=107) { return R11.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=27 && r<=35) return R3.Name(r-27);
  if (r>=36 && r<=62) return R4.Name(r-36);
  if (r>=63 && r<=71) return R5.Name(r-63);
  if (r>=72 && r<=80) return R6.Name(r-72);
  if (r>=81 && r<=89) return R7.Name(r-81);
  if (r>=90 && r<=92) return R8.Name(r-90);
  if (r>=93 && r<=101) return R9.Name(r-93);
  if (r>=102 && r<=104) return R10.Name(r-102);
  if (r>=105 && r<=107) return R11.Name(r-105);
  return NULL;
}
};
const unsigned numrules = 108;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 108
...
void Goal_value() {  // makun: set goalstate
    ...
    // set goalstate value: 
    mu_LockOwner[1][4].mu_State.value(mu_Valid);
    mu_Homes[1].mu_LDir[4].mu_State.value(mu_Locked);

    // set carelist about invariant 
    carelist.clear();  
    carelist.push_back("LockOwner[1][4].State");
    carelist.push_back("Homes[1].LDir[4].State");
...
/********************
  Invariant records
 ********************/
int mu__invariant_81() // Invariant "Correct lock state -> forward"
{
bool mu__quant82; 
mu__quant82 = TRUE;
{
...
for(int mu_l = 4; mu_l <= 4; mu_l++) {
bool mu__boolexpr84;
  if (!((mu_LockOwner[mu_h][mu_l].mu_State) == (mu_Valid))) mu__boolexpr84 = TRUE ;
  else {
  mu__boolexpr84 = ((mu_Homes[mu_h].mu_LDir[mu_l].mu_State) != (mu_Locked)) ; 
}
if ( !(mu__boolexpr84) )
...
bool mu__condition_85() // Condition for Rule "Correct lock state -> forward"
{
...
{"Correct lock state -> forward", &mu__condition_85, NULL, },
};
      ...
      if (Perm.MTO_class_mu_1_Remote() && count_mu_1_Remote<2)
        {
          ...
          for (k=0; k<2; k++) // step through class
            if (!(*this)[k+2].mu_LRAC[mu_Home_1][mu_LAddress_1].mu_Granting.isundefined()
                ...
                &&(*this)[k+2].mu_LRAC[mu_Home_1][mu_LAddress_1].mu_Granting<=3)
              exists = TRUE;
          if (exists)
            {
              for (i=0; i<count_mu_1_Remote; i++) // for value priority
