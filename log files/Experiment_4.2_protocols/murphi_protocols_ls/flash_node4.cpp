/******************************
  Program "./benchmarks/murphi_protocols/flash_node4.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/flash_node4"
#define BITS_IN_WORLD 488
#define ALIGN
...
void mu_1_STATE::set_self(const char *n, int os)
{
  ...
  if (name) mu_HomeProc.set_self_2(name, ".HomeProc", os + 96 ); else mu_HomeProc.set_self_2(NULL, NULL, 0);
  if (name) mu_Dir.set_self_2(name, ".Dir", os + 120 ); else mu_Dir.set_self_2(NULL, NULL, 0);
  if (name) mu_UniMsg.set_self_2(name, ".UniMsg", os + 232 ); else mu_UniMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_HomeUniMsg.set_self_2(name, ".HomeUniMsg", os + 328 ); else mu_HomeUniMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_InvMsg.set_self_2(name, ".InvMsg", os + 352 ); else mu_InvMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_RpMsg.set_self_2(name, ".RpMsg", os + 384 ); else mu_RpMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_WbMsg.set_self_2(name, ".WbMsg", os + 416 ); else mu_WbMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_ShWbMsg.set_self_2(name, ".ShWbMsg", os + 432 ); else mu_ShWbMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_NakcMsg.set_self_2(name, ".NakcMsg", os + 448 ); else mu_NakcMsg.set_self_2(NULL, NULL, 0);
  if (name) mu_PendReqSrc.set_self_2(name, ".PendReqSrc", os + 456 ); else mu_PendReqSrc.set_self_2(NULL, NULL, 0);
  if (name) mu_HomePendReqSrc.set_self_2(name, ".HomePendReqSrc", os + 464 ); else mu_HomePendReqSrc.set_self_2(NULL, NULL, 0);
  if (name) mu_Collecting.set_self_2(name, ".Collecting", os + 472 ); else mu_Collecting.set_self_2(NULL, NULL, 0);
  if (name) mu_FwdCmd.set_self_2(name, ".FwdCmd", os + 480 ); else mu_FwdCmd.set_self_2(NULL, NULL, 0);
}
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=116 && what_rule<132)
  ...
  if (what_rule>=166 && what_rule<167)
    { R37.NextRule(what_rule);
      if (what_rule<167) return; }
  if (what_rule>=167 && what_rule<168)
...
bool Condition(unsigned r)
{
  ...
  if (r>=8 && r<=8) return R2.Condition(r-8);
  if (r>=9 && r<=9) return R3.Condition(r-9);
  if (r>=10 && r<=13) return R4.Condition(r-10);
  if (r>=14 && r<=17) return R5.Condition(r-14);
  if (r>=18 && r<=21) return R6.Condition(r-18);
  if (r>=22 && r<=25) return R7.Condition(r-22);
  if (r>=26 && r<=26) return R8.Condition(r-26);
  if (r>=27 && r<=30) return R9.Condition(r-27);
  if (r>=31 && r<=31) return R10.Condition(r-31);
  if (r>=32 && r<=35) return R11.Condition(r-32);
  if (r>=36 && r<=51) return R12.Condition(r-36);
  if (r>=52 && r<=55) return R13.Condition(r-52);
  if (r>=56 && r<=71) return R14.Condition(r-56);
  if (r>=72 && r<=75) return R15.Condition(r-72);
  if (r>=76 && r<=79) return R16.Condition(r-76);
  if (r>=80 && r<=83) return R17.Condition(r-80);
  if (r>=84 && r<=87) return R18.Condition(r-84);
  if (r>=88 && r<=91) return R19.Condition(r-88);
  if (r>=92 && r<=95) return R20.Condition(r-92);
  if (r>=96 && r<=111) return R21.Condition(r-96);
  if (r>=112 && r<=115) return R22.Condition(r-112);
  if (r>=116 && r<=131) return R23.Condition(r-116);
  if (r>=132 && r<=135) return R24.Condition(r-132);
  if (r>=136 && r<=139) return R25.Condition(r-136);
  if (r>=140 && r<=143) return R26.Condition(r-140);
  if (r>=144 && r<=144) return R27.Condition(r-144);
  if (r>=145 && r<=145) return R28.Condition(r-145);
  if (r>=146 && r<=149) return R29.Condition(r-146);
  if (r>=150 && r<=150) return R30.Condition(r-150);
  if (r>=151 && r<=154) return R31.Condition(r-151);
  if (r>=155 && r<=155) return R32.Condition(r-155);
  if (r>=156 && r<=159) return R33.Condition(r-156);
  if (r>=160 && r<=160) return R34.Condition(r-160);
  if (r>=161 && r<=161) return R35.Condition(r-161);
  if (r>=162 && r<=165) return R36.Condition(r-162);
  if (r>=166 && r<=166) return R37.Condition(r-166);
  if (r>=167 && r<=167) return R38.Condition(r-167);
  if (r>=168 && r<=171) return R39.Condition(r-168);
...
void Code(unsigned r)
{
  ...
  if (r>=8 && r<=8) { R2.Code(r-8); return; } 
  if (r>=9 && r<=9) { R3.Code(r-9); return; } 
  if (r>=10 && r<=13) { R4.Code(r-10); return; } 
  if (r>=14 && r<=17) { R5.Code(r-14); return; } 
  if (r>=18 && r<=21) { R6.Code(r-18); return; } 
  if (r>=22 && r<=25) { R7.Code(r-22); return; } 
  if (r>=26 && r<=26) { R8.Code(r-26); return; } 
  if (r>=27 && r<=30) { R9.Code(r-27); return; } 
  if (r>=31 && r<=31) { R10.Code(r-31); return; } 
  if (r>=32 && r<=35) { R11.Code(r-32); return; } 
  if (r>=36 && r<=51) { R12.Code(r-36); return; } 
  if (r>=52 && r<=55) { R13.Code(r-52); return; } 
  if (r>=56 && r<=71) { R14.Code(r-56); return; } 
  if (r>=72 && r<=75) { R15.Code(r-72); return; } 
  if (r>=76 && r<=79) { R16.Code(r-76); return; } 
  if (r>=80 && r<=83) { R17.Code(r-80); return; } 
  if (r>=84 && r<=87) { R18.Code(r-84); return; } 
  if (r>=88 && r<=91) { R19.Code(r-88); return; } 
  if (r>=92 && r<=95) { R20.Code(r-92); return; } 
  if (r>=96 && r<=111) { R21.Code(r-96); return; } 
  if (r>=112 && r<=115) { R22.Code(r-112); return; } 
  if (r>=116 && r<=131) { R23.Code(r-116); return; } 
  if (r>=132 && r<=135) { R24.Code(r-132); return; } 
  if (r>=136 && r<=139) { R25.Code(r-136); return; } 
  if (r>=140 && r<=143) { R26.Code(r-140); return; } 
  if (r>=144 && r<=144) { R27.Code(r-144); return; } 
  if (r>=145 && r<=145) { R28.Code(r-145); return; } 
  if (r>=146 && r<=149) { R29.Code(r-146); return; } 
  if (r>=150 && r<=150) { R30.Code(r-150); return; } 
  if (r>=151 && r<=154) { R31.Code(r-151); return; } 
  if (r>=155 && r<=155) { R32.Code(r-155); return; } 
  if (r>=156 && r<=159) { R33.Code(r-156); return; } 
  if (r>=160 && r<=160) { R34.Code(r-160); return; } 
  if (r>=161 && r<=161) { R35.Code(r-161); return; } 
  if (r>=162 && r<=165) { R36.Code(r-162); return; } 
  if (r>=166 && r<=166) { R37.Code(r-166); return; } 
  if (r>=167 && r<=167) { R38.Code(r-167); return; } 
  if (r>=168 && r<=171) { R39.Code(r-168); return; } 
}
int Priority(unsigned short r)
{
  if (r<=3) { return R0.Priority(); } 
  if (r>=4 && r<=7) { return R1.Priority(); } 
  if (r>=8 && r<=8) { return R2.Priority(); } 
  if (r>=9 && r<=9) { return R3.Priority(); } 
  if (r>=10 && r<=13) { return R4.Priority(); } 
  if (r>=14 && r<=17) { return R5.Priority(); } 
  if (r>=18 && r<=21) { return R6.Priority(); } 
  if (r>=22 && r<=25) { return R7.Priority(); } 
  if (r>=26 && r<=26) { return R8.Priority(); } 
  if (r>=27 && r<=30) { return R9.Priority(); } 
  if (r>=31 && r<=31) { return R10.Priority(); } 
  if (r>=32 && r<=35) { return R11.Priority(); } 
  if (r>=36 && r<=51) { return R12.Priority(); } 
  if (r>=52 && r<=55) { return R13.Priority(); } 
  if (r>=56 && r<=71) { return R14.Priority(); } 
  if (r>=72 && r<=75) { return R15.Priority(); } 
  if (r>=76 && r<=79) { return R16.Priority(); } 
  if (r>=80 && r<=83) { return R17.Priority(); } 
  if (r>=84 && r<=87) { return R18.Priority(); } 
  if (r>=88 && r<=91) { return R19.Priority(); } 
  if (r>=92 && r<=95) { return R20.Priority(); } 
  if (r>=96 && r<=111) { return R21.Priority(); } 
  if (r>=112 && r<=115) { return R22.Priority(); } 
  if (r>=116 && r<=131) { return R23.Priority(); } 
  if (r>=132 && r<=135) { return R24.Priority(); } 
  if (r>=136 && r<=139) { return R25.Priority(); } 
  if (r>=140 && r<=143) { return R26.Priority(); } 
  if (r>=144 && r<=144) { return R27.Priority(); } 
  if (r>=145 && r<=145) { return R28.Priority(); } 
  if (r>=146 && r<=149) { return R29.Priority(); } 
  if (r>=150 && r<=150) { return R30.Priority(); } 
  if (r>=151 && r<=154) { return R31.Priority(); } 
  if (r>=155 && r<=155) { return R32.Priority(); } 
  if (r>=156 && r<=159) { return R33.Priority(); } 
  if (r>=160 && r<=160) { return R34.Priority(); } 
  if (r>=161 && r<=161) { return R35.Priority(); } 
  if (r>=162 && r<=165) { return R36.Priority(); } 
  if (r>=166 && r<=166) { return R37.Priority(); } 
  if (r>=167 && r<=167) { return R38.Priority(); } 
  if (r>=168 && r<=171) { return R39.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=3) return R0.Name(r-0);
  if (r>=4 && r<=7) return R1.Name(r-4);
  if (r>=8 && r<=8) return R2.Name(r-8);
  if (r>=9 && r<=9) return R3.Name(r-9);
  if (r>=10 && r<=13) return R4.Name(r-10);
  if (r>=14 && r<=17) return R5.Name(r-14);
  if (r>=18 && r<=21) return R6.Name(r-18);
  if (r>=22 && r<=25) return R7.Name(r-22);
  if (r>=26 && r<=26) return R8.Name(r-26);
  if (r>=27 && r<=30) return R9.Name(r-27);
  if (r>=31 && r<=31) return R10.Name(r-31);
  if (r>=32 && r<=35) return R11.Name(r-32);
  if (r>=36 && r<=51) return R12.Name(r-36);
  if (r>=52 && r<=55) return R13.Name(r-52);
  if (r>=56 && r<=71) return R14.Name(r-56);
  if (r>=72 && r<=75) return R15.Name(r-72);
  if (r>=76 && r<=79) return R16.Name(r-76);
  if (r>=80 && r<=83) return R17.Name(r-80);
  if (r>=84 && r<=87) return R18.Name(r-84);
  if (r>=88 && r<=91) return R19.Name(r-88);
  if (r>=92 && r<=95) return R20.Name(r-92);
  if (r>=96 && r<=111) return R21.Name(r-96);
  if (r>=112 && r<=115) return R22.Name(r-112);
  if (r>=116 && r<=131) return R23.Name(r-116);
  if (r>=132 && r<=135) return R24.Name(r-132);
  if (r>=136 && r<=139) return R25.Name(r-136);
  if (r>=140 && r<=143) return R26.Name(r-140);
  if (r>=144 && r<=144) return R27.Name(r-144);
  if (r>=145 && r<=145) return R28.Name(r-145);
  if (r>=146 && r<=149) return R29.Name(r-146);
  if (r>=150 && r<=150) return R30.Name(r-150);
  if (r>=151 && r<=154) return R31.Name(r-151);
  if (r>=155 && r<=155) return R32.Name(r-155);
  if (r>=156 && r<=159) return R33.Name(r-156);
  if (r>=160 && r<=160) return R34.Name(r-160);
  if (r>=161 && r<=161) return R35.Name(r-161);
  if (r>=162 && r<=165) return R36.Name(r-162);
  if (r>=166 && r<=166) return R37.Name(r-166);
  if (r>=167 && r<=167) return R38.Name(r-167);
  if (r>=168 && r<=171) return R39.Name(r-168);
  return NULL;
}
};
const unsigned numrules = 172;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 172
...
void Goal_value() {  // makun: set goalstate
    ...
    // set goalstate value: 
    mu_Sta.mu_Proc[1].mu_CacheState.value(mu_CACHE_E);
    mu_Sta.mu_Proc[2].mu_CacheState.value(mu_CACHE_S);

    // set carelist about invariant 
    carelist.clear();  
    carelist.push_back("Sta.Proc[1].CacheState");
    carelist.push_back("Sta.Proc[2].CacheState");
...
bool mu__condition_256() // Condition for Rule "test_proprity, j:2, i:1"
{
  return mu__invariant_247( 2, 1 );
}

bool mu__condition_257() // Condition for Rule "test_proprity, j:2, i:2"
{
  return mu__invariant_247( 2, 2 );
}

bool mu__condition_258() // Condition for Rule "test_proprity, j:2, i:3"
{
  return mu__invariant_247( 2, 3 );
}

bool mu__condition_259() // Condition for Rule "test_proprity, j:2, i:4"
{
  return mu__invariant_247( 2, 4 );
}

bool mu__condition_261() // Condition for Rule "test_proprity, j:3, i:1"
{
  return mu__invariant_247( 3, 1 );
}

bool mu__condition_262() // Condition for Rule "test_proprity, j:3, i:2"
{
  return mu__invariant_247( 3, 2 );
}

bool mu__condition_263() // Condition for Rule "test_proprity, j:3, i:3"
{
  return mu__invariant_247( 3, 3 );
}

bool mu__condition_264() // Condition for Rule "test_proprity, j:3, i:4"
{
  return mu__invariant_247( 3, 4 );
}

bool mu__condition_266() // Condition for Rule "test_proprity, j:4, i:1"
{
  return mu__invariant_247( 4, 1 );
}

bool mu__condition_267() // Condition for Rule "test_proprity, j:4, i:2"
{
  return mu__invariant_247( 4, 2 );
}

bool mu__condition_268() // Condition for Rule "test_proprity, j:4, i:3"
{
  return mu__invariant_247( 4, 3 );
}

bool mu__condition_269() // Condition for Rule "test_proprity, j:4, i:4"
{
...
{"test_proprity, j:4, i:4", &mu__condition_269, NULL, },
{"test_proprity, j:4, i:3", &mu__condition_268, NULL, },
{"test_proprity, j:4, i:2", &mu__condition_267, NULL, },
{"test_proprity, j:4, i:1", &mu__condition_266, NULL, },
{"test_proprity, j:3, i:4", &mu__condition_264, NULL, },
{"test_proprity, j:3, i:3", &mu__condition_263, NULL, },
{"test_proprity, j:3, i:2", &mu__condition_262, NULL, },
{"test_proprity, j:3, i:1", &mu__condition_261, NULL, },
{"test_proprity, j:2, i:4", &mu__condition_259, NULL, },
{"test_proprity, j:2, i:3", &mu__condition_258, NULL, },
{"test_proprity, j:2, i:2", &mu__condition_257, NULL, },
{"test_proprity, j:2, i:1", &mu__condition_256, NULL, },
