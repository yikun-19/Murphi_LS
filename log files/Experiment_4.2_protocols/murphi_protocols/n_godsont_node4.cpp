/******************************
  Program "./benchmarks/murphi_protocols/n_godsont_node4.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/n_godsont_node4"
...
class mu_1_TYPE_NODE: public mu__byte
{
 public:
  ...
  mu_1_TYPE_NODE (const char *name, int os): mu__byte(1, 4, 3, name, os) {};
  mu_1_TYPE_NODE (void): mu__byte(1, 4, 3) {};
  mu_1_TYPE_NODE (int val): mu__byte(1, 4, 3, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
/*** Variable declaration ***/
mu_1_TYPE_NODE mu_curNode("curNode",368);

/*** Variable declaration ***/
mu_1_TYPE_CACHE mu_curCache("curCache",376);

/*** Variable declaration ***/
mu_1_TYPE_ADDR mu_curMemory("curMemory",384);

/*** Variable declaration ***/
mu_1_TYPE_DATA mu_curData("curData",392);

/*** Variable declaration ***/
mu_1_TYPE_LOCK mu_curLock("curLock",400);

/*** Variable declaration ***/
mu_1_REPLACE_STAGE mu_replace("replace",408);

/*** Variable declaration ***/
mu_1_REPLACE_RULE mu_repRule("repRule",416);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=16 && what_rule<48)
    { R2.NextRule(what_rule);
      if (what_rule<48) return; }
  if (what_rule>=48 && what_rule<112)
    { R3.NextRule(what_rule);
      if (what_rule<112) return; }
  if (what_rule>=112 && what_rule<144)
    { R4.NextRule(what_rule);
      if (what_rule<144) return; }
  if (what_rule>=144 && what_rule<160)
    { R5.NextRule(what_rule);
      if (what_rule<160) return; }
  if (what_rule>=160 && what_rule<192)
    { R6.NextRule(what_rule);
      if (what_rule<192) return; }
  if (what_rule>=192 && what_rule<193)
    { R7.NextRule(what_rule);
      if (what_rule<193) return; }
  if (what_rule>=193 && what_rule<209)
    { R8.NextRule(what_rule);
      if (what_rule<209) return; }
  if (what_rule>=209 && what_rule<241)
    { R9.NextRule(what_rule);
      if (what_rule<241) return; }
  if (what_rule>=241 && what_rule<242)
    { R10.NextRule(what_rule);
      if (what_rule<242) return; }
  if (what_rule>=242 && what_rule<274)
    { R11.NextRule(what_rule);
      if (what_rule<274) return; }
  if (what_rule>=274 && what_rule<306)
    { R12.NextRule(what_rule);
      if (what_rule<306) return; }
  if (what_rule>=306 && what_rule<322)
    { R13.NextRule(what_rule);
      if (what_rule<322) return; }
  if (what_rule>=322 && what_rule<354)
    { R14.NextRule(what_rule);
      if (what_rule<354) return; }
  if (what_rule>=354 && what_rule<370)
    { R15.NextRule(what_rule);
      if (what_rule<370) return; }
  if (what_rule>=370 && what_rule<378)
    { R16.NextRule(what_rule);
      if (what_rule<378) return; }
  if (what_rule>=378 && what_rule<379)
    { R17.NextRule(what_rule);
      if (what_rule<379) return; }
  if (what_rule>=379 && what_rule<395)
    { R18.NextRule(what_rule);
      if (what_rule<395) return; }
  if (what_rule>=395 && what_rule<411)
    { R19.NextRule(what_rule);
      if (what_rule<411) return; }
  if (what_rule>=411 && what_rule<419)
    { R20.NextRule(what_rule);
      if (what_rule<419) return; }
  if (what_rule>=419 && what_rule<427)
    { R21.NextRule(what_rule);
      if (what_rule<427) return; }
  if (what_rule>=427 && what_rule<429)
    { R22.NextRule(what_rule);
      if (what_rule<429) return; }
  if (what_rule>=429 && what_rule<433)
    { R23.NextRule(what_rule);
      if (what_rule<433) return; }
  if (what_rule>=433 && what_rule<441)
    { R24.NextRule(what_rule);
      if (what_rule<441) return; }
  if (what_rule>=441 && what_rule<445)
...
bool Condition(unsigned r)
{
  ...
  if (r>=16 && r<=47) return R2.Condition(r-16);
  if (r>=48 && r<=111) return R3.Condition(r-48);
  if (r>=112 && r<=143) return R4.Condition(r-112);
  if (r>=144 && r<=159) return R5.Condition(r-144);
  if (r>=160 && r<=191) return R6.Condition(r-160);
  if (r>=192 && r<=192) return R7.Condition(r-192);
  if (r>=193 && r<=208) return R8.Condition(r-193);
  if (r>=209 && r<=240) return R9.Condition(r-209);
  if (r>=241 && r<=241) return R10.Condition(r-241);
  if (r>=242 && r<=273) return R11.Condition(r-242);
  if (r>=274 && r<=305) return R12.Condition(r-274);
  if (r>=306 && r<=321) return R13.Condition(r-306);
  if (r>=322 && r<=353) return R14.Condition(r-322);
  if (r>=354 && r<=369) return R15.Condition(r-354);
  if (r>=370 && r<=377) return R16.Condition(r-370);
  if (r>=378 && r<=378) return R17.Condition(r-378);
  if (r>=379 && r<=394) return R18.Condition(r-379);
  if (r>=395 && r<=410) return R19.Condition(r-395);
  if (r>=411 && r<=418) return R20.Condition(r-411);
  if (r>=419 && r<=426) return R21.Condition(r-419);
  if (r>=427 && r<=428) return R22.Condition(r-427);
  if (r>=429 && r<=432) return R23.Condition(r-429);
  if (r>=433 && r<=440) return R24.Condition(r-433);
  if (r>=441 && r<=444) return R25.Condition(r-441);
...
void Code(unsigned r)
{
  ...
  if (r>=16 && r<=47) { R2.Code(r-16); return; } 
  if (r>=48 && r<=111) { R3.Code(r-48); return; } 
  if (r>=112 && r<=143) { R4.Code(r-112); return; } 
  if (r>=144 && r<=159) { R5.Code(r-144); return; } 
  if (r>=160 && r<=191) { R6.Code(r-160); return; } 
  if (r>=192 && r<=192) { R7.Code(r-192); return; } 
  if (r>=193 && r<=208) { R8.Code(r-193); return; } 
  if (r>=209 && r<=240) { R9.Code(r-209); return; } 
  if (r>=241 && r<=241) { R10.Code(r-241); return; } 
  if (r>=242 && r<=273) { R11.Code(r-242); return; } 
  if (r>=274 && r<=305) { R12.Code(r-274); return; } 
  if (r>=306 && r<=321) { R13.Code(r-306); return; } 
  if (r>=322 && r<=353) { R14.Code(r-322); return; } 
  if (r>=354 && r<=369) { R15.Code(r-354); return; } 
  if (r>=370 && r<=377) { R16.Code(r-370); return; } 
  if (r>=378 && r<=378) { R17.Code(r-378); return; } 
  if (r>=379 && r<=394) { R18.Code(r-379); return; } 
  if (r>=395 && r<=410) { R19.Code(r-395); return; } 
  if (r>=411 && r<=418) { R20.Code(r-411); return; } 
  if (r>=419 && r<=426) { R21.Code(r-419); return; } 
  if (r>=427 && r<=428) { R22.Code(r-427); return; } 
  if (r>=429 && r<=432) { R23.Code(r-429); return; } 
  if (r>=433 && r<=440) { R24.Code(r-433); return; } 
  if (r>=441 && r<=444) { R25.Code(r-441); return; } 
}
int Priority(unsigned short r)
{
  if (r<=7) { return R0.Priority(); } 
  if (r>=8 && r<=15) { return R1.Priority(); } 
  if (r>=16 && r<=47) { return R2.Priority(); } 
  if (r>=48 && r<=111) { return R3.Priority(); } 
  if (r>=112 && r<=143) { return R4.Priority(); } 
  if (r>=144 && r<=159) { return R5.Priority(); } 
  if (r>=160 && r<=191) { return R6.Priority(); } 
  if (r>=192 && r<=192) { return R7.Priority(); } 
  if (r>=193 && r<=208) { return R8.Priority(); } 
  if (r>=209 && r<=240) { return R9.Priority(); } 
  if (r>=241 && r<=241) { return R10.Priority(); } 
  if (r>=242 && r<=273) { return R11.Priority(); } 
  if (r>=274 && r<=305) { return R12.Priority(); } 
  if (r>=306 && r<=321) { return R13.Priority(); } 
  if (r>=322 && r<=353) { return R14.Priority(); } 
  if (r>=354 && r<=369) { return R15.Priority(); } 
  if (r>=370 && r<=377) { return R16.Priority(); } 
  if (r>=378 && r<=378) { return R17.Priority(); } 
  if (r>=379 && r<=394) { return R18.Priority(); } 
  if (r>=395 && r<=410) { return R19.Priority(); } 
  if (r>=411 && r<=418) { return R20.Priority(); } 
  if (r>=419 && r<=426) { return R21.Priority(); } 
  if (r>=427 && r<=428) { return R22.Priority(); } 
  if (r>=429 && r<=432) { return R23.Priority(); } 
  if (r>=433 && r<=440) { return R24.Priority(); } 
  if (r>=441 && r<=444) { return R25.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=7) return R0.Name(r-0);
  if (r>=8 && r<=15) return R1.Name(r-8);
  if (r>=16 && r<=47) return R2.Name(r-16);
  if (r>=48 && r<=111) return R3.Name(r-48);
  if (r>=112 && r<=143) return R4.Name(r-112);
  if (r>=144 && r<=159) return R5.Name(r-144);
  if (r>=160 && r<=191) return R6.Name(r-160);
  if (r>=192 && r<=192) return R7.Name(r-192);
  if (r>=193 && r<=208) return R8.Name(r-193);
  if (r>=209 && r<=240) return R9.Name(r-209);
  if (r>=241 && r<=241) return R10.Name(r-241);
  if (r>=242 && r<=273) return R11.Name(r-242);
  if (r>=274 && r<=305) return R12.Name(r-274);
  if (r>=306 && r<=321) return R13.Name(r-306);
  if (r>=322 && r<=353) return R14.Name(r-322);
  if (r>=354 && r<=369) return R15.Name(r-354);
  if (r>=370 && r<=377) return R16.Name(r-370);
  if (r>=378 && r<=378) return R17.Name(r-378);
  if (r>=379 && r<=394) return R18.Name(r-379);
  if (r>=395 && r<=410) return R19.Name(r-395);
  if (r>=411 && r<=418) return R20.Name(r-411);
  if (r>=419 && r<=426) return R21.Name(r-419);
  if (r>=427 && r<=428) return R22.Name(r-427);
  if (r>=429 && r<=432) return R23.Name(r-429);
  if (r>=433 && r<=440) return R24.Name(r-433);
  if (r>=441 && r<=444) return R25.Name(r-441);
  return NULL;
}
};
const unsigned numrules = 445;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 445
...
bool mu__condition_228() // Condition for Rule "Coherence, a:1, j:2, i:1"
{
  return mu__invariant_214( 1, 2, 1 );
}

bool mu__condition_229() // Condition for Rule "Coherence, a:1, j:2, i:2"
{
  return mu__invariant_214( 1, 2, 2 );
}

bool mu__condition_230() // Condition for Rule "Coherence, a:1, j:2, i:3"
{
  return mu__invariant_214( 1, 2, 3 );
}

bool mu__condition_231() // Condition for Rule "Coherence, a:1, j:2, i:4"
{
  return mu__invariant_214( 1, 2, 4 );
}

bool mu__condition_234() // Condition for Rule "Coherence, a:2, j:1, i:1"
{
  return mu__invariant_214( 2, 1, 1 );
}

bool mu__condition_235() // Condition for Rule "Coherence, a:2, j:1, i:2"
{
  return mu__invariant_214( 2, 1, 2 );
}

bool mu__condition_236() // Condition for Rule "Coherence, a:2, j:1, i:3"
{
  return mu__invariant_214( 2, 1, 3 );
}

bool mu__condition_237() // Condition for Rule "Coherence, a:2, j:1, i:4"
{
  return mu__invariant_214( 2, 1, 4 );
}

bool mu__condition_239() // Condition for Rule "Coherence, a:2, j:2, i:1"
{
  return mu__invariant_214( 2, 2, 1 );
}

bool mu__condition_240() // Condition for Rule "Coherence, a:2, j:2, i:2"
{
  return mu__invariant_214( 2, 2, 2 );
}

bool mu__condition_241() // Condition for Rule "Coherence, a:2, j:2, i:3"
{
  return mu__invariant_214( 2, 2, 3 );
}

bool mu__condition_242() // Condition for Rule "Coherence, a:2, j:2, i:4"
{
...
{"Coherence, a:2, j:2, i:4", &mu__condition_242, NULL, },
{"Coherence, a:2, j:2, i:3", &mu__condition_241, NULL, },
{"Coherence, a:2, j:2, i:2", &mu__condition_240, NULL, },
{"Coherence, a:2, j:2, i:1", &mu__condition_239, NULL, },
{"Coherence, a:2, j:1, i:4", &mu__condition_237, NULL, },
{"Coherence, a:2, j:1, i:3", &mu__condition_236, NULL, },
{"Coherence, a:2, j:1, i:2", &mu__condition_235, NULL, },
{"Coherence, a:2, j:1, i:1", &mu__condition_234, NULL, },
{"Coherence, a:1, j:2, i:4", &mu__condition_231, NULL, },
{"Coherence, a:1, j:2, i:3", &mu__condition_230, NULL, },
{"Coherence, a:1, j:2, i:2", &mu__condition_229, NULL, },
{"Coherence, a:1, j:2, i:1", &mu__condition_228, NULL, },
