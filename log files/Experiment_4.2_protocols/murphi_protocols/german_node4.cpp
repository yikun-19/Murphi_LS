/******************************
  Program "./benchmarks/murphi_protocols/german_node4.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/german_node4"
...
bool mu__condition_59() // Condition for Rule "CntrlProp, j:2, i:3"
{
  return mu__invariant_44( 2, 3 );
}

bool mu__condition_60() // Condition for Rule "CntrlProp, j:2, i:4"
{
  return mu__invariant_44( 2, 4 );
}

bool mu__condition_62() // Condition for Rule "CntrlProp, j:3, i:1"
{
  return mu__invariant_44( 3, 1 );
}

bool mu__condition_63() // Condition for Rule "CntrlProp, j:3, i:2"
{
  return mu__invariant_44( 3, 2 );
}

bool mu__condition_64() // Condition for Rule "CntrlProp, j:3, i:3"
{
  return mu__invariant_44( 3, 3 );
}

bool mu__condition_65() // Condition for Rule "CntrlProp, j:3, i:4"
{
  return mu__invariant_44( 3, 4 );
}

bool mu__condition_67() // Condition for Rule "CntrlProp, j:4, i:1"
{
  return mu__invariant_44( 4, 1 );
}

bool mu__condition_68() // Condition for Rule "CntrlProp, j:4, i:2"
{
  return mu__invariant_44( 4, 2 );
}

bool mu__condition_69() // Condition for Rule "CntrlProp, j:4, i:3"
{
  return mu__invariant_44( 4, 3 );
}

bool mu__condition_70() // Condition for Rule "CntrlProp, j:4, i:4"
{
...
{"CntrlProp, j:4, i:4", &mu__condition_70, NULL, },
{"CntrlProp, j:4, i:3", &mu__condition_69, NULL, },
{"CntrlProp, j:4, i:2", &mu__condition_68, NULL, },
{"CntrlProp, j:4, i:1", &mu__condition_67, NULL, },
{"CntrlProp, j:3, i:4", &mu__condition_65, NULL, },
{"CntrlProp, j:3, i:3", &mu__condition_64, NULL, },
{"CntrlProp, j:3, i:2", &mu__condition_63, NULL, },
{"CntrlProp, j:3, i:1", &mu__condition_62, NULL, },
{"CntrlProp, j:2, i:4", &mu__condition_60, NULL, },
{"CntrlProp, j:2, i:3", &mu__condition_59, NULL, },
