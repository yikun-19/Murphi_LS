/******************************
  Program "./benchmarks/murphi_protocols/eadash_node2.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/eadash_node2"
#define BITS_IN_WORLD 2248
#define ALIGN
...
class mu_1_Address: public mu__byte
{
 public:
  ...
  mu_1_Address (const char *name, int os): mu__byte(4, 4, 1, name, os) {};
...
class mu_1_Value: public mu__byte
{
 public:
  ...
  mu_1_Value (const char *name, int os): mu__byte(5, 6, 2, name, os) {};
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  mu_1_RequestType (const char *name, int os): mu__byte(7, 14, 4, name, os) {};
  mu_1_RequestType (void): mu__byte(7, 14, 4) {};
  mu_1_RequestType (int val): mu__byte(7, 14, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_ReplyType::values[ int(val) - 15] );
    else return ( s << "Undefined" );
  };

  mu_1_ReplyType (const char *name, int os): mu__byte(15, 18, 3, name, os) {};
  mu_1_ReplyType (void): mu__byte(15, 18, 3) {};
  mu_1_ReplyType (int val): mu__byte(15, 18, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RAC_State::values[ int(val) - 19] );
    else return ( s << "Undefined" );
  };

  mu_1_RAC_State (const char *name, int os): mu__byte(19, 24, 3, name, os) {};
  mu_1_RAC_State (void): mu__byte(19, 24, 3) {};
  mu_1_RAC_State (int val): mu__byte(19, 24, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_CacheState::values[ int(val) - 25] );
    else return ( s << "Undefined" );
  };

  mu_1_CacheState (const char *name, int os): mu__byte(25, 27, 2, name, os) {};
  mu_1_CacheState (void): mu__byte(25, 27, 2) {};
  mu_1_CacheState (int val): mu__byte(25, 27, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 28] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (const char *name, int os): mu__byte(28, 30, 2, name, os) {};
  mu_1__type_1 (void): mu__byte(28, 30, 2) {};
  mu_1__type_1 (int val): mu__byte(28, 30, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
if (n) array[i].set_self_ar(n,"Remote_1", i * 104 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 104 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 312 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 312 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 312 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 128 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 128 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 128 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 384 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 384 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 384 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
const int mu_ACK = 15;
const int mu_NAK = 16;
const int mu_IACK = 17;
const int mu_SACK = 18;
const int mu_INVAL = 19;
const int mu_WRD = 20;
const int mu_WRDO = 21;
const int mu_WRDX = 22;
const int mu_WINV = 23;
const int mu_RRD = 24;
const int mu_Non_Locally_Cached = 25;
const int mu_Locally_Shared = 26;
const int mu_Locally_Exmod = 27;
const int mu_Uncached = 28;
const int mu_Shared_Remote = 29;
const int mu_Dirty_Remote = 30;
/*** Variable declaration ***/
mu_1__type_16 mu_ReqNet("ReqNet",0);

/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",936);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",2088);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",2208);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=114 && what_rule<117)
    { R13.NextRule(what_rule);
      if (what_rule<117) return; }
  if (what_rule>=117 && what_rule<120)
    { R14.NextRule(what_rule);
      if (what_rule<120) return; }
  if (what_rule>=120 && what_rule<123)
    { R15.NextRule(what_rule);
      if (what_rule<123) return; }
  if (what_rule>=123 && what_rule<126)
    { R16.NextRule(what_rule);
      if (what_rule<126) return; }
  if (what_rule>=126 && what_rule<129)
...
bool Condition(unsigned r)
{
  ...
  if (r>=114 && r<=116) return R13.Condition(r-114);
  if (r>=117 && r<=119) return R14.Condition(r-117);
  if (r>=120 && r<=122) return R15.Condition(r-120);
  if (r>=123 && r<=125) return R16.Condition(r-123);
  if (r>=126 && r<=128) return R17.Condition(r-126);
...
void Code(unsigned r)
{
  ...
  if (r>=114 && r<=116) { R13.Code(r-114); return; } 
  if (r>=117 && r<=119) { R14.Code(r-117); return; } 
  if (r>=120 && r<=122) { R15.Code(r-120); return; } 
  if (r>=123 && r<=125) { R16.Code(r-123); return; } 
  if (r>=126 && r<=128) { R17.Code(r-126); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=114 && r<=116) { return R13.Priority(); } 
  if (r>=117 && r<=119) { return R14.Priority(); } 
  if (r>=120 && r<=122) { return R15.Priority(); } 
  if (r>=123 && r<=125) { return R16.Priority(); } 
  if (r>=126 && r<=128) { return R17.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=114 && r<=116) return R13.Name(r-114);
  if (r>=117 && r<=119) return R14.Name(r-117);
  if (r>=120 && r<=122) return R15.Name(r-120);
  if (r>=123 && r<=125) return R16.Name(r-123);
  if (r>=126 && r<=128) return R17.Name(r-126);
  return NULL;
}
};
const unsigned numrules = 129;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 129
...
/********************
  Invariant records
 ********************/
int mu__invariant_61() // Invariant "Only a single master copy exist"
{
bool mu__quant62; 
mu__quant62 = TRUE;
{
...
bool mu__boolexpr66;
bool mu__boolexpr67;
  if (!((mu_n1) != (mu_n2))) mu__boolexpr67 = FALSE ;
  else {
  mu__boolexpr67 = ((mu_Procs[mu_n1].mu_Cache[mu_h][mu_a].mu_State) == (mu_Locally_Exmod)) ; 
}
  if (!(mu__boolexpr67)) mu__boolexpr66 = FALSE ;
  else {
  mu__boolexpr66 = ((mu_Procs[mu_n2].mu_Cache[mu_h][mu_a].mu_State) == (mu_Locally_Shared)) ; 
}
if ( !(!(mu__boolexpr66)) )
...
bool mu__condition_68() // Condition for Rule "Only a single master copy exist"
{
...
{"Only a single master copy exist", &mu__condition_68, NULL, },
};
