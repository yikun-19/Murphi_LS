/******************************
  Program "./benchmarks/murphi_protocols/n_godsont_node16.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/n_godsont_node16"
#define BITS_IN_WORLD 2440
#define ALIGN
...
class mu_1_TYPE_NODE: public mu__byte
{
 public:
  ...
  mu_1_TYPE_NODE (const char *name, int os): mu__byte(1, 32, 6, name, os) {};
  mu_1_TYPE_NODE (void): mu__byte(1, 32, 6) {};
  mu_1_TYPE_NODE (int val): mu__byte(1, 32, 6, "Parameter or function result.", 0)
  {
    operator=(val);
  };
...
/*** Variable declaration ***/
mu_1_TYPE_NODE mu_curNode("curNode",2384);

/*** Variable declaration ***/
mu_1_TYPE_CACHE mu_curCache("curCache",2392);

/*** Variable declaration ***/
mu_1_TYPE_ADDR mu_curMemory("curMemory",2400);

/*** Variable declaration ***/
mu_1_TYPE_DATA mu_curData("curData",2408);

/*** Variable declaration ***/
mu_1_TYPE_LOCK mu_curLock("curLock",2416);

/*** Variable declaration ***/
mu_1_REPLACE_STAGE mu_replace("replace",2424);

/*** Variable declaration ***/
mu_1_REPLACE_RULE mu_repRule("repRule",2432);
...
bool mu__boolexpr110;
  ...
  void NextRule(unsigned & what_rule)
  {
    unsigned r = what_rule - 1921;
    while (what_rule < 1922 )
      {
	if ( ( TRUE  ) ) {
...
if ( !((mu_node[mu_i].mu_cache[mu_j].mu_state) != (mu_DIRTY)) )
  ...
  void NextRule(unsigned & what_rule)
  {
    unsigned r = what_rule - 3010;
    while (what_rule < 3011 )
      {
	if ( ( TRUE  ) ) {
...
public:
  ...
  void NextRule(unsigned & what_rule)
  {
    unsigned r = what_rule - 3395;
    static mu_1_TYPE_CACHE mu_i;
    mu_i.value((r % 2) + 1);
    r = r / 2;
    while (what_rule < 3397 )
      {
	if ( ( TRUE  ) ) {
...
if ( !((mu_node[mu_i].mu_cache[mu_j].mu_state) != (mu_INVALID)) )
  ...
  void NextRule(unsigned & what_rule)
  {
    unsigned r = what_rule - 3397;
    static mu_1_TYPE_NODE mu_i;
    mu_i.value((r % 32) + 1);
    r = r / 32;
    while (what_rule < 3429 )
      {
	if ( ( TRUE  ) ) {
...
if ( ((mu_node[mu_i].mu_cache[mu_j].mu_state) == (mu_INVALID)) )
  ...
  void NextRule(unsigned & what_rule)
  {
    unsigned r = what_rule - 3493;
    static mu_1_TYPE_NODE mu_i;
    mu_i.value((r % 32) + 1);
    r = r / 32;
    while (what_rule < 3525 )
      {
	if ( ( TRUE  ) ) {
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=64 && what_rule<128)
    { R1.NextRule(what_rule);
      if (what_rule<128) return; }
  if (what_rule>=128 && what_rule<384)
    { R2.NextRule(what_rule);
      if (what_rule<384) return; }
  if (what_rule>=384 && what_rule<896)
    { R3.NextRule(what_rule);
      if (what_rule<896) return; }
  if (what_rule>=896 && what_rule<1152)
    { R4.NextRule(what_rule);
      if (what_rule<1152) return; }
  if (what_rule>=1152 && what_rule<1280)
    { R5.NextRule(what_rule);
      if (what_rule<1280) return; }
  if (what_rule>=1280 && what_rule<1536)
    { R6.NextRule(what_rule);
      if (what_rule<1536) return; }
  if (what_rule>=1536 && what_rule<1537)
    { R7.NextRule(what_rule);
      if (what_rule<1537) return; }
  if (what_rule>=1537 && what_rule<1665)
    { R8.NextRule(what_rule);
      if (what_rule<1665) return; }
  if (what_rule>=1665 && what_rule<1921)
    { R9.NextRule(what_rule);
      if (what_rule<1921) return; }
  if (what_rule>=1921 && what_rule<1922)
    { R10.NextRule(what_rule);
      if (what_rule<1922) return; }
  if (what_rule>=1922 && what_rule<2178)
    { R11.NextRule(what_rule);
      if (what_rule<2178) return; }
  if (what_rule>=2178 && what_rule<2434)
    { R12.NextRule(what_rule);
      if (what_rule<2434) return; }
  if (what_rule>=2434 && what_rule<2562)
    { R13.NextRule(what_rule);
      if (what_rule<2562) return; }
  if (what_rule>=2562 && what_rule<2818)
    { R14.NextRule(what_rule);
      if (what_rule<2818) return; }
  if (what_rule>=2818 && what_rule<2946)
    { R15.NextRule(what_rule);
      if (what_rule<2946) return; }
  if (what_rule>=2946 && what_rule<3010)
    { R16.NextRule(what_rule);
      if (what_rule<3010) return; }
  if (what_rule>=3010 && what_rule<3011)
    { R17.NextRule(what_rule);
      if (what_rule<3011) return; }
  if (what_rule>=3011 && what_rule<3139)
    { R18.NextRule(what_rule);
      if (what_rule<3139) return; }
  if (what_rule>=3139 && what_rule<3267)
    { R19.NextRule(what_rule);
      if (what_rule<3267) return; }
  if (what_rule>=3267 && what_rule<3331)
    { R20.NextRule(what_rule);
      if (what_rule<3331) return; }
  if (what_rule>=3331 && what_rule<3395)
    { R21.NextRule(what_rule);
      if (what_rule<3395) return; }
  if (what_rule>=3395 && what_rule<3397)
    { R22.NextRule(what_rule);
      if (what_rule<3397) return; }
  if (what_rule>=3397 && what_rule<3429)
    { R23.NextRule(what_rule);
      if (what_rule<3429) return; }
  if (what_rule>=3429 && what_rule<3493)
    { R24.NextRule(what_rule);
      if (what_rule<3493) return; }
  if (what_rule>=3493 && what_rule<3525)
    { R25.NextRule(what_rule);
      if (what_rule<3525) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  if (r<=63) return R0.Condition(r-0);
  if (r>=64 && r<=127) return R1.Condition(r-64);
  if (r>=128 && r<=383) return R2.Condition(r-128);
  if (r>=384 && r<=895) return R3.Condition(r-384);
  if (r>=896 && r<=1151) return R4.Condition(r-896);
  if (r>=1152 && r<=1279) return R5.Condition(r-1152);
  if (r>=1280 && r<=1535) return R6.Condition(r-1280);
  if (r>=1536 && r<=1536) return R7.Condition(r-1536);
  if (r>=1537 && r<=1664) return R8.Condition(r-1537);
  if (r>=1665 && r<=1920) return R9.Condition(r-1665);
  if (r>=1921 && r<=1921) return R10.Condition(r-1921);
  if (r>=1922 && r<=2177) return R11.Condition(r-1922);
  if (r>=2178 && r<=2433) return R12.Condition(r-2178);
  if (r>=2434 && r<=2561) return R13.Condition(r-2434);
  if (r>=2562 && r<=2817) return R14.Condition(r-2562);
  if (r>=2818 && r<=2945) return R15.Condition(r-2818);
  if (r>=2946 && r<=3009) return R16.Condition(r-2946);
  if (r>=3010 && r<=3010) return R17.Condition(r-3010);
  if (r>=3011 && r<=3138) return R18.Condition(r-3011);
  if (r>=3139 && r<=3266) return R19.Condition(r-3139);
  if (r>=3267 && r<=3330) return R20.Condition(r-3267);
  if (r>=3331 && r<=3394) return R21.Condition(r-3331);
  if (r>=3395 && r<=3396) return R22.Condition(r-3395);
  if (r>=3397 && r<=3428) return R23.Condition(r-3397);
  if (r>=3429 && r<=3492) return R24.Condition(r-3429);
  if (r>=3493 && r<=3524) return R25.Condition(r-3493);
Error.Notrace("Internal: NextStateGenerator -- checking condition for nonexisting rule.");
return 0;}
void Code(unsigned r)
{
  if (r<=63) { R0.Code(r-0); return; } 
  if (r>=64 && r<=127) { R1.Code(r-64); return; } 
  if (r>=128 && r<=383) { R2.Code(r-128); return; } 
  if (r>=384 && r<=895) { R3.Code(r-384); return; } 
  if (r>=896 && r<=1151) { R4.Code(r-896); return; } 
  if (r>=1152 && r<=1279) { R5.Code(r-1152); return; } 
  if (r>=1280 && r<=1535) { R6.Code(r-1280); return; } 
  if (r>=1536 && r<=1536) { R7.Code(r-1536); return; } 
  if (r>=1537 && r<=1664) { R8.Code(r-1537); return; } 
  if (r>=1665 && r<=1920) { R9.Code(r-1665); return; } 
  if (r>=1921 && r<=1921) { R10.Code(r-1921); return; } 
  if (r>=1922 && r<=2177) { R11.Code(r-1922); return; } 
  if (r>=2178 && r<=2433) { R12.Code(r-2178); return; } 
  if (r>=2434 && r<=2561) { R13.Code(r-2434); return; } 
  if (r>=2562 && r<=2817) { R14.Code(r-2562); return; } 
  if (r>=2818 && r<=2945) { R15.Code(r-2818); return; } 
  if (r>=2946 && r<=3009) { R16.Code(r-2946); return; } 
  if (r>=3010 && r<=3010) { R17.Code(r-3010); return; } 
  if (r>=3011 && r<=3138) { R18.Code(r-3011); return; } 
  if (r>=3139 && r<=3266) { R19.Code(r-3139); return; } 
  if (r>=3267 && r<=3330) { R20.Code(r-3267); return; } 
  if (r>=3331 && r<=3394) { R21.Code(r-3331); return; } 
  if (r>=3395 && r<=3396) { R22.Code(r-3395); return; } 
  if (r>=3397 && r<=3428) { R23.Code(r-3397); return; } 
  if (r>=3429 && r<=3492) { R24.Code(r-3429); return; } 
  if (r>=3493 && r<=3524) { R25.Code(r-3493); return; } 
}
int Priority(unsigned short r)
{
  if (r<=63) { return R0.Priority(); } 
  if (r>=64 && r<=127) { return R1.Priority(); } 
  if (r>=128 && r<=383) { return R2.Priority(); } 
  if (r>=384 && r<=895) { return R3.Priority(); } 
  if (r>=896 && r<=1151) { return R4.Priority(); } 
  if (r>=1152 && r<=1279) { return R5.Priority(); } 
  if (r>=1280 && r<=1535) { return R6.Priority(); } 
  if (r>=1536 && r<=1536) { return R7.Priority(); } 
  if (r>=1537 && r<=1664) { return R8.Priority(); } 
  if (r>=1665 && r<=1920) { return R9.Priority(); } 
  if (r>=1921 && r<=1921) { return R10.Priority(); } 
  if (r>=1922 && r<=2177) { return R11.Priority(); } 
  if (r>=2178 && r<=2433) { return R12.Priority(); } 
  if (r>=2434 && r<=2561) { return R13.Priority(); } 
  if (r>=2562 && r<=2817) { return R14.Priority(); } 
  if (r>=2818 && r<=2945) { return R15.Priority(); } 
  if (r>=2946 && r<=3009) { return R16.Priority(); } 
  if (r>=3010 && r<=3010) { return R17.Priority(); } 
  if (r>=3011 && r<=3138) { return R18.Priority(); } 
  if (r>=3139 && r<=3266) { return R19.Priority(); } 
  if (r>=3267 && r<=3330) { return R20.Priority(); } 
  if (r>=3331 && r<=3394) { return R21.Priority(); } 
  if (r>=3395 && r<=3396) { return R22.Priority(); } 
  if (r>=3397 && r<=3428) { return R23.Priority(); } 
  if (r>=3429 && r<=3492) { return R24.Priority(); } 
  if (r>=3493 && r<=3524) { return R25.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  if (r<=63) return R0.Name(r-0);
  if (r>=64 && r<=127) return R1.Name(r-64);
  if (r>=128 && r<=383) return R2.Name(r-128);
  if (r>=384 && r<=895) return R3.Name(r-384);
  if (r>=896 && r<=1151) return R4.Name(r-896);
  if (r>=1152 && r<=1279) return R5.Name(r-1152);
  if (r>=1280 && r<=1535) return R6.Name(r-1280);
  if (r>=1536 && r<=1536) return R7.Name(r-1536);
  if (r>=1537 && r<=1664) return R8.Name(r-1537);
  if (r>=1665 && r<=1920) return R9.Name(r-1665);
  if (r>=1921 && r<=1921) return R10.Name(r-1921);
  if (r>=1922 && r<=2177) return R11.Name(r-1922);
  if (r>=2178 && r<=2433) return R12.Name(r-2178);
  if (r>=2434 && r<=2561) return R13.Name(r-2434);
  if (r>=2562 && r<=2817) return R14.Name(r-2562);
  if (r>=2818 && r<=2945) return R15.Name(r-2818);
  if (r>=2946 && r<=3009) return R16.Name(r-2946);
  if (r>=3010 && r<=3010) return R17.Name(r-3010);
  if (r>=3011 && r<=3138) return R18.Name(r-3011);
  if (r>=3139 && r<=3266) return R19.Name(r-3139);
  if (r>=3267 && r<=3330) return R20.Name(r-3267);
  if (r>=3331 && r<=3394) return R21.Name(r-3331);
  if (r>=3395 && r<=3396) return R22.Name(r-3395);
  if (r>=3397 && r<=3428) return R23.Name(r-3397);
  if (r>=3429 && r<=3492) return R24.Name(r-3429);
  if (r>=3493 && r<=3524) return R25.Name(r-3493);
  return NULL;
}
};
const unsigned numrules = 3525;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 3525
...
void Goal_value() {  // makun: set goalstate
    ...
    // set goalstate value: 
    mu_replace.value(mu_NON);
    mu_node[1].mu_hasLock.value(true);
    mu_node[1].mu_firstRead[1].value(false);
    mu_node[1].mu_cache[2].mu_state.value(mu_VALID);
    mu_node[1].mu_cache[2].mu_addr.value(0);
    mu_node[1].mu_cache[2].mu_data.value(0);
    mu_memory[1].mu_data.value(0);

    // set carelist about invariant 
    carelist.clear();  
    carelist.push_back("replace");
    carelist.push_back("node[1].hasLock");
    carelist.push_back("node[1].firstRead[1]");
    carelist.push_back("node[1].cache[2].state");
    carelist.push_back("node[1].cache[2].addr");
    carelist.push_back("4");
    carelist.push_back("node[1].cache[2].data");
    carelist.push_back("memory[1].data");
...
bool mu__condition_259() // Condition for Rule "Coherence, a:1, j:1, i:5"
{
  return mu__invariant_246( 1, 1, 5 );
}

bool mu__condition_260() // Condition for Rule "Coherence, a:1, j:1, i:6"
{
  return mu__invariant_246( 1, 1, 6 );
}

bool mu__condition_261() // Condition for Rule "Coherence, a:1, j:1, i:7"
{
  return mu__invariant_246( 1, 1, 7 );
}

bool mu__condition_262() // Condition for Rule "Coherence, a:1, j:1, i:8"
{
  return mu__invariant_246( 1, 1, 8 );
}

bool mu__condition_263() // Condition for Rule "Coherence, a:1, j:1, i:9"
{
  return mu__invariant_246( 1, 1, 9 );
}

bool mu__condition_264() // Condition for Rule "Coherence, a:1, j:1, i:10"
{
  return mu__invariant_246( 1, 1, 10 );
}

bool mu__condition_265() // Condition for Rule "Coherence, a:1, j:1, i:11"
{
  return mu__invariant_246( 1, 1, 11 );
}

bool mu__condition_266() // Condition for Rule "Coherence, a:1, j:1, i:12"
{
  return mu__invariant_246( 1, 1, 12 );
}

bool mu__condition_267() // Condition for Rule "Coherence, a:1, j:1, i:13"
{
  return mu__invariant_246( 1, 1, 13 );
}

bool mu__condition_268() // Condition for Rule "Coherence, a:1, j:1, i:14"
{
  return mu__invariant_246( 1, 1, 14 );
}

bool mu__condition_269() // Condition for Rule "Coherence, a:1, j:1, i:15"
{
  return mu__invariant_246( 1, 1, 15 );
}

bool mu__condition_270() // Condition for Rule "Coherence, a:1, j:1, i:16"
{
  return mu__invariant_246( 1, 1, 16 );
}

bool mu__condition_271() // Condition for Rule "Coherence, a:1, j:1, i:17"
{
  return mu__invariant_246( 1, 1, 17 );
}

bool mu__condition_272() // Condition for Rule "Coherence, a:1, j:1, i:18"
{
  return mu__invariant_246( 1, 1, 18 );
}

bool mu__condition_273() // Condition for Rule "Coherence, a:1, j:1, i:19"
{
  return mu__invariant_246( 1, 1, 19 );
}

bool mu__condition_274() // Condition for Rule "Coherence, a:1, j:1, i:20"
{
  return mu__invariant_246( 1, 1, 20 );
}

bool mu__condition_275() // Condition for Rule "Coherence, a:1, j:1, i:21"
{
  return mu__invariant_246( 1, 1, 21 );
}

bool mu__condition_276() // Condition for Rule "Coherence, a:1, j:1, i:22"
{
  return mu__invariant_246( 1, 1, 22 );
}

bool mu__condition_277() // Condition for Rule "Coherence, a:1, j:1, i:23"
{
  return mu__invariant_246( 1, 1, 23 );
}

bool mu__condition_278() // Condition for Rule "Coherence, a:1, j:1, i:24"
{
  return mu__invariant_246( 1, 1, 24 );
}

bool mu__condition_279() // Condition for Rule "Coherence, a:1, j:1, i:25"
{
  return mu__invariant_246( 1, 1, 25 );
}

bool mu__condition_280() // Condition for Rule "Coherence, a:1, j:1, i:26"
{
  return mu__invariant_246( 1, 1, 26 );
}

bool mu__condition_281() // Condition for Rule "Coherence, a:1, j:1, i:27"
{
  return mu__invariant_246( 1, 1, 27 );
}

bool mu__condition_282() // Condition for Rule "Coherence, a:1, j:1, i:28"
{
  return mu__invariant_246( 1, 1, 28 );
}

bool mu__condition_283() // Condition for Rule "Coherence, a:1, j:1, i:29"
{
  return mu__invariant_246( 1, 1, 29 );
}

bool mu__condition_284() // Condition for Rule "Coherence, a:1, j:1, i:30"
{
  return mu__invariant_246( 1, 1, 30 );
}

bool mu__condition_285() // Condition for Rule "Coherence, a:1, j:1, i:31"
{
  return mu__invariant_246( 1, 1, 31 );
}

bool mu__condition_286() // Condition for Rule "Coherence, a:1, j:1, i:32"
{
  return mu__invariant_246( 1, 1, 32 );
}

bool mu__condition_288() // Condition for Rule "Coherence, a:1, j:2, i:1"
{
  return mu__invariant_246( 1, 2, 1 );
}

bool mu__condition_289() // Condition for Rule "Coherence, a:1, j:2, i:2"
{
  return mu__invariant_246( 1, 2, 2 );
}

bool mu__condition_290() // Condition for Rule "Coherence, a:1, j:2, i:3"
{
  return mu__invariant_246( 1, 2, 3 );
}

bool mu__condition_291() // Condition for Rule "Coherence, a:1, j:2, i:4"
{
  return mu__invariant_246( 1, 2, 4 );
}

bool mu__condition_292() // Condition for Rule "Coherence, a:1, j:2, i:5"
{
  return mu__invariant_246( 1, 2, 5 );
}

bool mu__condition_293() // Condition for Rule "Coherence, a:1, j:2, i:6"
{
  return mu__invariant_246( 1, 2, 6 );
}

bool mu__condition_294() // Condition for Rule "Coherence, a:1, j:2, i:7"
{
  return mu__invariant_246( 1, 2, 7 );
}

bool mu__condition_295() // Condition for Rule "Coherence, a:1, j:2, i:8"
{
  return mu__invariant_246( 1, 2, 8 );
}

bool mu__condition_296() // Condition for Rule "Coherence, a:1, j:2, i:9"
{
  return mu__invariant_246( 1, 2, 9 );
}

bool mu__condition_297() // Condition for Rule "Coherence, a:1, j:2, i:10"
{
  return mu__invariant_246( 1, 2, 10 );
}

bool mu__condition_298() // Condition for Rule "Coherence, a:1, j:2, i:11"
{
  return mu__invariant_246( 1, 2, 11 );
}

bool mu__condition_299() // Condition for Rule "Coherence, a:1, j:2, i:12"
{
  return mu__invariant_246( 1, 2, 12 );
}

bool mu__condition_300() // Condition for Rule "Coherence, a:1, j:2, i:13"
{
  return mu__invariant_246( 1, 2, 13 );
}

bool mu__condition_301() // Condition for Rule "Coherence, a:1, j:2, i:14"
{
  return mu__invariant_246( 1, 2, 14 );
}

bool mu__condition_302() // Condition for Rule "Coherence, a:1, j:2, i:15"
{
  return mu__invariant_246( 1, 2, 15 );
}

bool mu__condition_303() // Condition for Rule "Coherence, a:1, j:2, i:16"
{
  return mu__invariant_246( 1, 2, 16 );
}

bool mu__condition_304() // Condition for Rule "Coherence, a:1, j:2, i:17"
{
  return mu__invariant_246( 1, 2, 17 );
}

bool mu__condition_305() // Condition for Rule "Coherence, a:1, j:2, i:18"
{
  return mu__invariant_246( 1, 2, 18 );
}

bool mu__condition_306() // Condition for Rule "Coherence, a:1, j:2, i:19"
{
  return mu__invariant_246( 1, 2, 19 );
}

bool mu__condition_307() // Condition for Rule "Coherence, a:1, j:2, i:20"
{
  return mu__invariant_246( 1, 2, 20 );
}

bool mu__condition_308() // Condition for Rule "Coherence, a:1, j:2, i:21"
{
  return mu__invariant_246( 1, 2, 21 );
}

bool mu__condition_309() // Condition for Rule "Coherence, a:1, j:2, i:22"
{
  return mu__invariant_246( 1, 2, 22 );
}

bool mu__condition_310() // Condition for Rule "Coherence, a:1, j:2, i:23"
{
  return mu__invariant_246( 1, 2, 23 );
}

bool mu__condition_311() // Condition for Rule "Coherence, a:1, j:2, i:24"
{
  return mu__invariant_246( 1, 2, 24 );
}

bool mu__condition_312() // Condition for Rule "Coherence, a:1, j:2, i:25"
{
  return mu__invariant_246( 1, 2, 25 );
}

bool mu__condition_313() // Condition for Rule "Coherence, a:1, j:2, i:26"
{
  return mu__invariant_246( 1, 2, 26 );
}

bool mu__condition_314() // Condition for Rule "Coherence, a:1, j:2, i:27"
{
  return mu__invariant_246( 1, 2, 27 );
}

bool mu__condition_315() // Condition for Rule "Coherence, a:1, j:2, i:28"
{
  return mu__invariant_246( 1, 2, 28 );
}

bool mu__condition_316() // Condition for Rule "Coherence, a:1, j:2, i:29"
{
  return mu__invariant_246( 1, 2, 29 );
}

bool mu__condition_317() // Condition for Rule "Coherence, a:1, j:2, i:30"
{
  return mu__invariant_246( 1, 2, 30 );
}

bool mu__condition_318() // Condition for Rule "Coherence, a:1, j:2, i:31"
{
  return mu__invariant_246( 1, 2, 31 );
}

bool mu__condition_319() // Condition for Rule "Coherence, a:1, j:2, i:32"
{
  return mu__invariant_246( 1, 2, 32 );
}

bool mu__condition_322() // Condition for Rule "Coherence, a:2, j:1, i:1"
{
  return mu__invariant_246( 2, 1, 1 );
}

bool mu__condition_323() // Condition for Rule "Coherence, a:2, j:1, i:2"
{
  return mu__invariant_246( 2, 1, 2 );
}

bool mu__condition_324() // Condition for Rule "Coherence, a:2, j:1, i:3"
{
  return mu__invariant_246( 2, 1, 3 );
}

bool mu__condition_325() // Condition for Rule "Coherence, a:2, j:1, i:4"
{
  return mu__invariant_246( 2, 1, 4 );
}

bool mu__condition_326() // Condition for Rule "Coherence, a:2, j:1, i:5"
{
  return mu__invariant_246( 2, 1, 5 );
}

bool mu__condition_327() // Condition for Rule "Coherence, a:2, j:1, i:6"
{
  return mu__invariant_246( 2, 1, 6 );
}

bool mu__condition_328() // Condition for Rule "Coherence, a:2, j:1, i:7"
{
  return mu__invariant_246( 2, 1, 7 );
}

bool mu__condition_329() // Condition for Rule "Coherence, a:2, j:1, i:8"
{
  return mu__invariant_246( 2, 1, 8 );
}

bool mu__condition_330() // Condition for Rule "Coherence, a:2, j:1, i:9"
{
  return mu__invariant_246( 2, 1, 9 );
}

bool mu__condition_331() // Condition for Rule "Coherence, a:2, j:1, i:10"
{
  return mu__invariant_246( 2, 1, 10 );
}

bool mu__condition_332() // Condition for Rule "Coherence, a:2, j:1, i:11"
{
  return mu__invariant_246( 2, 1, 11 );
}

bool mu__condition_333() // Condition for Rule "Coherence, a:2, j:1, i:12"
{
  return mu__invariant_246( 2, 1, 12 );
}

bool mu__condition_334() // Condition for Rule "Coherence, a:2, j:1, i:13"
{
  return mu__invariant_246( 2, 1, 13 );
}

bool mu__condition_335() // Condition for Rule "Coherence, a:2, j:1, i:14"
{
  return mu__invariant_246( 2, 1, 14 );
}

bool mu__condition_336() // Condition for Rule "Coherence, a:2, j:1, i:15"
{
  return mu__invariant_246( 2, 1, 15 );
}

bool mu__condition_337() // Condition for Rule "Coherence, a:2, j:1, i:16"
{
  return mu__invariant_246( 2, 1, 16 );
}

bool mu__condition_338() // Condition for Rule "Coherence, a:2, j:1, i:17"
{
  return mu__invariant_246( 2, 1, 17 );
}

bool mu__condition_339() // Condition for Rule "Coherence, a:2, j:1, i:18"
{
  return mu__invariant_246( 2, 1, 18 );
}

bool mu__condition_340() // Condition for Rule "Coherence, a:2, j:1, i:19"
{
  return mu__invariant_246( 2, 1, 19 );
}

bool mu__condition_341() // Condition for Rule "Coherence, a:2, j:1, i:20"
{
  return mu__invariant_246( 2, 1, 20 );
}

bool mu__condition_342() // Condition for Rule "Coherence, a:2, j:1, i:21"
{
  return mu__invariant_246( 2, 1, 21 );
}

bool mu__condition_343() // Condition for Rule "Coherence, a:2, j:1, i:22"
{
  return mu__invariant_246( 2, 1, 22 );
}

bool mu__condition_344() // Condition for Rule "Coherence, a:2, j:1, i:23"
{
  return mu__invariant_246( 2, 1, 23 );
}

bool mu__condition_345() // Condition for Rule "Coherence, a:2, j:1, i:24"
{
  return mu__invariant_246( 2, 1, 24 );
}

bool mu__condition_346() // Condition for Rule "Coherence, a:2, j:1, i:25"
{
  return mu__invariant_246( 2, 1, 25 );
}

bool mu__condition_347() // Condition for Rule "Coherence, a:2, j:1, i:26"
{
  return mu__invariant_246( 2, 1, 26 );
}

bool mu__condition_348() // Condition for Rule "Coherence, a:2, j:1, i:27"
{
  return mu__invariant_246( 2, 1, 27 );
}

bool mu__condition_349() // Condition for Rule "Coherence, a:2, j:1, i:28"
{
  return mu__invariant_246( 2, 1, 28 );
}

bool mu__condition_350() // Condition for Rule "Coherence, a:2, j:1, i:29"
{
  return mu__invariant_246( 2, 1, 29 );
}

bool mu__condition_351() // Condition for Rule "Coherence, a:2, j:1, i:30"
{
  return mu__invariant_246( 2, 1, 30 );
}

bool mu__condition_352() // Condition for Rule "Coherence, a:2, j:1, i:31"
{
  return mu__invariant_246( 2, 1, 31 );
}

bool mu__condition_353() // Condition for Rule "Coherence, a:2, j:1, i:32"
{
  return mu__invariant_246( 2, 1, 32 );
}

bool mu__condition_355() // Condition for Rule "Coherence, a:2, j:2, i:1"
{
  return mu__invariant_246( 2, 2, 1 );
}

bool mu__condition_356() // Condition for Rule "Coherence, a:2, j:2, i:2"
{
  return mu__invariant_246( 2, 2, 2 );
}

bool mu__condition_357() // Condition for Rule "Coherence, a:2, j:2, i:3"
{
  return mu__invariant_246( 2, 2, 3 );
}

bool mu__condition_358() // Condition for Rule "Coherence, a:2, j:2, i:4"
{
  return mu__invariant_246( 2, 2, 4 );
}

bool mu__condition_359() // Condition for Rule "Coherence, a:2, j:2, i:5"
{
  return mu__invariant_246( 2, 2, 5 );
}

bool mu__condition_360() // Condition for Rule "Coherence, a:2, j:2, i:6"
{
  return mu__invariant_246( 2, 2, 6 );
}

bool mu__condition_361() // Condition for Rule "Coherence, a:2, j:2, i:7"
{
  return mu__invariant_246( 2, 2, 7 );
}

bool mu__condition_362() // Condition for Rule "Coherence, a:2, j:2, i:8"
{
  return mu__invariant_246( 2, 2, 8 );
}

bool mu__condition_363() // Condition for Rule "Coherence, a:2, j:2, i:9"
{
  return mu__invariant_246( 2, 2, 9 );
}

bool mu__condition_364() // Condition for Rule "Coherence, a:2, j:2, i:10"
{
  return mu__invariant_246( 2, 2, 10 );
}

bool mu__condition_365() // Condition for Rule "Coherence, a:2, j:2, i:11"
{
  return mu__invariant_246( 2, 2, 11 );
}

bool mu__condition_366() // Condition for Rule "Coherence, a:2, j:2, i:12"
{
  return mu__invariant_246( 2, 2, 12 );
}

bool mu__condition_367() // Condition for Rule "Coherence, a:2, j:2, i:13"
{
  return mu__invariant_246( 2, 2, 13 );
}

bool mu__condition_368() // Condition for Rule "Coherence, a:2, j:2, i:14"
{
  return mu__invariant_246( 2, 2, 14 );
}

bool mu__condition_369() // Condition for Rule "Coherence, a:2, j:2, i:15"
{
  return mu__invariant_246( 2, 2, 15 );
}

bool mu__condition_370() // Condition for Rule "Coherence, a:2, j:2, i:16"
{
  return mu__invariant_246( 2, 2, 16 );
}

bool mu__condition_371() // Condition for Rule "Coherence, a:2, j:2, i:17"
{
  return mu__invariant_246( 2, 2, 17 );
}

bool mu__condition_372() // Condition for Rule "Coherence, a:2, j:2, i:18"
{
  return mu__invariant_246( 2, 2, 18 );
}

bool mu__condition_373() // Condition for Rule "Coherence, a:2, j:2, i:19"
{
  return mu__invariant_246( 2, 2, 19 );
}

bool mu__condition_374() // Condition for Rule "Coherence, a:2, j:2, i:20"
{
  return mu__invariant_246( 2, 2, 20 );
}

bool mu__condition_375() // Condition for Rule "Coherence, a:2, j:2, i:21"
{
  return mu__invariant_246( 2, 2, 21 );
}

bool mu__condition_376() // Condition for Rule "Coherence, a:2, j:2, i:22"
{
  return mu__invariant_246( 2, 2, 22 );
}

bool mu__condition_377() // Condition for Rule "Coherence, a:2, j:2, i:23"
{
  return mu__invariant_246( 2, 2, 23 );
}

bool mu__condition_378() // Condition for Rule "Coherence, a:2, j:2, i:24"
{
  return mu__invariant_246( 2, 2, 24 );
}

bool mu__condition_379() // Condition for Rule "Coherence, a:2, j:2, i:25"
{
  return mu__invariant_246( 2, 2, 25 );
}

bool mu__condition_380() // Condition for Rule "Coherence, a:2, j:2, i:26"
{
  return mu__invariant_246( 2, 2, 26 );
}

bool mu__condition_381() // Condition for Rule "Coherence, a:2, j:2, i:27"
{
  return mu__invariant_246( 2, 2, 27 );
}

bool mu__condition_382() // Condition for Rule "Coherence, a:2, j:2, i:28"
{
  return mu__invariant_246( 2, 2, 28 );
}

bool mu__condition_383() // Condition for Rule "Coherence, a:2, j:2, i:29"
{
  return mu__invariant_246( 2, 2, 29 );
}

bool mu__condition_384() // Condition for Rule "Coherence, a:2, j:2, i:30"
{
  return mu__invariant_246( 2, 2, 30 );
}

bool mu__condition_385() // Condition for Rule "Coherence, a:2, j:2, i:31"
{
  return mu__invariant_246( 2, 2, 31 );
}

bool mu__condition_386() // Condition for Rule "Coherence, a:2, j:2, i:32"
{
  return mu__invariant_246( 2, 2, 32 );
}

/**** end rule declaration ****/

const rulerec invariants[] = {
{"Coherence, a:2, j:2, i:32", &mu__condition_386, NULL, },
{"Coherence, a:2, j:2, i:31", &mu__condition_385, NULL, },
{"Coherence, a:2, j:2, i:30", &mu__condition_384, NULL, },
{"Coherence, a:2, j:2, i:29", &mu__condition_383, NULL, },
{"Coherence, a:2, j:2, i:28", &mu__condition_382, NULL, },
{"Coherence, a:2, j:2, i:27", &mu__condition_381, NULL, },
{"Coherence, a:2, j:2, i:26", &mu__condition_380, NULL, },
{"Coherence, a:2, j:2, i:25", &mu__condition_379, NULL, },
{"Coherence, a:2, j:2, i:24", &mu__condition_378, NULL, },
{"Coherence, a:2, j:2, i:23", &mu__condition_377, NULL, },
{"Coherence, a:2, j:2, i:22", &mu__condition_376, NULL, },
{"Coherence, a:2, j:2, i:21", &mu__condition_375, NULL, },
{"Coherence, a:2, j:2, i:20", &mu__condition_374, NULL, },
{"Coherence, a:2, j:2, i:19", &mu__condition_373, NULL, },
{"Coherence, a:2, j:2, i:18", &mu__condition_372, NULL, },
{"Coherence, a:2, j:2, i:17", &mu__condition_371, NULL, },
{"Coherence, a:2, j:2, i:16", &mu__condition_370, NULL, },
{"Coherence, a:2, j:2, i:15", &mu__condition_369, NULL, },
{"Coherence, a:2, j:2, i:14", &mu__condition_368, NULL, },
{"Coherence, a:2, j:2, i:13", &mu__condition_367, NULL, },
{"Coherence, a:2, j:2, i:12", &mu__condition_366, NULL, },
{"Coherence, a:2, j:2, i:11", &mu__condition_365, NULL, },
{"Coherence, a:2, j:2, i:10", &mu__condition_364, NULL, },
{"Coherence, a:2, j:2, i:9", &mu__condition_363, NULL, },
{"Coherence, a:2, j:2, i:8", &mu__condition_362, NULL, },
{"Coherence, a:2, j:2, i:7", &mu__condition_361, NULL, },
{"Coherence, a:2, j:2, i:6", &mu__condition_360, NULL, },
{"Coherence, a:2, j:2, i:5", &mu__condition_359, NULL, },
{"Coherence, a:2, j:2, i:4", &mu__condition_358, NULL, },
{"Coherence, a:2, j:2, i:3", &mu__condition_357, NULL, },
{"Coherence, a:2, j:2, i:2", &mu__condition_356, NULL, },
{"Coherence, a:2, j:2, i:1", &mu__condition_355, NULL, },
{"Coherence, a:2, j:1, i:32", &mu__condition_353, NULL, },
{"Coherence, a:2, j:1, i:31", &mu__condition_352, NULL, },
{"Coherence, a:2, j:1, i:30", &mu__condition_351, NULL, },
{"Coherence, a:2, j:1, i:29", &mu__condition_350, NULL, },
{"Coherence, a:2, j:1, i:28", &mu__condition_349, NULL, },
{"Coherence, a:2, j:1, i:27", &mu__condition_348, NULL, },
{"Coherence, a:2, j:1, i:26", &mu__condition_347, NULL, },
{"Coherence, a:2, j:1, i:25", &mu__condition_346, NULL, },
{"Coherence, a:2, j:1, i:24", &mu__condition_345, NULL, },
{"Coherence, a:2, j:1, i:23", &mu__condition_344, NULL, },
{"Coherence, a:2, j:1, i:22", &mu__condition_343, NULL, },
{"Coherence, a:2, j:1, i:21", &mu__condition_342, NULL, },
{"Coherence, a:2, j:1, i:20", &mu__condition_341, NULL, },
{"Coherence, a:2, j:1, i:19", &mu__condition_340, NULL, },
{"Coherence, a:2, j:1, i:18", &mu__condition_339, NULL, },
{"Coherence, a:2, j:1, i:17", &mu__condition_338, NULL, },
{"Coherence, a:2, j:1, i:16", &mu__condition_337, NULL, },
{"Coherence, a:2, j:1, i:15", &mu__condition_336, NULL, },
{"Coherence, a:2, j:1, i:14", &mu__condition_335, NULL, },
{"Coherence, a:2, j:1, i:13", &mu__condition_334, NULL, },
{"Coherence, a:2, j:1, i:12", &mu__condition_333, NULL, },
{"Coherence, a:2, j:1, i:11", &mu__condition_332, NULL, },
{"Coherence, a:2, j:1, i:10", &mu__condition_331, NULL, },
{"Coherence, a:2, j:1, i:9", &mu__condition_330, NULL, },
{"Coherence, a:2, j:1, i:8", &mu__condition_329, NULL, },
{"Coherence, a:2, j:1, i:7", &mu__condition_328, NULL, },
{"Coherence, a:2, j:1, i:6", &mu__condition_327, NULL, },
{"Coherence, a:2, j:1, i:5", &mu__condition_326, NULL, },
{"Coherence, a:2, j:1, i:4", &mu__condition_325, NULL, },
{"Coherence, a:2, j:1, i:3", &mu__condition_324, NULL, },
{"Coherence, a:2, j:1, i:2", &mu__condition_323, NULL, },
{"Coherence, a:2, j:1, i:1", &mu__condition_322, NULL, },
{"Coherence, a:1, j:2, i:32", &mu__condition_319, NULL, },
{"Coherence, a:1, j:2, i:31", &mu__condition_318, NULL, },
{"Coherence, a:1, j:2, i:30", &mu__condition_317, NULL, },
{"Coherence, a:1, j:2, i:29", &mu__condition_316, NULL, },
{"Coherence, a:1, j:2, i:28", &mu__condition_315, NULL, },
{"Coherence, a:1, j:2, i:27", &mu__condition_314, NULL, },
{"Coherence, a:1, j:2, i:26", &mu__condition_313, NULL, },
{"Coherence, a:1, j:2, i:25", &mu__condition_312, NULL, },
{"Coherence, a:1, j:2, i:24", &mu__condition_311, NULL, },
{"Coherence, a:1, j:2, i:23", &mu__condition_310, NULL, },
{"Coherence, a:1, j:2, i:22", &mu__condition_309, NULL, },
{"Coherence, a:1, j:2, i:21", &mu__condition_308, NULL, },
{"Coherence, a:1, j:2, i:20", &mu__condition_307, NULL, },
{"Coherence, a:1, j:2, i:19", &mu__condition_306, NULL, },
{"Coherence, a:1, j:2, i:18", &mu__condition_305, NULL, },
{"Coherence, a:1, j:2, i:17", &mu__condition_304, NULL, },
{"Coherence, a:1, j:2, i:16", &mu__condition_303, NULL, },
{"Coherence, a:1, j:2, i:15", &mu__condition_302, NULL, },
{"Coherence, a:1, j:2, i:14", &mu__condition_301, NULL, },
{"Coherence, a:1, j:2, i:13", &mu__condition_300, NULL, },
{"Coherence, a:1, j:2, i:12", &mu__condition_299, NULL, },
{"Coherence, a:1, j:2, i:11", &mu__condition_298, NULL, },
{"Coherence, a:1, j:2, i:10", &mu__condition_297, NULL, },
{"Coherence, a:1, j:2, i:9", &mu__condition_296, NULL, },
{"Coherence, a:1, j:2, i:8", &mu__condition_295, NULL, },
{"Coherence, a:1, j:2, i:7", &mu__condition_294, NULL, },
{"Coherence, a:1, j:2, i:6", &mu__condition_293, NULL, },
{"Coherence, a:1, j:2, i:5", &mu__condition_292, NULL, },
{"Coherence, a:1, j:2, i:4", &mu__condition_291, NULL, },
{"Coherence, a:1, j:2, i:3", &mu__condition_290, NULL, },
{"Coherence, a:1, j:2, i:2", &mu__condition_289, NULL, },
{"Coherence, a:1, j:2, i:1", &mu__condition_288, NULL, },
{"Coherence, a:1, j:1, i:32", &mu__condition_286, NULL, },
{"Coherence, a:1, j:1, i:31", &mu__condition_285, NULL, },
{"Coherence, a:1, j:1, i:30", &mu__condition_284, NULL, },
{"Coherence, a:1, j:1, i:29", &mu__condition_283, NULL, },
{"Coherence, a:1, j:1, i:28", &mu__condition_282, NULL, },
{"Coherence, a:1, j:1, i:27", &mu__condition_281, NULL, },
{"Coherence, a:1, j:1, i:26", &mu__condition_280, NULL, },
{"Coherence, a:1, j:1, i:25", &mu__condition_279, NULL, },
{"Coherence, a:1, j:1, i:24", &mu__condition_278, NULL, },
{"Coherence, a:1, j:1, i:23", &mu__condition_277, NULL, },
{"Coherence, a:1, j:1, i:22", &mu__condition_276, NULL, },
{"Coherence, a:1, j:1, i:21", &mu__condition_275, NULL, },
{"Coherence, a:1, j:1, i:20", &mu__condition_274, NULL, },
{"Coherence, a:1, j:1, i:19", &mu__condition_273, NULL, },
{"Coherence, a:1, j:1, i:18", &mu__condition_272, NULL, },
{"Coherence, a:1, j:1, i:17", &mu__condition_271, NULL, },
{"Coherence, a:1, j:1, i:16", &mu__condition_270, NULL, },
{"Coherence, a:1, j:1, i:15", &mu__condition_269, NULL, },
{"Coherence, a:1, j:1, i:14", &mu__condition_268, NULL, },
{"Coherence, a:1, j:1, i:13", &mu__condition_267, NULL, },
{"Coherence, a:1, j:1, i:12", &mu__condition_266, NULL, },
{"Coherence, a:1, j:1, i:11", &mu__condition_265, NULL, },
{"Coherence, a:1, j:1, i:10", &mu__condition_264, NULL, },
{"Coherence, a:1, j:1, i:9", &mu__condition_263, NULL, },
{"Coherence, a:1, j:1, i:8", &mu__condition_262, NULL, },
{"Coherence, a:1, j:1, i:7", &mu__condition_261, NULL, },
{"Coherence, a:1, j:1, i:6", &mu__condition_260, NULL, },
{"Coherence, a:1, j:1, i:5", &mu__condition_259, NULL, },
...
const unsigned short numinvariants = 128;
