/******************************
  Program "./benchmarks/murphi_protocols/adash_node4.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/adash_node4"
#define BITS_IN_WORLD 18656
#define ALIGN
...
class mu_1_Remote: public mu__byte
{
 public:
  ...
  mu_1_Remote (const char *name, int os): mu__byte(2, 5, 3, name, os) {};
...
class mu_1_Proc: public mu__byte
{
 public:
  ...
  mu_1_Proc (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
  ...
  int indexvalue()
  {
    ...
    if ((value() >= 2) && (value() <= 5)) return (value() - 1);
  return 0;
  };
  inline int unionassign(int val)
  {
    if (val >= 0 && val <= 0) return value(val+1);
    if (val >= 1 && val <= 4) return value(val+1);
  return 0;
  };
...
const char *mu_1_Proc::values[] = {"Home_1","Remote_1","Remote_2","Remote_3","Remote_4",NULL };
...
class mu_1_DirIndex: public mu__byte
{
 public:
  ...
  mu_1_DirIndex (const char *name, int os): mu__byte(0, 3, 3, name, os) {};
...
class mu_1_NodeCount: public mu__byte
{
 public:
  ...
  mu_1_NodeCount (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu_1_Address: public mu__byte
{
 public:
  ...
  mu_1_Address (const char *name, int os): mu__byte(6, 6, 1, name, os) {};
...
class mu_1_Value: public mu__byte
{
 public:
  ...
  mu_1_Value (const char *name, int os): mu__byte(7, 8, 2, name, os) {};
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  mu_1_RequestType (const char *name, int os): mu__byte(9, 21, 4, name, os) {};
  mu_1_RequestType (void): mu__byte(9, 21, 4) {};
  mu_1_RequestType (int val): mu__byte(9, 21, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_ReplyType::values[ int(val) - 22] );
    else return ( s << "Undefined" );
  };

  mu_1_ReplyType (const char *name, int os): mu__byte(22, 25, 3, name, os) {};
  mu_1_ReplyType (void): mu__byte(22, 25, 3) {};
  mu_1_ReplyType (int val): mu__byte(22, 25, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RAC_State::values[ int(val) - 26] );
    else return ( s << "Undefined" );
  };

  mu_1_RAC_State (const char *name, int os): mu__byte(26, 34, 4, name, os) {};
  mu_1_RAC_State (void): mu__byte(26, 34, 4) {};
  mu_1_RAC_State (int val): mu__byte(26, 34, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_CacheState::values[ int(val) - 35] );
    else return ( s << "Undefined" );
  };

  mu_1_CacheState (const char *name, int os): mu__byte(35, 37, 2, name, os) {};
  mu_1_CacheState (void): mu__byte(35, 37, 2) {};
  mu_1_CacheState (int val): mu__byte(35, 37, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 38] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (const char *name, int os): mu__byte(38, 40, 2, name, os) {};
  mu_1__type_1 (void): mu__byte(38, 40, 2) {};
  mu_1__type_1 (int val): mu__byte(38, 40, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  mu_1__type_2 (const char *name, int os): mu__byte(0, 4, 3, name, os) {};
...
class mu_1__type_12: public mu__byte
{
 public:
  ...
  mu_1__type_12 (const char *name, int os): mu__byte(0, 10, 4, name, os) {};
  mu_1__type_12 (void): mu__byte(0, 10, 4) {};
  mu_1__type_12 (int val): mu__byte(0, 10, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (const char *name, int os): mu__byte(0, 9, 4, name, os) {};
  mu__subrange_31 (void): mu__byte(0, 9, 4) {};
  mu__subrange_31 (int val): mu__byte(0, 9, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 328 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 328 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 328 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 328 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 328 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 1640 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 1640 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 1640 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 1640 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 1640 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_17: public mu__byte
{
 public:
  ...
  mu_1__type_17 (const char *name, int os): mu__byte(0, 10, 4, name, os) {};
  mu_1__type_17 (void): mu__byte(0, 10, 4) {};
  mu_1__type_17 (int val): mu__byte(0, 10, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (const char *name, int os): mu__byte(0, 9, 4, name, os) {};
  mu__subrange_37 (void): mu__byte(0, 9, 4) {};
  mu__subrange_37 (int val): mu__byte(0, 9, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 408 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 408 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 408 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 408 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 408 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 2040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 2040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 2040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 2040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 2040 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 56 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu__subrange_45: public mu__byte
{
 public:
  ...
  mu__subrange_45 (const char *name, int os): mu__byte(0, 8, 4, name, os) {};
  mu__subrange_45 (void): mu__byte(0, 8, 4) {};
  mu__subrange_45 (int val): mu__byte(0, 8, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_46: public mu__byte
{
 public:
  ...
  mu__subrange_46 (const char *name, int os): mu__byte(0, 8, 4, name, os) {};
  mu__subrange_46 (void): mu__byte(0, 8, 4) {};
  mu__subrange_46 (int val): mu__byte(0, 8, 4, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
const int mu_DRD_H = 17;
const int mu_DRD_RAC = 18;
const int mu_DWR_H = 19;
const int mu_DWR_RAC = 20;
const int mu_DUP = 21;
const int mu_ACK = 22;
const int mu_NAK = 23;
const int mu_IACK = 24;
const int mu_SACK = 25;
const int mu_INVAL = 26;
const int mu_WRD = 27;
const int mu_WRDO = 28;
const int mu_WRDX = 29;
const int mu_WINV = 30;
const int mu_RRD = 31;
const int mu_WDMAR = 32;
const int mu_WUP = 33;
const int mu_WDMAW = 34;
const int mu_Non_Locally_Cached = 35;
const int mu_Locally_Shared = 36;
const int mu_Locally_Exmod = 37;
const int mu_Uncached = 38;
const int mu_Shared_Remote = 39;
const int mu_Dirty_Remote = 40;
/*** Variable declaration ***/
mu_1__type_16 mu_ReqNet("ReqNet",0);

/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",8200);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",18400);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",18600);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=310 && what_rule<335)
    { R13.NextRule(what_rule);
      if (what_rule<335) return; }
  if (what_rule>=335 && what_rule<360)
    { R14.NextRule(what_rule);
      if (what_rule<360) return; }
  if (what_rule>=360 && what_rule<385)
    { R15.NextRule(what_rule);
      if (what_rule<385) return; }
  if (what_rule>=385 && what_rule<410)
    { R16.NextRule(what_rule);
      if (what_rule<410) return; }
  if (what_rule>=410 && what_rule<435)
    { R17.NextRule(what_rule);
      if (what_rule<435) return; }
  if (what_rule>=435 && what_rule<445)
    { R18.NextRule(what_rule);
      if (what_rule<445) return; }
  if (what_rule>=445 && what_rule<450)
    { R19.NextRule(what_rule);
      if (what_rule<450) return; }
  if (what_rule>=450 && what_rule<455)
    { R20.NextRule(what_rule);
      if (what_rule<455) return; }
  if (what_rule>=455 && what_rule<460)
    { R21.NextRule(what_rule);
      if (what_rule<460) return; }
  if (what_rule>=460 && what_rule<465)
    { R22.NextRule(what_rule);
      if (what_rule<465) return; }
  if (what_rule>=465 && what_rule<475)
    { R23.NextRule(what_rule);
      if (what_rule<475) return; }
  if (what_rule>=475 && what_rule<480)
    { R24.NextRule(what_rule);
      if (what_rule<480) return; }
  if (what_rule>=480 && what_rule<485)
    { R25.NextRule(what_rule);
      if (what_rule<485) return; }
  if (what_rule>=485 && what_rule<490)
...
bool Condition(unsigned r)
{
  ...
  if (r>=310 && r<=334) return R13.Condition(r-310);
  if (r>=335 && r<=359) return R14.Condition(r-335);
  if (r>=360 && r<=384) return R15.Condition(r-360);
  if (r>=385 && r<=409) return R16.Condition(r-385);
  if (r>=410 && r<=434) return R17.Condition(r-410);
  if (r>=435 && r<=444) return R18.Condition(r-435);
  if (r>=445 && r<=449) return R19.Condition(r-445);
  if (r>=450 && r<=454) return R20.Condition(r-450);
  if (r>=455 && r<=459) return R21.Condition(r-455);
  if (r>=460 && r<=464) return R22.Condition(r-460);
  if (r>=465 && r<=474) return R23.Condition(r-465);
  if (r>=475 && r<=479) return R24.Condition(r-475);
  if (r>=480 && r<=484) return R25.Condition(r-480);
  if (r>=485 && r<=489) return R26.Condition(r-485);
...
void Code(unsigned r)
{
  ...
  if (r>=310 && r<=334) { R13.Code(r-310); return; } 
  if (r>=335 && r<=359) { R14.Code(r-335); return; } 
  if (r>=360 && r<=384) { R15.Code(r-360); return; } 
  if (r>=385 && r<=409) { R16.Code(r-385); return; } 
  if (r>=410 && r<=434) { R17.Code(r-410); return; } 
  if (r>=435 && r<=444) { R18.Code(r-435); return; } 
  if (r>=445 && r<=449) { R19.Code(r-445); return; } 
  if (r>=450 && r<=454) { R20.Code(r-450); return; } 
  if (r>=455 && r<=459) { R21.Code(r-455); return; } 
  if (r>=460 && r<=464) { R22.Code(r-460); return; } 
  if (r>=465 && r<=474) { R23.Code(r-465); return; } 
  if (r>=475 && r<=479) { R24.Code(r-475); return; } 
  if (r>=480 && r<=484) { R25.Code(r-480); return; } 
  if (r>=485 && r<=489) { R26.Code(r-485); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=310 && r<=334) { return R13.Priority(); } 
  if (r>=335 && r<=359) { return R14.Priority(); } 
  if (r>=360 && r<=384) { return R15.Priority(); } 
  if (r>=385 && r<=409) { return R16.Priority(); } 
  if (r>=410 && r<=434) { return R17.Priority(); } 
  if (r>=435 && r<=444) { return R18.Priority(); } 
  if (r>=445 && r<=449) { return R19.Priority(); } 
  if (r>=450 && r<=454) { return R20.Priority(); } 
  if (r>=455 && r<=459) { return R21.Priority(); } 
  if (r>=460 && r<=464) { return R22.Priority(); } 
  if (r>=465 && r<=474) { return R23.Priority(); } 
  if (r>=475 && r<=479) { return R24.Priority(); } 
  if (r>=480 && r<=484) { return R25.Priority(); } 
  if (r>=485 && r<=489) { return R26.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=310 && r<=334) return R13.Name(r-310);
  if (r>=335 && r<=359) return R14.Name(r-335);
  if (r>=360 && r<=384) return R15.Name(r-360);
  if (r>=385 && r<=409) return R16.Name(r-385);
  if (r>=410 && r<=434) return R17.Name(r-410);
  if (r>=435 && r<=444) return R18.Name(r-435);
  if (r>=445 && r<=449) return R19.Name(r-445);
  if (r>=450 && r<=454) return R20.Name(r-450);
  if (r>=455 && r<=459) return R21.Name(r-455);
  if (r>=460 && r<=464) return R22.Name(r-460);
  if (r>=465 && r<=474) return R23.Name(r-465);
  if (r>=475 && r<=479) return R24.Name(r-475);
  if (r>=480 && r<=484) return R25.Name(r-480);
  if (r>=485 && r<=489) return R26.Name(r-485);
  return NULL;
}
};
const unsigned numrules = 490;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 490
