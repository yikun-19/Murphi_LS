/******************************
  Program "./benchmarks/murphi_protocols/adash_node8.m" compiled by "Caching Murphi Release 5.5.0"
...
#define PROTOCOL_NAME "./benchmarks/murphi_protocols/adash_node8"
#define BITS_IN_WORLD 106720
#define ALIGN
...
class mu_1_RequestType: public mu__byte
{
 public:
  ...
  mu_1_RequestType (const char *name, int os): mu__byte(13, 25, 4, name, os) {};
  mu_1_RequestType (void): mu__byte(13, 25, 4) {};
  mu_1_RequestType (int val): mu__byte(13, 25, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_ReplyType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_ReplyType::values[ int(val) - 26] );
    else return ( s << "Undefined" );
  };

  mu_1_ReplyType (const char *name, int os): mu__byte(26, 29, 3, name, os) {};
  mu_1_ReplyType (void): mu__byte(26, 29, 3) {};
  mu_1_ReplyType (int val): mu__byte(26, 29, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_RAC_State: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_RAC_State::values[ int(val) - 30] );
    else return ( s << "Undefined" );
  };

  mu_1_RAC_State (const char *name, int os): mu__byte(30, 38, 4, name, os) {};
  mu_1_RAC_State (void): mu__byte(30, 38, 4) {};
  mu_1_RAC_State (int val): mu__byte(30, 38, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1_CacheState: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_CacheState::values[ int(val) - 39] );
    else return ( s << "Undefined" );
  };

  mu_1_CacheState (const char *name, int os): mu__byte(39, 41, 2, name, os) {};
  mu_1_CacheState (void): mu__byte(39, 41, 2) {};
  mu_1_CacheState (int val): mu__byte(39, 41, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_1::values[ int(val) - 42] );
    else return ( s << "Undefined" );
  };

  mu_1__type_1 (const char *name, int os): mu__byte(42, 44, 2, name, os) {};
  mu_1__type_1 (void): mu__byte(42, 44, 2) {};
  mu_1__type_1 (int val): mu__byte(42, 44, 2, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_12: public mu__byte
{
 public:
  ...
  mu_1__type_12 (const char *name, int os): mu__byte(0, 18, 5, name, os) {};
  mu_1__type_12 (void): mu__byte(0, 18, 5) {};
  mu_1__type_12 (int val): mu__byte(0, 18, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_31: public mu__byte
{
 public:
  ...
  mu__subrange_31 (const char *name, int os): mu__byte(0, 17, 5, name, os) {};
  mu__subrange_31 (void): mu__byte(0, 17, 5) {};
  mu__subrange_31 (int val): mu__byte(0, 17, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 584 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 5256 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu_1__type_17: public mu__byte
{
 public:
  ...
  mu_1__type_17 (const char *name, int os): mu__byte(0, 18, 5, name, os) {};
  mu_1__type_17 (void): mu__byte(0, 18, 5) {};
  mu_1__type_17 (int val): mu__byte(0, 18, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_37: public mu__byte
{
 public:
  ...
  mu__subrange_37 (const char *name, int os): mu__byte(0, 17, 5, name, os) {};
  mu__subrange_37 (void): mu__byte(0, 17, 5) {};
  mu__subrange_37 (int val): mu__byte(0, 17, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
if (n) array[i].set_self_ar(n,"Home_1", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 728 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
if (n) array[i].set_self_ar(n,"Home_1", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_1", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_2", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_3", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_4", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_5", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_6", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_7", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"Remote_8", i * 6552 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
}
...
class mu__subrange_45: public mu__byte
{
 public:
  ...
  mu__subrange_45 (const char *name, int os): mu__byte(0, 16, 5, name, os) {};
  mu__subrange_45 (void): mu__byte(0, 16, 5) {};
  mu__subrange_45 (int val): mu__byte(0, 16, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
class mu__subrange_46: public mu__byte
{
 public:
  ...
  mu__subrange_46 (const char *name, int os): mu__byte(0, 16, 5, name, os) {};
  mu__subrange_46 (void): mu__byte(0, 16, 5) {};
  mu__subrange_46 (int val): mu__byte(0, 16, 5, "Parameter or function result.", 0)
  {
    operator=(val);
  };
  char * Name() { return tsprintf("%d",value()); };
...
const int mu_DRD_H = 21;
const int mu_DRD_RAC = 22;
const int mu_DWR_H = 23;
const int mu_DWR_RAC = 24;
const int mu_DUP = 25;
const int mu_ACK = 26;
const int mu_NAK = 27;
const int mu_IACK = 28;
const int mu_SACK = 29;
const int mu_INVAL = 30;
const int mu_WRD = 31;
const int mu_WRDO = 32;
const int mu_WRDX = 33;
const int mu_WINV = 34;
const int mu_RRD = 35;
const int mu_WDMAR = 36;
const int mu_WUP = 37;
const int mu_WDMAW = 38;
const int mu_Non_Locally_Cached = 39;
const int mu_Locally_Shared = 40;
const int mu_Locally_Exmod = 41;
const int mu_Uncached = 42;
const int mu_Shared_Remote = 43;
const int mu_Dirty_Remote = 44;
/*** Variable declaration ***/
mu_1__type_16 mu_ReqNet("ReqNet",0);

/*** Variable declaration ***/
mu_1__type_21 mu_ReplyNet("ReplyNet",47304);

/*** Variable declaration ***/
mu_1__type_22 mu_Procs("Procs",106272);

/*** Variable declaration ***/
mu_1__type_23 mu_Homes("Homes",106632);
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=990 && what_rule<1071)
    { R13.NextRule(what_rule);
      if (what_rule<1071) return; }
  if (what_rule>=1071 && what_rule<1152)
    { R14.NextRule(what_rule);
      if (what_rule<1152) return; }
  if (what_rule>=1152 && what_rule<1233)
    { R15.NextRule(what_rule);
      if (what_rule<1233) return; }
  if (what_rule>=1233 && what_rule<1314)
    { R16.NextRule(what_rule);
      if (what_rule<1314) return; }
  if (what_rule>=1314 && what_rule<1395)
    { R17.NextRule(what_rule);
      if (what_rule<1395) return; }
  if (what_rule>=1395 && what_rule<1413)
    { R18.NextRule(what_rule);
      if (what_rule<1413) return; }
  if (what_rule>=1413 && what_rule<1422)
    { R19.NextRule(what_rule);
      if (what_rule<1422) return; }
  if (what_rule>=1422 && what_rule<1431)
    { R20.NextRule(what_rule);
      if (what_rule<1431) return; }
  if (what_rule>=1431 && what_rule<1440)
    { R21.NextRule(what_rule);
      if (what_rule<1440) return; }
  if (what_rule>=1440 && what_rule<1449)
    { R22.NextRule(what_rule);
      if (what_rule<1449) return; }
  if (what_rule>=1449 && what_rule<1467)
    { R23.NextRule(what_rule);
      if (what_rule<1467) return; }
  if (what_rule>=1467 && what_rule<1476)
    { R24.NextRule(what_rule);
      if (what_rule<1476) return; }
  if (what_rule>=1476 && what_rule<1485)
    { R25.NextRule(what_rule);
      if (what_rule<1485) return; }
  if (what_rule>=1485 && what_rule<1494)
    { R26.NextRule(what_rule);
      if (what_rule<1494) return; }
}
bool Condition(unsigned r)
{
  category = CONDITION;
  ...
  if (r>=990 && r<=1070) return R13.Condition(r-990);
  if (r>=1071 && r<=1151) return R14.Condition(r-1071);
  if (r>=1152 && r<=1232) return R15.Condition(r-1152);
  if (r>=1233 && r<=1313) return R16.Condition(r-1233);
  if (r>=1314 && r<=1394) return R17.Condition(r-1314);
  if (r>=1395 && r<=1412) return R18.Condition(r-1395);
  if (r>=1413 && r<=1421) return R19.Condition(r-1413);
  if (r>=1422 && r<=1430) return R20.Condition(r-1422);
  if (r>=1431 && r<=1439) return R21.Condition(r-1431);
  if (r>=1440 && r<=1448) return R22.Condition(r-1440);
  if (r>=1449 && r<=1466) return R23.Condition(r-1449);
  if (r>=1467 && r<=1475) return R24.Condition(r-1467);
  if (r>=1476 && r<=1484) return R25.Condition(r-1476);
  if (r>=1485 && r<=1493) return R26.Condition(r-1485);
...
void Code(unsigned r)
{
  ...
  if (r>=990 && r<=1070) { R13.Code(r-990); return; } 
  if (r>=1071 && r<=1151) { R14.Code(r-1071); return; } 
  if (r>=1152 && r<=1232) { R15.Code(r-1152); return; } 
  if (r>=1233 && r<=1313) { R16.Code(r-1233); return; } 
  if (r>=1314 && r<=1394) { R17.Code(r-1314); return; } 
  if (r>=1395 && r<=1412) { R18.Code(r-1395); return; } 
  if (r>=1413 && r<=1421) { R19.Code(r-1413); return; } 
  if (r>=1422 && r<=1430) { R20.Code(r-1422); return; } 
  if (r>=1431 && r<=1439) { R21.Code(r-1431); return; } 
  if (r>=1440 && r<=1448) { R22.Code(r-1440); return; } 
  if (r>=1449 && r<=1466) { R23.Code(r-1449); return; } 
  if (r>=1467 && r<=1475) { R24.Code(r-1467); return; } 
  if (r>=1476 && r<=1484) { R25.Code(r-1476); return; } 
  if (r>=1485 && r<=1493) { R26.Code(r-1485); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=990 && r<=1070) { return R13.Priority(); } 
  if (r>=1071 && r<=1151) { return R14.Priority(); } 
  if (r>=1152 && r<=1232) { return R15.Priority(); } 
  if (r>=1233 && r<=1313) { return R16.Priority(); } 
  if (r>=1314 && r<=1394) { return R17.Priority(); } 
  if (r>=1395 && r<=1412) { return R18.Priority(); } 
  if (r>=1413 && r<=1421) { return R19.Priority(); } 
  if (r>=1422 && r<=1430) { return R20.Priority(); } 
  if (r>=1431 && r<=1439) { return R21.Priority(); } 
  if (r>=1440 && r<=1448) { return R22.Priority(); } 
  if (r>=1449 && r<=1466) { return R23.Priority(); } 
  if (r>=1467 && r<=1475) { return R24.Priority(); } 
  if (r>=1476 && r<=1484) { return R25.Priority(); } 
  if (r>=1485 && r<=1493) { return R26.Priority(); } 
return 0;}
char * Name(unsigned r)
{
  ...
  if (r>=990 && r<=1070) return R13.Name(r-990);
  if (r>=1071 && r<=1151) return R14.Name(r-1071);
  if (r>=1152 && r<=1232) return R15.Name(r-1152);
  if (r>=1233 && r<=1313) return R16.Name(r-1233);
  if (r>=1314 && r<=1394) return R17.Name(r-1314);
  if (r>=1395 && r<=1412) return R18.Name(r-1395);
  if (r>=1413 && r<=1421) return R19.Name(r-1413);
  if (r>=1422 && r<=1430) return R20.Name(r-1422);
  if (r>=1431 && r<=1439) return R21.Name(r-1431);
  if (r>=1440 && r<=1448) return R22.Name(r-1440);
  if (r>=1449 && r<=1466) return R23.Name(r-1449);
  if (r>=1467 && r<=1475) return R24.Name(r-1467);
  if (r>=1476 && r<=1484) return R25.Name(r-1476);
  if (r>=1485 && r<=1493) return R26.Name(r-1485);
  return NULL;
}
};
const unsigned numrules = 1494;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 1494
...
/********************
  Invariant records
 ********************/
int mu__invariant_87() // Invariant "Only a single master copy exist"
{
bool mu__quant88; 
mu__quant88 = TRUE;
{
...
bool mu__boolexpr92;
bool mu__boolexpr93;
  if (!((mu_n1) != (mu_n2))) mu__boolexpr93 = FALSE ;
  else {
  mu__boolexpr93 = ((mu_Procs[mu_n1].mu_Cache[mu_h][mu_a].mu_State) == (mu_Locally_Exmod)) ; 
}
  if (!(mu__boolexpr93)) mu__boolexpr92 = FALSE ;
  else {
  mu__boolexpr92 = ((mu_Procs[mu_n2].mu_Cache[mu_h][mu_a].mu_State) == (mu_Locally_Shared)) ; 
}
if ( !(!(mu__boolexpr92)) )
...
bool mu__condition_94() // Condition for Rule "Only a single master copy exist"
{
...
{"Only a single master copy exist", &mu__condition_94, NULL, },
};
